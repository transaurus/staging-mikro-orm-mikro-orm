...
## Primitive Types only[​](#primitive-types-only "Direct link to Primitive Types only")
...
## Identity through foreign Entities[​](#identity-through-foreign-entities "Direct link to Identity through foreign Entities")
...
## Use-Case 1: Dynamic Attributes[​](#use-case-1-dynamic-attributes "Direct link to Use-Case 1: Dynamic Attributes")
...
## Use-Case 2: Simple Derived Identity[​](#use-case-2-simple-derived-identity "Direct link to Use-Case 2: Simple Derived Identity")
...
## Use-Case 3: Join-Table with Metadata[​](#use-case-3-join-table-with-metadata "Direct link to Use-Case 3: Join-Table with Metadata")
...
## Using QueryBuilder with composite keys[​](#using-querybuilder-with-composite-keys "Direct link to Using QueryBuilder with composite keys")
