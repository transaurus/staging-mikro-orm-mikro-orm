...
If you need a relationship that can point to multiple unrelated entity types (each with their own table), consider using [Polymorphic Relations](https://mikro-orm.io/docs/relationships.md#polymorphic-relations) instead of inheritance.
