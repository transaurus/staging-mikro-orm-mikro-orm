...
For detailed information about decorator types, metadata providers, and configuration, see [Using Decorators](https://mikro-orm.io/docs/using-decorators.md).

## Entity Definition[​](#entity-definition "Direct link to Entity Definition")

> Some options affect how the [Schema Generator](https://mikro-orm.io/docs/schema-generator.md) works, and those are SQL only, meaning they affect only SQL drivers - whereas, mongo has no schema.
...
| `repository`          | `() => EntityRepository`             | yes      | Set [custom repository class](https://mikro-orm.io/docs/repositories.md#custom-repository).                                      |
| `inheritance`         | `'tpt'`                              | yes      | For [Table-Per-Type Inheritance](https://mikro-orm.io/docs/inheritance-mapping.md#table-per-type-inheritance-tpt).               |
| `discriminatorColumn` | `string`                             | yes      | For [Single Table Inheritance](https://mikro-orm.io/docs/inheritance-mapping.md#single-table-inheritance).                       |
| `discriminatorMap`    | `Dictionary<string>`                 | yes      | For [Single Table Inheritance](https://mikro-orm.io/docs/inheritance-mapping.md#single-table-inheritance).                       |
| `discriminatorValue`  | `number` \| `string`                 | yes      | For [Single Table Inheritance](https://mikro-orm.io/docs/inheritance-mapping.md#single-table-inheritance).                       |
...
| `orderBy`             | `QueryOrderMap` \| `QueryOrderMap[]` | yes      | Set default ordering for this entity. See [collections](https://mikro-orm.io/docs/collections.md#entity-level-default-ordering). |
...
See [Embeddables](https://mikro-orm.io/docs/embeddables.md) for more details.
...
See [Filters](https://mikro-orm.io/docs/filters.md) for more details.
...
| Parameter          | Type                                      | Optional | Description                                                                                                                                                                                                                                                                                                                                                               |
| ------------------ | ----------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `fieldName`        | `string`                                  | yes      | Override default property name (see [Naming Strategy](https://mikro-orm.io/docs/naming-strategy.md)).                                                                                                                                                                                                                                                                     |
| `type`             | `string` \| `Constructor<Type>` \| `Type` | yes      | Explicitly specify the property type. This value is mapped based on the current driver (see [Metadata Providers](https://mikro-orm.io/docs/metadata-providers.md) and [Custom Types](https://mikro-orm.io/docs/custom-types.md)).                                                                                                                                         |
...
| `persist`          | `boolean`                                 | yes      | Set to `false` to define [Shadow Property](https://mikro-orm.io/docs/serializing.md#shadow-properties).                                                                                                                                                                                                                                                                   |
| `hydrate`          | `boolean`                                 | yes      | Set to `false` to disable hydration of this property. Useful for persisted getters.                                                                                                                                                                                                                                                                                       |
| `hidden`           | `boolean`                                 | yes      | Set to `true` to omit the property when [Serializing](https://mikro-orm.io/docs/serializing.md).                                                                                                                                                                                                                                                                          |
| `groups`           | `string[]`                                | yes      | Specify serialization groups for [explicit serialization](https://mikro-orm.io/docs/serializing.md#explicit-serialization). If a property does not specify any group, it will be included, otherwise only properties with a matching group are included.                                                                                                                  |
| `columnType`       | `string`                                  | yes      | Specify exact database column type for [Schema Generator](https://mikro-orm.io/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                                  |
| `length`           | `number`                                  | yes      | Length/precision of database column, used for `datetime/timestamp/varchar` column types for [Schema Generator](https://mikro-orm.io/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                             |
| `default`          | `any`                                     | yes      | Specify default column value for [Schema Generator](https://mikro-orm.io/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                                        |
| `unique`           | `boolean`                                 | yes      | Set column as unique for [Schema Generator](https://mikro-orm.io/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                                                |
| `nullable`         | `boolean`                                 | yes      | Set column as nullable for [Schema Generator](https://mikro-orm.io/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                                              |
| `unsigned`         | `boolean`                                 | yes      | Set column as unsigned for [Schema Generator](https://mikro-orm.io/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                                              |
| `comment`          | `string`                                  | yes      | Specify comment of column for [Schema Generator](https://mikro-orm.io/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                                           |
| `version`          | `boolean`                                 | yes      | Set to true to enable [Optimistic Locking](https://mikro-orm.io/docs/transactions.md#optimistic-locking) via version field. **(SQL only)**                                                                                                                                                                                                                                |
| `concurrencyCheck` | `boolean`                                 | yes      | Set to true to enable [Concurrency Check](https://mikro-orm.io/docs/transactions.md#concurrency-checks) via concurrency fields.                                                                                                                                                                                                                                           |
...
See [Usage with MongoDB](https://mikro-orm.io/docs/usage-with-mongo.md) and [Serializing](https://mikro-orm.io/docs/serializing.md).
...
See [Defining Entities](https://mikro-orm.io/docs/defining-entities.md#enums).
...
See [Defining Entities](https://mikro-orm.io/docs/defining-entities.md#formulas).
...
See [Defining Entities](https://mikro-orm.io/docs/defining-entities.md#indexes).
...
See [Defining Entities](https://mikro-orm.io/docs/defining-entities.md#check-constraints).
...
See [Defining Entities](https://mikro-orm.io/docs/relationships.md#manytoone) for more examples.

| Parameter    | Type                                    | Optional | Description                                                                                                                                                                         |
| ------------ | --------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `entity`     | `string` \| `() => EntityName`          | yes      | Set target entity type.                                                                                                                                                             |
| `cascade`    | `Cascade[]`                             | yes      | Set what actions on owning entity should be cascaded to the relationship. Defaults to `[Cascade.PERSIST, Cascade.MERGE]` (see [Cascading](https://mikro-orm.io/docs/cascading.md)). |
...
| `ref`        | `boolean`                               | yes      | Wrap the entity in [`Reference` wrapper](https://mikro-orm.io/docs/type-safe-relations.md).                                                                                         |
| `primary`    | `boolean`                               | yes      | Use this relation as primary key.                                                                                                                                                   |
| `deleteRule` | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `updateRule` | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `deferMode`  | `immediate` \| `deferred`               | yes      | only for postgres unique constraints                                                                                                                                                |
...
See [Defining Entities](https://mikro-orm.io/docs/relationships.md#onetoone) for more examples, including bidirectional 1:1.
...
| `ref`           | `boolean`                               | yes      | Wrap the entity in [`Reference` wrapper](https://mikro-orm.io/docs/type-safe-relations.md).                                                                                         |
| `orphanRemoval` | `boolean`                               | yes      | Remove the entity when it gets disconnected from the relationship (see [Cascading](https://mikro-orm.io/docs/cascading.md#orphan-removal)).                                         |
| `joinColumn`    | `string`                                | yes      | Override default database column name on the owning side (see [Naming Strategy](https://mikro-orm.io/docs/naming-strategy.md)).                                                     |
| `primary`       | `boolean`                               | yes      | Use this relation as primary key.                                                                                                                                                   |
| `deleteRule`    | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `updateRule`    | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `deferMode`     | `immediate` \| `deferred`               | yes      | only for postgres unique constraints                                                                                                                                                |
...
See [Defining Entities](https://mikro-orm.io/docs/relationships.md#onetomany) for more examples, including bidirectional 1<!-- -->:m<!-- -->.
...
| `cascade`           | `Cascade[]`                             | yes      | Set what actions on owning entity should be cascaded to the relationship. Defaults to `[Cascade.PERSIST, Cascade.MERGE]` (see [Cascading](https://mikro-orm.io/docs/cascading.md)). |
| `eager`             | `boolean`                               | yes      | Always load the relationship. (Discouraged for use with to-many relations.)                                                                                                         |
| `orphanRemoval`     | `boolean`                               | yes      | Remove the entity when it gets disconnected from the connection (see [Cascading](https://mikro-orm.io/docs/cascading.md#orphan-removal)).                                           |
| `orderBy`           | `{ [field: string]: QueryOrder }`       | yes      | Set default ordering condition.                                                                                                                                                     |
| `joinColumn`        | `string`                                | yes      | Override default database column name on the owning side (see [Naming Strategy](https://mikro-orm.io/docs/naming-strategy.md)).                                                     |
| `inverseJoinColumn` | `string`                                | yes      | Override default database column name on the inverse side (see [Naming Strategy](https://mikro-orm.io/docs/naming-strategy.md)).                                                    |
...
See [Defining Entities](https://mikro-orm.io/docs/relationships.md#manytomany) for more examples, including bidirectional m<!-- -->:n<!-- -->.
...
| `mappedBy`          | `(string & keyof T)` \| `(e: T) => any` | yes      | Point to the owning side property name.                                                                                                                                             |
| `orderBy`           | `{ [field: string]: QueryOrder }`       | yes      | Set default ordering condition.                                                                                                                                                     |
| `fixedOrder`        | `boolean`                               | yes      | Force stable insertion order of items in the collection (see [Collections](https://mikro-orm.io/docs/collections.md#forcing-fixed-order-of-collection-items)).                      |
| `fixedOrderColumn`  | `string`                                | yes      | Override default order column name (`id`).                                                                                                                                          |
| `pivotTable`        | `string`                                | yes      | Override default name for pivot table (see [Naming Strategy](https://mikro-orm.io/docs/naming-strategy.md)).                                                                        |
| `joinColumn`        | `string`                                | yes      | Override default database column name on the owning side (see [Naming Strategy](https://mikro-orm.io/docs/naming-strategy.md)).                                                     |
| `inverseJoinColumn` | `string`                                | yes      | Override default database column name on the inverse side (see [Naming Strategy](https://mikro-orm.io/docs/naming-strategy.md)).                                                    |
...
See [Identity Map](https://mikro-orm.io/docs/identity-map.md) for more details about request context.
...
See [Transactions](https://mikro-orm.io/docs/transactions.md) for more details.
