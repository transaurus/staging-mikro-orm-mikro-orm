...
You can also specify how operations on given entity should [cascade](https://mikro-orm.io/docs/cascading.md) to the referred entity.
...
As you can see, OneToMany is the inverse side of ManyToOne (which is the owning side). More about how collections work can be found on [collections page](https://mikro-orm.io/docs/collections.md).

You can also specify how operations on given entity should [cascade](https://mikro-orm.io/docs/cascading.md) to the referred entities. There is also more aggressive remove mode called [Orphan Removal](https://mikro-orm.io/docs/cascading.md#orphan-removal) (`books4` example).
...
As you can see, relationships can be also self-referencing (all of them. OneToOne also supports [Orphan Removal](https://mikro-orm.io/docs/cascading.md#orphan-removal)).
...
Again, more information about how collections work can be found on [collections page](https://mikro-orm.io/docs/collections.md).
...
This name overrides the one automatically generated by the current [NamingStrategy](https://mikro-orm.io/docs/naming-strategy.md).
...
Polymorphic relations are different from [Single Table Inheritance (STI)](https://mikro-orm.io/docs/inheritance-mapping.md#single-table-inheritance):
