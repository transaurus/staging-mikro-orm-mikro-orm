...
## `Loaded` type and populate hints[​](#loaded-type-and-populate-hints "Direct link to loaded-type-and-populate-hints")
...
## Strict partial loading with `fields`[​](#strict-partial-loading-with-fields "Direct link to strict-partial-loading-with-fields")
...
## QueryBuilder type safety[​](#querybuilder-type-safety "Direct link to QueryBuilder type safety")
...
### Context-aware joins[​](#context-aware-joins "Direct link to Context-aware joins")
...
### Strict `select`[​](#strict-select "Direct link to strict-select")
...
### Strict `where`[​](#strict-where "Direct link to strict-where")
...
### Result types with `joinAndSelect`[​](#result-types-with-joinandselect "Direct link to result-types-with-joinandselect")
...
### Result types with `select`[​](#result-types-with-select "Direct link to result-types-with-select")
...
### Awaiting the QueryBuilder[​](#awaiting-the-querybuilder "Direct link to Awaiting the QueryBuilder")
