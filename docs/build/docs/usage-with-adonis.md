...
The most critical part of the integration is the [RequestContext](https://mikro-orm.io/docs/identity-map.md#request-context) middleware. It ensures each HTTP request gets its own identity map, preventing entity state from leaking between requests:
