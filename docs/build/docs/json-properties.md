...
> For [embedded array properties](https://mikro-orm.io/docs/embeddables.md#array-of-embeddables), element-level querying works implicitly without `$elemMatch` since the ORM knows the schema from the embeddable metadata.
