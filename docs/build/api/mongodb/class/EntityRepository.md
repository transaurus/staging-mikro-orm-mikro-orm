...
* [EntityRepository](https://mikro-orm.io/api/core/class/EntityRepository.md)\<T>
  * *EntityRepository*
...
* ****new EntityRepository**\<T>(em, entityName): [MongoEntityRepository](https://mikro-orm.io/api/mongodb/class/EntityRepository.md)\<T>

- Overrides EntityRepository.constructor

  #### Parameters

  * ##### em: [MongoEntityManager](https://mikro-orm.io/api/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md)>
  * ##### entityName: [EntityName](https://mikro-orm.io/api/core.md#EntityName)\<T>

  #### Returns [MongoEntityRepository](https://mikro-orm.io/api/mongodb/class/EntityRepository.md)\<T>
...
- Inherited from EntityRepository.count
  ...
  * ##### options: [CountOptions](https://mikro-orm.io/api/core/interface/CountOptions.md)\<T, Hint> = <!-- -->{}
...
- Inherited from EntityRepository.create
  ...
  * ##### data: Data & [IsSubset](https://mikro-orm.io/api/core.md#IsSubset)<[RequiredEntityData](https://mikro-orm.io/api/core.md#RequiredEntityData)\<T, never, Convert>, Data>
...
* ****find**\<Hint, Fields, Excludes>(where, options): Promise<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>\[]>
...
- Inherited from EntityRepository.find
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/api/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOptions](https://mikro-orm.io/api/core/interface/FindOptions.md)\<T, Hint, Fields, Excludes>

  #### Returns Promise<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>\[]>
...
* ****findAll**\<Hint, Fields, Excludes>(options): Promise<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>\[]>
...
- Inherited from EntityRepository.findAll
  ...
  * ##### optionaloptions: [FindAllOptions](https://mikro-orm.io/api/core/interface/FindAllOptions.md)\<T, Hint, Fields, Excludes>
...
* ****findAndCount**\<Hint, Fields, Excludes>(where, options): Promise<\[[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>\[], number]>
...
- Inherited from EntityRepository.findAndCount
  ...
  * ##### optionaloptions: [FindOptions](https://mikro-orm.io/api/core/interface/FindOptions.md)\<T, Hint, Fields, Excludes>
  ...
  #### Returns Promise<\[[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>\[], number]>
...
* ****findByCursor**\<Hint, Fields, Excludes, IncludeCount>(options): Promise<[Cursor](https://mikro-orm.io/api/core/class/Cursor.md)\<T, Hint, Fields, Excludes, IncludeCount>>
...
- Inherited from EntityRepository.findByCursor
  ...
  * ##### options: [FindByCursorOptions](https://mikro-orm.io/api/core/interface/FindByCursorOptions.md)\<T, Hint, Fields, Excludes, IncludeCount>

  #### Returns Promise<[Cursor](https://mikro-orm.io/api/core/class/Cursor.md)\<T, Hint, Fields, Excludes, IncludeCount>>
...
* ****findOne**\<Hint, Fields, Excludes>(where, options): Promise\<null | [Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>>
...
- Inherited from EntityRepository.findOne
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/api/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOneOptions](https://mikro-orm.io/api/core/interface/FindOneOptions.md)\<T, Hint, Fields, Excludes>

  #### Returns Promise\<null | [Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>>
...
* ****findOneOrFail**\<Hint, Fields, Excludes>(where, options): Promise<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>>
...
- Inherited from EntityRepository.findOneOrFail
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/api/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOneOrFailOptions](https://mikro-orm.io/api/core/interface/FindOneOrFailOptions.md)\<T, Hint, Fields, Excludes>
...
* ****getEntityManager**(): [MongoEntityManager](https://mikro-orm.io/api/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md)>
...
* ****getReference**\<K>(id, options): [Ref](https://mikro-orm.io/api/core.md#Ref)\<T>
* ****getReference**\<K>(id, options): T
* ****getReference**(id, options): [Ref](https://mikro-orm.io/api/core.md#Ref)\<T>
* ****getReference**(id): T
...
- Inherited from EntityRepository.insert
  ...
  * ##### data: T | [RequiredEntityData](https://mikro-orm.io/api/core.md#RequiredEntityData)\<T>
  * ##### optionaloptions: [NativeInsertUpdateOptions](https://mikro-orm.io/api/core/interface/NativeInsertUpdateOptions.md)\<T>

  #### Returns Promise\<T extends { \[PrimaryKeyProp]?<!-- -->: PK } ? PK extends undefined ? Omit\<T\<T>, typeof [PrimaryKeyProp](https://mikro-orm.io/api/core.md#PrimaryKeyProp)> : PK extends keyof<!-- --> T\<T> ? ReadonlyPrimary\<UnwrapPrimary\<T\<T>\[PK\<PK>]>> : PK extends keyof<!-- --> T\<T>\[] ? ReadonlyPrimary\<PrimaryPropToType\<T\<T>, PK\<PK>>> : PK : T extends { \_id?<!-- -->: PK } ? string | ReadonlyPrimary\<PK> : T extends { id?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T extends { uuid?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T>
...
- Inherited from EntityRepository.merge
  ...
  * ##### data: T | [EntityData](https://mikro-orm.io/api/core.md#EntityData)\<T>
...
- Inherited from EntityRepository.nativeUpdate
  ...
  * ##### optionaloptions: [UpdateOptions](https://mikro-orm.io/api/core/interface/UpdateOptions.md)\<T>
...
* ****populate**\<Ent, Hint, Naked, Fields, Excludes>(entities, populate, options): Promise\<Ent extends object\[] ? [MergeLoaded](https://mikro-orm.io/api/core.md#MergeLoaded)\<ArrayElement\<Ent\<Ent>>, Naked, Hint, Fields, Excludes, false>\[] : [MergeLoaded](https://mikro-orm.io/api/core.md#MergeLoaded)\<Ent, Naked, Hint, Fields, Excludes, false>>
...
- Inherited from EntityRepository.populate
  ...
  * ##### entities: Ent
  * ##### populate: false | [AutoPath](https://mikro-orm.io/api/core.md#AutoPath)\<Naked, Hint, ALL, 9>\[]
  * ##### optionaloptions: [EntityLoaderOptions](https://mikro-orm.io/api/core/interface/EntityLoaderOptions.md)\<Naked, Fields, Excludes>

  #### Returns Promise\<Ent extends object\[] ? [MergeLoaded](https://mikro-orm.io/api/core.md#MergeLoaded)\<ArrayElement\<Ent\<Ent>>, Naked, Hint, Fields, Excludes, false>\[] : [MergeLoaded](https://mikro-orm.io/api/core.md#MergeLoaded)\<Ent, Naked, Hint, Fields, Excludes, false>>
...
* ****stream**\<Hint, Fields, Excludes>(options): AsyncIterableIterator<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>, any, any>
...
- Inherited from EntityRepository.stream
  ...
  * ##### optionaloptions: [StreamOptions](https://mikro-orm.io/api/core/interface/StreamOptions.md)\<T, Hint, Fields, Excludes>

  #### Returns AsyncIterableIterator<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<T, Hint, Fields, Excludes>, any, any>
...
- Inherited from EntityRepository.upsert
  ...
  * ##### optionalentityOrData: T | [EntityData](https://mikro-orm.io/api/core.md#EntityData)\<T>
  * ##### optionaloptions: [UpsertOptions](https://mikro-orm.io/api/core/interface/UpsertOptions.md)\<T, Fields>
...
- Inherited from EntityRepository.upsertMany
  ...
  * ##### optionalentitiesOrData: [EntityData](https://mikro-orm.io/api/core.md#EntityData)\<T>\[] | T\[]
  * ##### optionaloptions: [UpsertManyOptions](https://mikro-orm.io/api/core/interface/UpsertManyOptions.md)\<T, Fields>
