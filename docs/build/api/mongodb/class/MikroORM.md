...
* [MikroORM](https://mikro-orm.io/api/core/class/MikroORM.md)<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md), EM, Entities>
  * *MikroORM*
...
* ****new MikroORM**\<EM, Entities>(options): [MongoMikroORM](https://mikro-orm.io/api/mongodb/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/api/core/interface/Options.md)<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md), EM, Entities>>

  #### Returns [MongoMikroORM](https://mikro-orm.io/api/mongodb/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/api/core/class/Configuration.md)<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md), [MongoEntityManager](https://mikro-orm.io/api/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md)> & [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md)>>
...
**driver: [MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md)
...
* ****connect**(): Promise<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[MongoDriver](https://mikro-orm.io/api/mongodb/class/MongoDriver.md)>
