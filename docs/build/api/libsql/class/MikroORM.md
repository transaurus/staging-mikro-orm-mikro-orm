...
* [MikroORM](https://mikro-orm.io/api/core/class/MikroORM.md)<[LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md), EM, Entities>
  * *MikroORM*
...
* ****new MikroORM**\<EM, Entities>(options): [LibSqlMikroORM](https://mikro-orm.io/api/libsql/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/api/core/interface/Options.md)<[LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md), EM, Entities>>

  #### Returns [LibSqlMikroORM](https://mikro-orm.io/api/libsql/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/api/core/class/Configuration.md)<[LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md), [SqlEntityManager](https://mikro-orm.io/api/sql/class/EntityManager.md)<[LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md)> & [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)<[LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md)>>
...
**driver: [LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md)
...
* ****connect**(): Promise<[LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[LibSqlDriver](https://mikro-orm.io/api/libsql/class/LibSqlDriver.md)>
