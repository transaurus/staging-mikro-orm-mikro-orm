...
* [MikroORM](https://mikro-orm.io/api/core/class/MikroORM.md)<[PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md), EM, Entities>
  * *MikroORM*
...
* ****new MikroORM**\<EM, Entities>(options): [PostgreSqlMikroORM](https://mikro-orm.io/api/postgresql/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/api/core/interface/Options.md)<[PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md), EM, Entities>>

  #### Returns [PostgreSqlMikroORM](https://mikro-orm.io/api/postgresql/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/api/core/class/Configuration.md)<[PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md), [PostgreSqlEntityManager](https://mikro-orm.io/api/postgresql/class/EntityManager.md)<[PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md)> & [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)<[PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md)>>
...
**driver: [PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md)
...
* ****connect**(): Promise<[PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[PostgreSqlDriver](https://mikro-orm.io/api/postgresql/class/PostgreSqlDriver.md)>
