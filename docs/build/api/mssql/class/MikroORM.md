...
* [MikroORM](https://mikro-orm.io/api/core/class/MikroORM.md)<[MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md), EM, Entities>
  * *MikroORM*
...
* ****new MikroORM**\<EM, Entities>(options): [MsSqlMikroORM](https://mikro-orm.io/api/mssql/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/api/core/interface/Options.md)<[MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md), EM, Entities>>

  #### Returns [MsSqlMikroORM](https://mikro-orm.io/api/mssql/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/api/core/class/Configuration.md)<[MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md), [SqlEntityManager](https://mikro-orm.io/api/sql/class/EntityManager.md)<[MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md)> & [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)<[MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md)>>
...
**driver: [MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md)
...
* ****connect**(): Promise<[MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[MsSqlDriver](https://mikro-orm.io/api/mssql/class/MsSqlDriver.md)>
