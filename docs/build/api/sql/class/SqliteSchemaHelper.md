...
* ****new SqliteSchemaHelper**(platform): [SqliteSchemaHelper](https://mikro-orm.io/api/sql/class/SqliteSchemaHelper.md)
...
- Inherited from SchemaHelper.constructor
  ...
  * ##### platform: [AbstractSqlPlatform](https://mikro-orm.io/api/sql/class/AbstractSqlPlatform.md)
  ...
  #### Returns [SqliteSchemaHelper](https://mikro-orm.io/api/sql/class/SqliteSchemaHelper.md)
...
- Overrides SchemaHelper.getAddColumnsSQL
  ...
  * ##### optionaldiff: [TableDifference](https://mikro-orm.io/api/sql/interface/TableDifference.md)
