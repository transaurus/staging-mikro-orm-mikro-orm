...
* [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)\<Driver>
  * *EntityManager*
...
### [**](#createQueryBuilder)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/SqlEntityManager.ts#L36)createQueryBuilder

* ****createQueryBuilder**\<Entity, RootAlias>(entityName, alias, type, loggerContext): [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, never, never, \*, {}>
...
- Creates a QueryBuilder instance
  ...
  * ##### entityName: [EntityName](https://mikro-orm.io/api/core.md#EntityName)\<Entity> | [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, never, never, never, never, \*, {}>
  ...
  * ##### optionalloggerContext: [LoggingOptions](https://mikro-orm.io/api/core.md#LoggingOptions)
  ...
  #### Returns [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, never, never, \*, {}>

### [**](#execute)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/SqlEntityManager.ts#L90)execute
...
### [**](#getKysely)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/SqlEntityManager.ts#L69)getKysely

* ****getKysely**\<TDB, TOptions>(options): [Kysely](https://mikro-orm.io/api/sql/class/Kysely.md)\<TDB extends undefined ? [MapValueAsTable](https://mikro-orm.io/api/sql.md#MapValueAsTable)<[MapTableName](https://mikro-orm.io/api/sql.md#MapTableName)\<never, TOptions>, TOptions> : TDB>
...
- Returns configured Kysely instance.
  ...
  * ##### options: TOptions = <!-- -->...
  ...
  #### Returns [Kysely](https://mikro-orm.io/api/sql/class/Kysely.md)\<TDB extends undefined ? [MapValueAsTable](https://mikro-orm.io/api/sql.md#MapValueAsTable)<[MapTableName](https://mikro-orm.io/api/sql.md#MapTableName)\<never, TOptions>, TOptions> : TDB>
...
### [**](#getRepository)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/SqlEntityManager.ts#L105)getRepository

* ****getRepository**\<T, U>(entityName): [GetRepository](https://mikro-orm.io/api/core.md#GetRepository)\<T, U>
...
- Overrides EntityManager.getRepository
  ...
  * ##### entityName: [EntityName](https://mikro-orm.io/api/core.md#EntityName)\<T>
  ...
  #### Returns [GetRepository](https://mikro-orm.io/api/core.md#GetRepository)\<T, U>
...
### [**](#qb)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/SqlEntityManager.ts#L57)qb

* ****qb**\<Entity, RootAlias>(entityName, alias, type, loggerContext): [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, never, never, \*, {}>
