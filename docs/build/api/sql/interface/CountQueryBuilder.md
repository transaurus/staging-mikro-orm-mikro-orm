...
* [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any>
  * *CountQueryBuilder*
...
* ****addSelect**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, ExtractRawAliases\<F extends readonly
  <!-- -->
...
- Inherited from QueryBuilder.addSelect
  ...
  * ##### fields: F
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, ExtractRawAliases\<F extends readonly<!-- --> unknown\[] ? F\<F> : \[F]>, \* | ExtractRootFields\<F extends readonly<!-- --> U\[] ? U & string : F & string, any, never>, {}>
...
* ****andHaving**(cond, params): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>

- Inherited from QueryBuilder.andHaving

  #### Parameters

  * ##### optionalcond: string | [QBFilterQuery](https://mikro-orm.io/api/sql.md#QBFilterQuery)\<Entity, any, never, never>
  * ##### optionalparams: any\[]

  #### Returns [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****andOrderBy**(orderBy): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
* ****andOrderBy**\<T>(orderBy): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
- Inherited from QueryBuilder.andOrderBy
  ...
  * ##### orderBy: [ContextOrderByMap](https://mikro-orm.io/api/sql.md#ContextOrderByMap)\<Entity, any, never, never> | [ContextOrderByMap](https://mikro-orm.io/api/sql.md#ContextOrderByMap)\<Entity, any, never, never>\[]
...
- Inherited from QueryBuilder.andWhere
  ...
  * ##### cond: [QBFilterQuery](https://mikro-orm.io/api/sql.md#QBFilterQuery)\<Entity, any, never, never>
...
* ****clone**(reset, preserve): [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
- Inherited from QueryBuilder.clone
  ...
  * ##### optionalpreserve: keyof<!-- --> QBState\<Entity>\[]
  ...
  #### Returns [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****delete**(cond): [DeleteQueryBuilder](https://mikro-orm.io/api/sql/interface/DeleteQueryBuilder.md)\<Entity, any, never>
...
- Inherited from QueryBuilder.delete
  ...
  * ##### optionalcond: [QBFilterQuery](https://mikro-orm.io/api/sql.md#QBFilterQuery)\<Entity, any, never, never>

  #### Returns [DeleteQueryBuilder](https://mikro-orm.io/api/sql/interface/DeleteQueryBuilder.md)\<Entity, any, never>
...
* ****distinct**(): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****distinctOn**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
* ****distinctOn**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****from**\<Entity>(target, aliasName): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
* ****from**\<Entity>(target): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****getResultAndCount**(): Promise<\[[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<Entity, any, \*>\[], number]>
...
- Inherited from QueryBuilder.getResultAndCount
  ...
  ***
  ...
  #### Returns Promise<\[[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<Entity, any, \*>\[], number]>
...
* ****getSingleResult**(): Promise\<null | [Loaded](https://mikro-orm.io/api/core.md#Loaded)\<Entity, any, \*>>
...
- Inherited from QueryBuilder.getSingleResult
  ...
  ***
  ...
  #### Returns Promise\<null | [Loaded](https://mikro-orm.io/api/core.md#Loaded)\<Entity, any, \*>>
...
* ****groupBy**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
* ****groupBy**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
* ****groupBy**\<P>(fields): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****having**(cond, params, operator): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
- Inherited from QueryBuilder.having
  ...
  * ##### cond: string | [QBFilterQuery](https://mikro-orm.io/api/sql.md#QBFilterQuery)\<Entity, any, never, never> = <!-- -->{}
  * ##### optionalparams: any\[]
...
* ****innerJoin**\<Field, Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, false>, never, \*, {}>
* ****innerJoin**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<Entity, object, string, Alias, false>, never, \*, {}>
...
- Inherited from QueryBuilder.innerJoin
  ...
  * ##### field: Field
  * ##### alias: Alias
  * ##### optionalcond: JoinCondition<[ExpandProperty](https://mikro-orm.io/api/core.md#ExpandProperty)\<GetType\<Entity, never, Field>\[GetPropName\<Field> & keyof<!-- --> GetType\<Entity, never, Field>]>, Alias>
  * ##### optionalschema: string

  #### Returns [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, false>, never, \*, {}>
...
* ****innerJoinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/api/sql.md#ModifyFields)<\*, any, never, Field, Alias, JoinFields>, {}>
...
- Inherited from QueryBuilder.innerJoinAndSelect
  ...
  * ##### alias: Alias
  * ##### cond: JoinCondition<[ExpandProperty](https://mikro-orm.io/api/core.md#ExpandProperty)\<GetType\<Entity, never, Field>\[GetPropName\<Field> & keyof<!-- --> GetType\<Entity, never, Field>]>, Alias> = <!-- -->...
  * ##### optionalfields: JoinFields
  * ##### optionalschema: string

  #### Returns [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/api/sql.md#ModifyFields)<\*, any, never, Field, Alias, JoinFields>, {}>
...
* ****innerJoinLateral**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<Entity, object, string, Alias, false>, never, \*, {}>
...
- Inherited from QueryBuilder.innerJoinLateral
  ...
  * ##### optionalschema: string
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<Entity, object, string, Alias, false>, never, \*, {}>
...
* ****innerJoinLateralAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/api/sql.md#ModifyFields)<\*, any, never, Field, Alias, JoinFields>, {}>
...
* ****insert**(data): [InsertQueryBuilder](https://mikro-orm.io/api/sql/interface/InsertQueryBuilder.md)\<Entity, any, never>
...
- Inherited from QueryBuilder.insert
  ...
  * ##### data: [RequiredEntityData](https://mikro-orm.io/api/core.md#RequiredEntityData)\<Entity> | [RequiredEntityData](https://mikro-orm.io/api/core.md#RequiredEntityData)\<Entity>\[]
  ...
  #### Returns [InsertQueryBuilder](https://mikro-orm.io/api/sql/interface/InsertQueryBuilder.md)\<Entity, any, never>
...
* ****join**\<Field, Alias>(field, alias, cond, type, path, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, false>, never, \*, {}>
* ****join**\<Alias>(field, alias, cond, type, path, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<Entity, object, string, Alias, false>, never, \*, {}>
...
* ****joinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, type, path, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/api/sql.md#ModifyFields)<\*, any, never, Field, Alias, JoinFields>, {}>
...
* ****leftJoin**\<Field, Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, false>, never, \*, {}>
* ****leftJoin**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<Entity, object, string, Alias, false>, never, \*, {}>
...
* ****leftJoinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/api/sql.md#ModifyFields)<\*, any, never, Field, Alias, JoinFields>, {}>
...
* ****leftJoinLateral**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<Entity, object, string, Alias, false>, never, \*, {}>
...
* ****leftJoinLateralAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, AddToContext\<GetType\<Entity, object, Field>, object, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/api/sql.md#ModifyFields)<\*, any, never, Field, Alias, JoinFields>, {}>
...
* ****limit**(limit, offset): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****offset**(offset): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****onConflict**\<F>(fields): [InsertQueryBuilder](https://mikro-orm.io/api/sql/interface/InsertQueryBuilder.md)\<Entity, any, never>
...
* ****orderBy**(orderBy): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
* ****orderBy**\<T>(orderBy): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****orHaving**(cond, params): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, \*, {}>
...
* ****select**\<F>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, ExtractRawAliases\<F>, ExtractRootFields\<F\[number] & string, any, never>, {}>
* ****select**\<P>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, ExtractRootFields\<P, any, never>, {}>
* ****select**\<P>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, never, ExtractRootFields\<P, any, never>, {}>
* ****select**\<F>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, ExtractRawAliasFromField\<F>, ExtractRootFields\<F & string, any, never>, {}>
...
- Inherited from QueryBuilder.select
  ...
  * ##### optionaldistinct: boolean
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/api/sql/interface/SelectQueryBuilder.md)\<Entity, any, any, never, ExtractRawAliases\<F>, ExtractRootFields\<F\[number] & string, any, never>, {}>
...
* ****stream**(options): AsyncIterableIterator<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<Entity, any, \*>, any, any>
...
- Inherited from QueryBuilder.stream
  ...
  * ##### optionaloptions: [QBStreamOptions](https://mikro-orm.io/api/sql/interface/QBStreamOptions.md)
  ...
  #### Returns AsyncIterableIterator<[Loaded](https://mikro-orm.io/api/core.md#Loaded)\<Entity, any, \*>, any, any>
...
* ****update**(data): [UpdateQueryBuilder](https://mikro-orm.io/api/sql/interface/UpdateQueryBuilder.md)\<Entity, any, never>
...
- Inherited from QueryBuilder.update
  ...
  * ##### data: [EntityData](https://mikro-orm.io/api/core.md#EntityData)\<Entity>
  ...
  #### Returns [UpdateQueryBuilder](https://mikro-orm.io/api/sql/interface/UpdateQueryBuilder.md)\<Entity, any, never>
...
* ****with**\<Name, Q>(name, query, options): [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any, never, never, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
* ****with**\<Name>(name, query, options): [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any, never, never, \*, Record\<Name, object>>
...
- Inherited from QueryBuilder.with
  ...
  * ##### optionaloptions: [CteOptions](https://mikro-orm.io/api/sql/interface/CteOptions.md)
  ...
  #### Returns [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any, never, never, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
...
* ****withRecursive**\<Name, Q>(name, query, options): [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any, never, never, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
* ****withRecursive**\<Name>(name, query, options): [QueryBuilder](https://mikro-orm.io/api/sql/class/QueryBuilder.md)\<Entity, any, any, never, never, \*, Record\<Name, object>>
