...
* ****now**(length): [RawQueryFragment](https://mikro-orm.io/api/core/class/RawQueryFragment.md)\<string> & symbol

- #### Parameters

  * ##### optionallength: number

  #### Returns [RawQueryFragment](https://mikro-orm.io/api/core/class/RawQueryFragment.md)\<string> & symbol
...
* ****ref**\<T>(...keys): [RawQueryFragment](https://mikro-orm.io/api/core/class/RawQueryFragment.md)\<string> & symbol
