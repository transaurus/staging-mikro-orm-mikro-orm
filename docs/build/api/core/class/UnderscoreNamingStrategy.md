...
* ****new UnderscoreNamingStrategy**(): [UnderscoreNamingStrategy](https://mikro-orm.io/api/core/class/UnderscoreNamingStrategy.md)

- Inherited from AbstractNamingStrategy.constructor

  #### Returns [UnderscoreNamingStrategy](https://mikro-orm.io/api/core/class/UnderscoreNamingStrategy.md)
