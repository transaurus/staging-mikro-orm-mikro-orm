...
* [MikroORM](https://mikro-orm.io/api/core/class/MikroORM.md)<[MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md), EM, Entities>
  * *MikroORM*
...
* ****new MikroORM**\<EM, Entities>(options): [MySqlMikroORM](https://mikro-orm.io/api/mysql/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/api/core/interface/Options.md)<[MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md), EM, Entities>>

  #### Returns [MySqlMikroORM](https://mikro-orm.io/api/mysql/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/api/core/class/Configuration.md)<[MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md), [SqlEntityManager](https://mikro-orm.io/api/sql/class/EntityManager.md)<[MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md)> & [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)<[MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md)>>
...
**driver: [MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md)
...
* ****connect**(): Promise<[MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[MySqlDriver](https://mikro-orm.io/api/mysql/class/MySqlDriver.md)>
