...
* [MikroORM](https://mikro-orm.io/api/core/class/MikroORM.md)<[SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md), EM, Entities>
  * *MikroORM*
...
* ****new MikroORM**\<EM, Entities>(options): [SqliteMikroORM](https://mikro-orm.io/api/sqlite/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/api/core/interface/Options.md)<[SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md), EM, Entities>>

  #### Returns [SqliteMikroORM](https://mikro-orm.io/api/sqlite/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/api/core/class/Configuration.md)<[SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md), [SqlEntityManager](https://mikro-orm.io/api/sql/class/EntityManager.md)<[SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md)> & [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)<[SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md)>>
...
**driver: [SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md)
...
* ****connect**(): Promise<[SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[SqliteDriver](https://mikro-orm.io/api/sqlite/class/SqliteDriver.md)>
