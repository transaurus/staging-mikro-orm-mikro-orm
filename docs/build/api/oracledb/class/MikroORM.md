...
* [MikroORM](https://mikro-orm.io/api/core/class/MikroORM.md)<[OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md), EM, Entities>
  * *MikroORM*
...
* ****new MikroORM**\<EM, Entities>(options): [OracleMikroORM](https://mikro-orm.io/api/oracledb/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/api/core/interface/Options.md)<[OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md), EM, Entities>>

  #### Returns [OracleMikroORM](https://mikro-orm.io/api/oracledb/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/api/core/class/Configuration.md)<[OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md), [SqlEntityManager](https://mikro-orm.io/api/sql/class/EntityManager.md)<[OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md)> & [EntityManager](https://mikro-orm.io/api/core/class/EntityManager.md)<[OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md)>>
...
**driver: [OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md)
...
* ****connect**(): Promise<[OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[OracleDriver](https://mikro-orm.io/api/oracledb/class/OracleDriver.md)>
