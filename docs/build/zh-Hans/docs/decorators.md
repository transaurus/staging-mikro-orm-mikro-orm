...
## Legacy vs ES Decorators[​](#legacy-vs-es-decorators "Direct link to Legacy vs ES Decorators")
...
For detailed information about decorator types, metadata providers, and configuration, see [Using Decorators](https://mikro-orm.io/zh-Hans/zh-Hans/docs/using-decorators.md).

## Entity Definition[​](#entity-definition "Direct link to Entity Definition")

> Some options affect how the [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md) works, and those are SQL only, meaning they affect only SQL drivers - whereas, mongo has no schema.
...
| `repository`          | `() => EntityRepository`             | yes      | Set [custom repository class](https://mikro-orm.io/zh-Hans/zh-Hans/docs/repositories.md#custom-repository).                                      |
| `inheritance`         | `'tpt'`                              | yes      | For [Table-Per-Type Inheritance](https://mikro-orm.io/zh-Hans/zh-Hans/docs/inheritance-mapping.md#table-per-type-inheritance-tpt).               |
| `discriminatorColumn` | `string`                             | yes      | For [Single Table Inheritance](https://mikro-orm.io/zh-Hans/zh-Hans/docs/inheritance-mapping.md#single-table-inheritance).                       |
| `discriminatorMap`    | `Dictionary<string>`                 | yes      | For [Single Table Inheritance](https://mikro-orm.io/zh-Hans/zh-Hans/docs/inheritance-mapping.md#single-table-inheritance).                       |
| `discriminatorValue`  | `number` \| `string`                 | yes      | For [Single Table Inheritance](https://mikro-orm.io/zh-Hans/zh-Hans/docs/inheritance-mapping.md#single-table-inheritance).                       |
...
| `orderBy`             | `QueryOrderMap` \| `QueryOrderMap[]` | yes      | Set default ordering for this entity. See [collections](https://mikro-orm.io/zh-Hans/zh-Hans/docs/collections.md#entity-level-default-ordering). |
...
### @Embeddable()[​](#embeddable "Direct link to @Embeddable()")
...
See [Embeddables](https://mikro-orm.io/zh-Hans/zh-Hans/docs/embeddables.md) for more details.
...
See [Filters](https://mikro-orm.io/zh-Hans/zh-Hans/docs/filters.md) for more details.
...
## Entity Properties[​](#entity-properties "Direct link to Entity Properties")
...
| Parameter          | Type                                      | Optional | Description                                                                                                                                                                                                                                                                                                                                                               |
| ------------------ | ----------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `fieldName`        | `string`                                  | yes      | Override default property name (see [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md)).                                                                                                                                                                                                                                                     |
| `type`             | `string` \| `Constructor<Type>` \| `Type` | yes      | Explicitly specify the property type. This value is mapped based on the current driver (see [Metadata Providers](https://mikro-orm.io/zh-Hans/zh-Hans/docs/metadata-providers.md) and [Custom Types](https://mikro-orm.io/zh-Hans/zh-Hans/docs/custom-types.md)).                                                                                                         |
...
| `persist`          | `boolean`                                 | yes      | Set to `false` to define [Shadow Property](https://mikro-orm.io/zh-Hans/zh-Hans/docs/serializing.md#shadow-properties).                                                                                                                                                                                                                                                   |
| `hydrate`          | `boolean`                                 | yes      | Set to `false` to disable hydration of this property. Useful for persisted getters.                                                                                                                                                                                                                                                                                       |
| `hidden`           | `boolean`                                 | yes      | Set to `true` to omit the property when [Serializing](https://mikro-orm.io/zh-Hans/zh-Hans/docs/serializing.md).                                                                                                                                                                                                                                                          |
| `groups`           | `string[]`                                | yes      | Specify serialization groups for [explicit serialization](https://mikro-orm.io/zh-Hans/zh-Hans/docs/serializing.md#explicit-serialization). If a property does not specify any group, it will be included, otherwise only properties with a matching group are included.                                                                                                  |
| `columnType`       | `string`                                  | yes      | Specify exact database column type for [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                  |
| `length`           | `number`                                  | yes      | Length/precision of database column, used for `datetime/timestamp/varchar` column types for [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                             |
| `default`          | `any`                                     | yes      | Specify default column value for [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                        |
| `unique`           | `boolean`                                 | yes      | Set column as unique for [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                                |
| `nullable`         | `boolean`                                 | yes      | Set column as nullable for [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                              |
| `unsigned`         | `boolean`                                 | yes      | Set column as unsigned for [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                              |
| `comment`          | `string`                                  | yes      | Specify comment of column for [Schema Generator](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). **(SQL only)**                                                                                                                                                                                                                                           |
| `version`          | `boolean`                                 | yes      | Set to true to enable [Optimistic Locking](https://mikro-orm.io/zh-Hans/zh-Hans/docs/transactions.md#optimistic-locking) via version field. **(SQL only)**                                                                                                                                                                                                                |
| `concurrencyCheck` | `boolean`                                 | yes      | Set to true to enable [Concurrency Check](https://mikro-orm.io/zh-Hans/zh-Hans/docs/transactions.md#concurrency-checks) via concurrency fields.                                                                                                                                                                                                                           |
...
### @PrimaryKey()[​](#primarykey "Direct link to @PrimaryKey()")
...
### @SerializedPrimaryKey()[​](#serializedprimarykey "Direct link to @SerializedPrimaryKey()")
...
See [Usage with MongoDB](https://mikro-orm.io/zh-Hans/zh-Hans/docs/usage-with-mongo.md) and [Serializing](https://mikro-orm.io/zh-Hans/zh-Hans/docs/serializing.md).
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/defining-entities.md#enums).
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/defining-entities.md#formulas).
...
### @Embedded()[​](#embedded "Direct link to @Embedded()")
...
### @Index() and @Unique()[​](#index-and-unique "Direct link to @Index() and @Unique()")
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/defining-entities.md#indexes).
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/defining-entities.md#check-constraints).
...
## Entity Relationships[​](#entity-relationships "Direct link to Entity Relationships")
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/relationships.md#manytoone) for more examples.

| Parameter    | Type                                    | Optional | Description                                                                                                                                                                                         |
| ------------ | --------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `entity`     | `string` \| `() => EntityName`          | yes      | Set target entity type.                                                                                                                                                                             |
| `cascade`    | `Cascade[]`                             | yes      | Set what actions on owning entity should be cascaded to the relationship. Defaults to `[Cascade.PERSIST, Cascade.MERGE]` (see [Cascading](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md)). |
...
| `ref`        | `boolean`                               | yes      | Wrap the entity in [`Reference` wrapper](https://mikro-orm.io/zh-Hans/zh-Hans/docs/type-safe-relations.md).                                                                                         |
| `primary`    | `boolean`                               | yes      | Use this relation as primary key.                                                                                                                                                                   |
| `deleteRule` | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `updateRule` | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `deferMode`  | `immediate` \| `deferred`               | yes      | only for postgres unique constraints                                                                                                                                                                |
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/relationships.md#onetoone) for more examples, including bidirectional 1:1.
...
| `ref`           | `boolean`                               | yes      | Wrap the entity in [`Reference` wrapper](https://mikro-orm.io/zh-Hans/zh-Hans/docs/type-safe-relations.md).                                                                                         |
| `orphanRemoval` | `boolean`                               | yes      | Remove the entity when it gets disconnected from the relationship (see [Cascading](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#orphan-removal)).                                         |
| `joinColumn`    | `string`                                | yes      | Override default database column name on the owning side (see [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md)).                                                     |
| `primary`       | `boolean`                               | yes      | Use this relation as primary key.                                                                                                                                                                   |
| `deleteRule`    | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `updateRule`    | `string`                                | yes      | [Referential integrity](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#declarative-referential-integrity).                                                                                  |
| `deferMode`     | `immediate` \| `deferred`               | yes      | only for postgres unique constraints                                                                                                                                                                |
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/relationships.md#onetomany) for more examples, including bidirectional 1<!-- -->:m<!-- -->.
...
| `cascade`           | `Cascade[]`                             | yes      | Set what actions on owning entity should be cascaded to the relationship. Defaults to `[Cascade.PERSIST, Cascade.MERGE]` (see [Cascading](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md)). |
| `eager`             | `boolean`                               | yes      | Always load the relationship. (Discouraged for use with to-many relations.)                                                                                                                         |
| `orphanRemoval`     | `boolean`                               | yes      | Remove the entity when it gets disconnected from the connection (see [Cascading](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#orphan-removal)).                                           |
| `orderBy`           | `{ [field: string]: QueryOrder }`       | yes      | Set default ordering condition.                                                                                                                                                                     |
| `joinColumn`        | `string`                                | yes      | Override default database column name on the owning side (see [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md)).                                                     |
| `inverseJoinColumn` | `string`                                | yes      | Override default database column name on the inverse side (see [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md)).                                                    |
...
See [Defining Entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/relationships.md#manytomany) for more examples, including bidirectional m<!-- -->:n<!-- -->.
...
| `mappedBy`          | `(string & keyof T)` \| `(e: T) => any` | yes      | Point to the owning side property name.                                                                                                                                                             |
| `orderBy`           | `{ [field: string]: QueryOrder }`       | yes      | Set default ordering condition.                                                                                                                                                                     |
| `fixedOrder`        | `boolean`                               | yes      | Force stable insertion order of items in the collection (see [Collections](https://mikro-orm.io/zh-Hans/zh-Hans/docs/collections.md#forcing-fixed-order-of-collection-items)).                      |
| `fixedOrderColumn`  | `string`                                | yes      | Override default order column name (`id`).                                                                                                                                                          |
| `pivotTable`        | `string`                                | yes      | Override default name for pivot table (see [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md)).                                                                        |
| `joinColumn`        | `string`                                | yes      | Override default database column name on the owning side (see [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md)).                                                     |
| `inverseJoinColumn` | `string`                                | yes      | Override default database column name on the inverse side (see [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md)).                                                    |
...
### @BeforeCreate()[​](#beforecreate "Direct link to @BeforeCreate()")
...
### @AfterCreate()[​](#aftercreate "Direct link to @AfterCreate()")
...
### @BeforeUpsert()[​](#beforeupsert "Direct link to @BeforeUpsert()")
...
### @AfterUpsert()[​](#afterupsert "Direct link to @AfterUpsert()")
...
### @BeforeDelete()[​](#beforedelete "Direct link to @BeforeDelete()")
...
### @AfterDelete()[​](#afterdelete "Direct link to @AfterDelete()")
...
## Method Decorators[​](#method-decorators "Direct link to Method Decorators")

### @CreateRequestContext()[​](#createrequestcontext "Direct link to @CreateRequestContext()")
...
See [Identity Map](https://mikro-orm.io/zh-Hans/zh-Hans/docs/identity-map.md) for more details about request context.
...
### @EnsureRequestContext()[​](#ensurerequestcontext "Direct link to @EnsureRequestContext()")
...
### @Transactional()[​](#transactional "Direct link to @Transactional()")

`@Transactional()` decorator wraps the method in a transaction. It supports all options from `em.transactional()`.

See [Transactions](https://mikro-orm.io/zh-Hans/zh-Hans/docs/transactions.md) for more details.
