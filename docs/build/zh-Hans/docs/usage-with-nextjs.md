...
## Key Challenges[​](#key-challenges "Direct link to Key Challenges")
...
### Example Entity[​](#example-entity "Direct link to Example Entity")
...
## Explicit Table Names Are Required[​](#explicit-table-names-are-required "Direct link to Explicit Table Names Are Required")
...
## No Folder-Based Discovery[​](#no-folder-based-discovery "Direct link to No Folder-Based Discovery")
...
## Migrations Require Explicit Configuration[​](#migrations-require-explicit-configuration "Direct link to Migrations Require Explicit Configuration")
...
### Configure Migrations Explicitly[​](#configure-migrations-explicitly "Direct link to Configure Migrations Explicitly")
...
## Database Connection Management[​](#database-connection-management "Direct link to Database Connection Management")
...
### Using in Server Components / Route Handlers[​](#using-in-server-components--route-handlers "Direct link to Using in Server Components / Route Handlers")
