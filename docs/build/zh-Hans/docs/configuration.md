...
Read more about this in [Metadata Providers](https://mikro-orm.io/zh-Hans/zh-Hans/docs/metadata-providers.md) sections.
...
Read more about this in [Installation](https://mikro-orm.io/zh-Hans/zh-Hans/docs/quick-start.md) and [Read Connections](https://mikro-orm.io/zh-Hans/zh-Hans/docs/read-connections.md) sections.
...
Read more about this in [Using Multiple Schemas](https://mikro-orm.io/zh-Hans/zh-Hans/docs/multiple-schemas.md#sqlite-attach-database) section.
...
Read more about this in [Naming Strategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md) section.
...
Read more about this in [Repositories](https://mikro-orm.io/zh-Hans/zh-Hans/docs/repositories.md) section.
...
Read more about this in [Property Validation](https://mikro-orm.io/zh-Hans/zh-Hans/docs/property-validation.md) section.
...
Read more about this in [Debugging](https://mikro-orm.io/zh-Hans/zh-Hans/docs/logging.md) section.
...
Read more about this in [Entity Manager](https://mikro-orm.io/zh-Hans/zh-Hans/docs/entity-manager.md#handling-not-found-entities) docs.
...
Read more about this in [Migrations](https://mikro-orm.io/zh-Hans/zh-Hans/docs/migrations.md) section.
...
Read more about this in [seeding docs](https://mikro-orm.io/zh-Hans/zh-Hans/docs/seeding.md).
...
Read more about this in [Metadata Cache](https://mikro-orm.io/zh-Hans/zh-Hans/docs/metadata-cache.md) section.
...
You can ignore all or only specific deprecation warnings. See [Logging's section on deprecation warnings](https://mikro-orm.io/zh-Hans/zh-Hans/docs/logging.md#deprecation-warnings) for details.
