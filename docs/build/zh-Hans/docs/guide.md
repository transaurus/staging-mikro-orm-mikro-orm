...
This guide focuses on "code first" approach to developing the application, but MikroORM can also be used with a "schema first" approach. Check out [the "schema first" guide](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-first-guide.md) for more details on that.
