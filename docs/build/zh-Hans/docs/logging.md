...
You can see a list of deprecation errors in [Configuration's section on deprecated warnings](https://mikro-orm.io/zh-Hans/zh-Hans/docs/configuration.md#deprecation-warnings).
...
It may often be beneficial to log the origin of a query when using [`EntityManager.find`](https://mikro-orm.io/zh-Hans/zh-Hans/docs/entity-manager.md#fetching-entities-with-entitymanager) or [`EntityManager.findOne`](https://mikro-orm.io/zh-Hans/zh-Hans/docs/entity-manager.md#fetching-entities-with-entitymanager) for debugging and redundancy elimination purposes.
