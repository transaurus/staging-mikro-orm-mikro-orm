...
## Creating a SQL Driver[​](#creating-a-sql-driver "Direct link to Creating a SQL Driver")
...
### Using the custom driver[​](#using-the-custom-driver "Direct link to Using the custom driver")
...
## Creating a Non-SQL Driver[​](#creating-a-non-sql-driver "Direct link to Creating a Non-SQL Driver")
...
### Platform[​](#platform-1 "Direct link to Platform")
...
### Driver[​](#driver-1 "Direct link to Driver")
...
## Custom SQLite driver[​](#custom-sqlite-driver "Direct link to Custom SQLite driver")

For SQLite-based databases, the `@mikro-orm/sql` package provides a generic `SqliteDriver` that works with any SQLite library via Kysely dialects. See the [SQLite guide](https://mikro-orm.io/zh-Hans/zh-Hans/docs/usage-with-sqlite.md#custom-sqlite-dialect) for details.
