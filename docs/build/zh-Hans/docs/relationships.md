...
You can also specify how operations on given entity should [cascade](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md) to the referred entity.
...
As you can see, OneToMany is the inverse side of ManyToOne (which is the owning side). More about how collections work can be found on [collections page](https://mikro-orm.io/zh-Hans/zh-Hans/docs/collections.md).

You can also specify how operations on given entity should [cascade](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md) to the referred entities. There is also more aggressive remove mode called [Orphan Removal](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#orphan-removal) (`books4` example).
...
### Owning Side[​](#owning-side "Direct link to Owning Side")
...
### Inverse Side[​](#inverse-side "Direct link to Inverse Side")
...
As you can see, relationships can be also self-referencing (all of them. OneToOne also supports [Orphan Removal](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md#orphan-removal)).
...
### Owning Side[​](#owning-side-1 "Direct link to Owning Side")
...
### Inverse Side[​](#inverse-side-1 "Direct link to Inverse Side")
...
Again, more information about how collections work can be found on [collections page](https://mikro-orm.io/zh-Hans/zh-Hans/docs/collections.md).

## Referencing Non-Primary Key Columns[​](#referencing-non-primary-key-columns "Direct link to Referencing Non-Primary Key Columns")
...
## Relations in ESM projects[​](#relations-in-esm-projects "Direct link to Relations in ESM projects")
...
## Custom foreign key constraint name[​](#custom-foreign-key-constraint-name "Direct link to Custom foreign key constraint name")
...
This name overrides the one automatically generated by the current [NamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/docs/naming-strategy.md).
...
## Disabling foreign key constraint creation[​](#disabling-foreign-key-constraint-creation "Direct link to Disabling foreign key constraint creation")
...
Polymorphic Relations vs Single Table Inheritance

Polymorphic relations are different from [Single Table Inheritance (STI)](https://mikro-orm.io/zh-Hans/zh-Hans/docs/inheritance-mapping.md#single-table-inheritance):
...
### Defining Polymorphic Relations[​](#defining-polymorphic-relations "Direct link to Defining Polymorphic Relations")
...
const UserLikeSchema = defineEntity({
  name: 'UserLike',
  properties: {
    id: p.number().primary(),
...
export class UserLike extends UserLikeSchema.class {}
...
### Loading Polymorphic Relations[​](#loading-polymorphic-relations "Direct link to Loading Polymorphic Relations")
...
### Loading Inverse Side[​](#loading-inverse-side "Direct link to Loading Inverse Side")
...
### Persisting Polymorphic Relations[​](#persisting-polymorphic-relations "Direct link to Persisting Polymorphic Relations")
...
### Discriminator Values[​](#discriminator-values "Direct link to Discriminator Values")
...
### Exposing the Discriminator for Querying[​](#exposing-the-discriminator-for-querying "Direct link to Exposing the Discriminator for Querying")
...
### Many-to-Many Polymorphic Relations[​](#many-to-many-polymorphic-relations "Direct link to Many-to-Many Polymorphic Relations")
...
#### How M<!-- -->:N<!-- --> Polymorphic Works[​](#how-m-polymorphic-works "Direct link to how-m-polymorphic-works")
...
#### Defining M<!-- -->:N<!-- --> Polymorphic Relations[​](#defining-m-polymorphic-relations "Direct link to defining-m-polymorphic-relations")
...
const VideoSchema = defineEntity({
  name: 'Video',
  properties: {
    id: p.number().primary(),
    url: p.string(),
...
export class Video extends VideoSchema.class {}
...
#### Discriminator Values[​](#discriminator-values-1 "Direct link to Discriminator Values")
...
#### Custom Discriminator Values[​](#custom-discriminator-values "Direct link to Custom Discriminator Values")
...
#### Using M<!-- -->:N<!-- --> Polymorphic Relations[​](#using-m-polymorphic-relations "Direct link to using-m-polymorphic-relations")
...
#### Differences from Regular M<!-- -->:N[​](#differences-from-regular-m "Direct link to differences-from-regular-m")
