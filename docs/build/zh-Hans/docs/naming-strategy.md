...
#### `NamingStrategy.manyToManyPropertyName(ownerEntityName: string, targetEntityName: string, pivotTableName: string, ownerTableName: string, schemaName?: string): string`[​](#namingstrategymanytomanypropertynameownerentityname-string-targetentityname-string-pivottablename-string-ownertablename-string-schemaname-string-string "Direct link to namingstrategymanytomanypropertynameownerentityname-string-targetentityname-string-pivottablename-string-ownertablename-string-schemaname-string-string")
...
#### `NamingStrategy.discriminatorColumnName(baseName: string): string`[​](#namingstrategydiscriminatorcolumnnamebasename-string-string "Direct link to namingstrategydiscriminatorcolumnnamebasename-string-string")
