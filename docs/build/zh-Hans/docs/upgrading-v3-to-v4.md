...
If you want to use ts-morph, you need to install `@mikro-orm/reflection` package and enable the provider explicitly in the ORM config, as described [here](https://mikro-orm.io/zh-Hans/zh-Hans/docs/metadata-providers.md#tsmorphmetadataprovider).
...
Using `ReflectMetadataProvider` has some limitations, so be sure to read about them [here](https://mikro-orm.io/zh-Hans/zh-Hans/docs/metadata-providers.md#limitations-and-requirements).
