...
View entities represent actual database views that are created and managed by MikroORM's schema generator. Unlike [virtual entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/virtual-entities.md) which evaluate expressions at query time, view entities create persistent `CREATE VIEW` statements in your database.
...
> Note: MongoDB does not support view entities as it doesn't have the concept of database views. Use [virtual entities](https://mikro-orm.io/zh-Hans/zh-Hans/docs/virtual-entities.md) instead for MongoDB.
...
Read more about materialized views [in their own section](https://mikro-orm.io/zh-Hans/zh-Hans/docs/materialized-views.md).
