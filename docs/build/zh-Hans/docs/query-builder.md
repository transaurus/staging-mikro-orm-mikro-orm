...
`QueryBuilder` also supports [smart query conditions](https://mikro-orm.io/zh-Hans/zh-Hans/docs/query-conditions.md).
...
This is currently available only for filtering (`where`) and sorting (`orderBy`), only the root entity will be selected. To populate its relationships, you can use [`em.populate()`](https://mikro-orm.io/zh-Hans/zh-Hans/docs/populating-relations.md).
...
See [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/docs/kysely.md) for more details on the Kysely integration.
