...
## Debugging discovery[​](#debugging-discovery "Direct link to Debugging discovery")
...
## Explicit vs Folder-based Discovery[​](#explicit-vs-folder-based-discovery "Direct link to Explicit vs Folder-based Discovery")
...
### When to use explicit references[​](#when-to-use-explicit-references "Direct link to When to use explicit references")
...
### When to use folder-based discovery[​](#when-to-use-folder-based-discovery "Direct link to When to use folder-based discovery")
...
## Synchronous initialization limitation[​](#synchronous-initialization-limitation "Direct link to Synchronous initialization limitation")
...
## Multiple entity locations[​](#multiple-entity-locations "Direct link to Multiple entity locations")
