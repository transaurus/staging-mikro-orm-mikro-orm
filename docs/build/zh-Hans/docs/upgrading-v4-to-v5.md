...
Previously awaiting of QB instance was a no-op. In v5, QB is promise-like interface, so we can await it. More about this in [Executing the Query](https://mikro-orm.io/zh-Hans/zh-Hans/docs/query-builder.md#executing-the-query) section.
