...
Check the [Modeling Entity Relationships](https://mikro-orm.io/zh-Hans/zh-Hans/docs/relationships.md) section in the documentation for more details and examples for each of the types.
...
If you carefully checked this snippet, you probably found that new mysterious [`em.clear()`](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md#clear) call. What does it do? It clears the context for the [`EntityManager`](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md), meaning it will detach all the entities it was managing. It will bring the [`EntityManager`](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md) to the same state as if you would create a fresh fork via [`em.fork()`](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md#fork). You won't usually need this in your app, but it is very handy for unit testing, to simulate new requests coming in. You may as well use forks explicitly if you want.
...
With `.onCreate()`, the `slug` and `description` properties are automatically optional in [`em.create()`](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md#create) - no additional type configuration needed!
...
Refer to the [Collections section](https://mikro-orm.io/zh-Hans/zh-Hans/docs/collections.md) in the docs for more information and examples.
...
> The discovery phase (which happens during `MikroORM.init()` or `new MikroORM()`) is required for propagation to work. See the [Propagation](https://mikro-orm.io/zh-Hans/zh-Hans/docs/propagation.md) docs for more details.

Read more about [Cascading](https://mikro-orm.io/zh-Hans/zh-Hans/docs/cascading.md) in the documentation.
