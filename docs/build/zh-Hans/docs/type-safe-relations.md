...
### Defining References[​](#defining-references "Direct link to Defining References")
...
### Using References[​](#using-references "Direct link to Using References")
...
### Type-Safe Access with `$`[​](#type-safe-access-with- "Direct link to type-safe-access-with-")
...
### Using `Loaded` in Function Signatures[​](#using-loaded-in-function-signatures "Direct link to using-loaded-in-function-signatures")
...
## Assigning References[​](#assigning-references "Direct link to Assigning References")
...
Another way is to use `toReference()` method available as part of the [`wrap()` helper](https://mikro-orm.io/zh-Hans/zh-Hans/docs/wrap-helper.md):
...
## Primary Key Access[​](#primary-key-access "Direct link to Primary Key Access")
...
### Nullable Scalars[​](#nullable-scalars "Direct link to Nullable Scalars")
