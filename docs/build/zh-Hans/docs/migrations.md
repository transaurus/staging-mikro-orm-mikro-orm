...
### Working with `EntityManager`[​](#working-with-entitymanager "Direct link to working-with-entitymanager")
...
You can also override those options using the [environment variables](https://mikro-orm.io/zh-Hans/zh-Hans/docs/configuration.md#using-environment-variables):
...
## Running migrations in production[​](#running-migrations-in-production "Direct link to Running migrations in production")
...
## Using custom `MigrationGenerator`[​](#using-custom-migrationgenerator "Direct link to using-custom-migrationgenerator")
...
## Using via CLI[​](#using-via-cli "Direct link to Using via CLI")
...
## Using the Migrator programmatically[​](#using-the-migrator-programmatically "Direct link to Using the Migrator programmatically")
...
## Providing transaction context[​](#providing-transaction-context "Direct link to Providing transaction context")
...
## Importing migrations statically[​](#importing-migrations-statically "Direct link to Importing migrations statically")
...
## Using custom migration names[​](#using-custom-migration-names "Direct link to Using custom migration names")
...
## MongoDB support[​](#mongodb-support "Direct link to MongoDB support")
...
### Migration class[​](#migration-class-1 "Direct link to Migration class")
