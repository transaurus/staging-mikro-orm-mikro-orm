...
For more examples, take a look at [defining entities section](https://mikro-orm.io/zh-Hans/zh-Hans/docs/defining-entities.md).
...
If you used `SchemaGenerator`, now there is CLI tool you can use instead. Learn more in [SchemaGenerator docs](https://mikro-orm.io/zh-Hans/zh-Hans/docs/schema-generator.md). To set up CLI, take a look at [installation section](https://mikro-orm.io/zh-Hans/zh-Hans/docs/quick-start.md).
