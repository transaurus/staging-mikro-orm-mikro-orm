...
## Persisting Managed Entities[​](#persisting-managed-entities "Direct link to Persisting Managed Entities")
...
## Entities with explicit primary key[​](#entities-with-explicit-primary-key "Direct link to Entities with explicit primary key")
...
## How MikroORM Detects Changes[​](#how-mikroorm-detects-changes "Direct link to How MikroORM Detects Changes")
...
## Flush Modes[​](#flush-modes "Direct link to Flush Modes")
