...
## Defining the Outbox Entity[​](#defining-the-outbox-entity "Direct link to Defining the Outbox Entity")
...
## Writing Events Inside the Transaction[​](#writing-events-inside-the-transaction "Direct link to Writing Events Inside the Transaction")
...
### Automating with an onFlush Subscriber[​](#automating-with-an-onflush-subscriber "Direct link to Automating with an onFlush Subscriber")
...
## Why Not Emit Events in a Hook?[​](#why-not-emit-events-in-a-hook "Direct link to Why Not Emit Events in a Hook?")
