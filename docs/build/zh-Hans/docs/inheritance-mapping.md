...
## See also: Polymorphic Relations[​](#see-also-polymorphic-relations "Direct link to See also: Polymorphic Relations")

If you need a relationship that can point to multiple unrelated entity types (each with their own table), consider using [Polymorphic Relations](https://mikro-orm.io/zh-Hans/zh-Hans/docs/relationships.md#polymorphic-relations) instead of inheritance.
...
## Table-Per-Type Inheritance (TPT)[​](#table-per-type-inheritance-tpt "Direct link to Table-Per-Type Inheritance (TPT)")
...
### Generated Schema[​](#generated-schema "Direct link to Generated Schema")
...
### How TPT Works[​](#how-tpt-works "Direct link to How TPT Works")
...
#### SELECT Operations[​](#select-operations "Direct link to SELECT Operations")
...
### Multi-level Inheritance[​](#multi-level-inheritance "Direct link to Multi-level Inheritance")
...
### Design-time Considerations[​](#design-time-considerations-1 "Direct link to Design-time Considerations")
...
### Performance Impact[​](#performance-impact-1 "Direct link to Performance Impact")
...
### STI vs TPT Comparison[​](#sti-vs-tpt-comparison "Direct link to STI vs TPT Comparison")
...
### Mixing STI and TPT[​](#mixing-sti-and-tpt "Direct link to Mixing STI and TPT")
