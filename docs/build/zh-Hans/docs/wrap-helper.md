...
## `wrap()` vs `BaseEntity`[​](#wrap-vs-baseentity "Direct link to wrap-vs-baseentity")
...
### Serialization Methods[​](#serialization-methods "Direct link to Serialization Methods")
...
See [Serializing](https://mikro-orm.io/zh-Hans/zh-Hans/docs/serializing.md) for detailed serialization options.
...
### Reference Methods[​](#reference-methods "Direct link to Reference Methods")
...
### Schema Methods[​](#schema-methods "Direct link to Schema Methods")
...
### Accessing Internal Properties[​](#accessing-internal-properties "Direct link to Accessing Internal Properties")
...
## Updating Entities with `assign()`[​](#updating-entities-with-assign "Direct link to updating-entities-with-assign")
...
### Assigning to Unmanaged Entities[​](#assigning-to-unmanaged-entities "Direct link to Assigning to Unmanaged Entities")
...
### Merging Object Properties[​](#merging-object-properties "Direct link to Merging Object Properties")
...
### Updating Nested Relations[​](#updating-nested-relations "Direct link to Updating Nested Relations")
...
### Updating Collections[​](#updating-collections "Direct link to Updating Collections")
...
### Using Class-Based DTOs[​](#using-class-based-dtos "Direct link to Using Class-Based DTOs")
