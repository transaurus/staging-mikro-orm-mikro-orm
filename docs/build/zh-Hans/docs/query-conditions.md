...
## List of supported operators[​](#list-of-supported-operators "Direct link to List of supported operators")
...
## Regular Expressions[​](#regular-expressions "Direct link to Regular Expressions")
...
## Full text searching[​](#full-text-searching "Direct link to Full text searching")
...
### MySQL, MariaDB[​](#mysql-mariadb "Direct link to MySQL, MariaDB")
