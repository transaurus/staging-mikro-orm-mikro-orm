...
![](/zh-Hans/assets/images/improving-72dbe2591f1b332382c450a3aa344c19.jpg)

### Quick summary of 5.x releases[​](#quick-summary-of-5x-releases "Direct link to Quick summary of 5.x releases")
...
![](/zh-Hans/assets/images/typesafe-ded61effb5f36721c35543f1709e2aba.jpg)
...
### `Opt` type[​](#opt-type "Direct link to opt-type")
...
### `Hidden` type[​](#hidden-type "Direct link to hidden-type")
...
### Populate based on filter[​](#populate-based-on-filter "Direct link to Populate based on filter")
...
### Primary key type inference[​](#primary-key-type-inference "Direct link to Primary key type inference")
...
### Simplified `BaseEntity`[​](#simplified-baseentity "Direct link to simplified-baseentity")
...
![](/zh-Hans/assets/images/godeeper-7f0c4eb4f249ec5735bc893d6484eae5.jpg)
...
### `forceObject`[​](#forceobject "Direct link to forceobject")
...
## Joined strategy[​](#joined-strategy "Direct link to Joined strategy")

![](/zh-Hans/assets/images/join-c1d441452a76f90e14adc4614b565cf7.jpg)
...
## Filters on relations[​](#filters-on-relations "Direct link to Filters on relations")
...
## Raw SQL fragments[​](#raw-sql-fragments "Direct link to Raw SQL fragments")

![](/zh-Hans/assets/images/let-the-raw-08dd7a08b58314498b7ec60bb036b748.jpg)
...
## Subquery operators `$some`, `$none` and `$every`[​](#subquery-operators-some-none-and-every "Direct link to subquery-operators-some-none-and-every")
...
## Subquery joining[​](#subquery-joining "Direct link to Subquery joining")
...
## Dataloader support for references and collections[​](#dataloader-support-for-references-and-collections "Direct link to Dataloader support for references and collections")

![](/zh-Hans/assets/images/dataloader-0f04774a3b5d93e633ba4b59db7e292c.jpg)
...
## Improved change-tracking of M<!-- -->:N<!-- --> relations[​](#improved-change-tracking-of-m-relations "Direct link to improved-change-tracking-of-m-relations")
...
![](/zh-Hans/assets/images/extension-15fd00c48a9842a00587959a5df94fb8.jpg)
...
## `GeneratedCacheAdapter` for production usage[​](#generatedcacheadapter-for-production-usage "Direct link to generatedcacheadapter-for-production-usage")
...
## Entity Generator improvements[​](#entity-generator-improvements "Direct link to Entity Generator improvements")
...
## Inference of default values[​](#inference-of-default-values "Direct link to Inference of default values")
...
## Other notable changes[​](#other-notable-changes "Direct link to Other notable changes")
...
And *many many* more, see the [full changelog here](https://github.com/mikro-orm/mikro-orm/blob/master/CHANGELOG.md#600-2024-01-08). Also be sure to check the [upgrading guide](https://mikro-orm.io/docs/upgrading-v5-to-v6).

## One more thing…[​](#one-more-thing "Direct link to One more thing…")

![](/zh-Hans/assets/images/one-more-thing-jobs-0bee26be8f438d8e61c8bc95b1095167.webp)
...
* [typescript](https://mikro-orm.io/zh-Hans/zh-Hans/blog/tags/typescript.md)
* [javascript](https://mikro-orm.io/zh-Hans/zh-Hans/blog/tags/javascript.md)
* [node](https://mikro-orm.io/zh-Hans/zh-Hans/blog/tags/node.md)
* [sql](https://mikro-orm.io/zh-Hans/zh-Hans/blog/tags/sql.md)
