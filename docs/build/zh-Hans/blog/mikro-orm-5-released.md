...
### Quick summary of 4.x releases[​](#quick-summary-of-4x-releases "Direct link to Quick summary of 4.x releases")
...
### Improved type safety[​](#improved-type-safety "Direct link to Improved type safety")
...
### Validation improvements[​](#validation-improvements "Direct link to Validation improvements")
...
### Reworked schema diffing[​](#reworked-schema-diffing "Direct link to Reworked schema diffing")
...
### Smarter migrations[​](#smarter-migrations "Direct link to Smarter migrations")
...
### Auto-flush mode[​](#auto-flush-mode "Direct link to Auto-flush mode")
...
### Automatic refreshing of loaded entities[​](#automatic-refreshing-of-loaded-entities "Direct link to Automatic refreshing of loaded entities")
...
### Seeder package[​](#seeder-package "Direct link to Seeder package")
...
### Populating lazy scalar properties[​](#populating-lazy-scalar-properties "Direct link to Populating lazy scalar properties")
...
### Creating references without EntityManager[​](#creating-references-without-entitymanager "Direct link to Creating references without EntityManager")
...
### Smarter `expr` helper[​](#smarter-expr-helper "Direct link to smarter-expr-helper")
...
### Awaitable QueryBuilder[​](#awaitable-querybuilder "Direct link to Awaitable QueryBuilder")
...
### Wildcard schema entities[​](#wildcard-schema-entities "Direct link to Wildcard schema entities")
...
### Deep assigning of entities[​](#deep-assigning-of-entities "Direct link to Deep assigning of entities")
...
### Experimental support for ES modules[​](#experimental-support-for-es-modules "Direct link to Experimental support for ES modules")
...
* and *many many* more, see the [full changelog here](https://github.com/mikro-orm/mikro-orm/blob/master/CHANGELOG.md#500-rc2-2022-02-03)
...
* allow specifying pivot entity for M
  <!-- -->
  :N
  <!-- -->
  relations (so we can have additional columns there, but still map it as M
  <!-- -->
  :N
  <!-- -->
