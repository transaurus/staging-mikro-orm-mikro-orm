...
## Fine-grained control over upserting[​](#fine-grained-control-over-upserting "Direct link to Fine-grained control over upserting")
...
## Filters with Joined loading strategy[​](#filters-with-joined-loading-strategy "Direct link to Filters with Joined loading strategy")
...
## New `Collection` helpers[​](#new-collection-helpers "Direct link to new-collection-helpers")
...
## Smaller improvements worth mentioning[​](#smaller-improvements-worth-mentioning "Direct link to Smaller improvements worth mentioning")
...
## What about v6?[​](#what-about-v6 "Direct link to What about v6?")
