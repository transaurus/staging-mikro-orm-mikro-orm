...
* AbstractMigrator<[AbstractSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlDriver.md)>
  * *Migrator*
...
* ****new Migrator**(em): [Migrator](https://mikro-orm.io/zh-Hans/zh-Hans/api/migrations/class/Migrator.md)
...
- Overrides AbstractMigrator\<AbstractSqlDriver>.constructor
  ...
  * ##### em: [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[AbstractSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlDriver.md)<[AbstractSqlConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlConnection.md), [AbstractSqlPlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlPlatform.md)>>
  ...
  #### Returns [Migrator](https://mikro-orm.io/zh-Hans/zh-Hans/api/migrations/class/Migrator.md)
...
* ****create**(path, blank, initial, name): Promise<[MigrationResult](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationResult)>
...
- Overrides AbstractMigrator.create
  ...
  * ##### optionalname: string
  ...
  #### Returns Promise<[MigrationResult](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationResult)>
...
* ****createInitial**(path, name, blank): Promise<[MigrationResult](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationResult)>
...
* ****down**(options): Promise<[MigrationInfo](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationInfo)\[]>
...
- Inherited from AbstractMigrator.down
  ...
  * ##### optionaloptions: string | string\[] | Omit\<MigrateOptions, from>
  ...
  #### Returns Promise<[MigrationInfo](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationInfo)\[]>
...
* ****getExecuted**(): Promise<[MigrationRow](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationRow)\[]>
...
* ****getPending**(): Promise<[MigrationInfo](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationInfo)\[]>
...
* ****getStorage**(): [MigrationStorage](https://mikro-orm.io/zh-Hans/zh-Hans/api/migrations/class/MigrationStorage.md)
...
- Inherited from AbstractMigrator.off
  ...
  * ##### eventName: [MigratorEvent](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigratorEvent)
  * ##### listener: (event) => [MaybePromise](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MaybePromise)\<void>
...
* ****up**(options): Promise<[MigrationInfo](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MigrationInfo)\[]>
