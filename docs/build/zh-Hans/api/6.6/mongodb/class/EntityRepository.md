...
* [EntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EntityRepository.md)\<T>
  * *EntityRepository*
...
### [**](#constructor)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/mongodb/src/MongoEntityRepository.ts#L7)constructor

* ****new EntityRepository**\<T>(em, entityName): [MongoEntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/EntityRepository.md)\<T>

- Overrides EntityRepository.constructor

  #### Parameters

  * ##### em: [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/MongoDriver.md)>
  * ##### entityName: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#EntityName)\<T>

  #### Returns [MongoEntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/EntityRepository.md)\<T>

## Methods<!-- -->[**](#Methods)

### [**](#aggregate)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/mongodb/src/MongoEntityRepository.ts#L15)aggregate
...
- Inherited from EntityRepository.count
  ...
  * ##### options: [CountOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/CountOptions.md)\<T, Hint> = <!-- -->{}
...
- Inherited from EntityRepository.create
  ...
  * ##### data: [RequiredEntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#RequiredEntityData)\<T, never, Convert>
...
* ****find**\<Hint, Fields, Excludes>(where, options): Promise<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>\[]>
...
- Inherited from EntityRepository.find
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/FindOptions.md)\<T, Hint, Fields, Excludes>

  #### Returns Promise<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>\[]>
...
* ****findAll**\<Hint, Fields, Excludes>(options): Promise<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>\[]>
...
- Inherited from EntityRepository.findAll
  ...
  * ##### optionaloptions: [FindAllOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/FindAllOptions.md)\<T, Hint, Fields, Excludes>
...
* ****findAndCount**\<Hint, Fields, Excludes>(where, options): Promise<\[[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>\[], number]>
...
- Inherited from EntityRepository.findAndCount
  ...
  * ##### optionaloptions: [FindOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/FindOptions.md)\<T, Hint, Fields, Excludes>
  ...
  #### Returns Promise<\[[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>\[], number]>
...
* ****findByCursor**\<Hint, Fields, Excludes, IncludeCount>(where, options): Promise<[Cursor](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Cursor.md)\<T, Hint, Fields, Excludes, IncludeCount>>
...
- Inherited from EntityRepository.findByCursor
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#FilterQuery)\<T>
  * ##### options: [FindByCursorOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/FindByCursorOptions.md)\<T, Hint, Fields, Excludes, IncludeCount>

  #### Returns Promise<[Cursor](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Cursor.md)\<T, Hint, Fields, Excludes, IncludeCount>>
...
* ****findOne**\<Hint, Fields, Excludes>(where, options): Promise\<null | [Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>>
...
- Inherited from EntityRepository.findOne
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/FindOneOptions.md)\<T, Hint, Fields, Excludes>

  #### Returns Promise\<null | [Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>>
...
* ****findOneOrFail**\<Hint, Fields, Excludes>(where, options): Promise<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>>
...
- Inherited from EntityRepository.findOneOrFail
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOneOrFailOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/FindOneOrFailOptions.md)\<T, Hint, Fields, Excludes>

  #### Returns Promise<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<T, Hint, Fields, Excludes>>

### [**](#getCollection)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/mongodb/src/MongoEntityRepository.ts#L19)getCollection

* ****getCollection**(): Collection\<T>

- #### Returns Collection\<T>

### [**](#getEntityManager)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/mongodb/src/MongoEntityRepository.ts#L26)getEntityManager

* ****getEntityManager**(): [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/MongoDriver.md)>
...
- Overrides EntityRepository.getEntityManager
  ...
  ***
  ...
  #### Returns [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mongodb/class/MongoDriver.md)>
...
* ****getReference**(id, options): [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Ref)\<T>
* ****getReference**(id): T
...
- Inherited from EntityRepository.insert
  ...
  * ##### data: T | [RequiredEntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#RequiredEntityData)\<T>
  * ##### optionaloptions: [NativeInsertUpdateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/NativeInsertUpdateOptions.md)\<T>
  ...
  #### Returns Promise\<T extends { \[PrimaryKeyProp]?<!-- -->: PK } ? PK extends undefined ? Omit\<T\<T>, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#PrimaryKeyProp)> : PK extends keyof<!-- --> T\<T> ? ReadonlyPrimary\<UnwrapPrimary\<T\<T>\[PK\<PK>]>> : PK extends keyof<!-- --> T\<T>\[] ? ReadonlyPrimary\<PrimaryPropToType\<T\<T>, PK\<PK>>> : PK : T extends { \_id?<!-- -->: PK } ? string | ReadonlyPrimary\<PK> : T extends { id?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T extends { uuid?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T>
...
- Inherited from EntityRepository.merge
  ...
  * ##### data: T | [EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#EntityData)\<T>
...
- Inherited from EntityRepository.nativeUpdate
  ...
  * ##### optionaloptions: [UpdateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/UpdateOptions.md)\<T>
...
- Inherited from EntityRepository.upsert
  ...
  * ##### optionalentityOrData: T | [EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#EntityData)\<T>
  * ##### optionaloptions: [UpsertOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/UpsertOptions.md)\<T, Fields>
...
- Inherited from EntityRepository.upsertMany
  ...
  * ##### optionalentitiesOrData: [EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#EntityData)\<T>\[] | T\[]
  * ##### optionaloptions: [UpsertManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/UpsertManyOptions.md)\<T, Fields>
