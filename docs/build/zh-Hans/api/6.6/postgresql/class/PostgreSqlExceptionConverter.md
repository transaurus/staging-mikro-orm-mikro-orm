...
* ****new PostgreSqlExceptionConverter**(): [PostgreSqlExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/postgresql/class/PostgreSqlExceptionConverter.md)

- Inherited from ExceptionConverter.constructor

  #### Returns [PostgreSqlExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/postgresql/class/PostgreSqlExceptionConverter.md)
