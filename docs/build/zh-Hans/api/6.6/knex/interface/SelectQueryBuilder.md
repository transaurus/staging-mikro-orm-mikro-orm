...
* [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/knex/class/QueryBuilder.md)\<Entity, RootAlias, Hint, Context>
  * *SelectQueryBuilder*
...
* ****then**\<TResult1, TResult2>(onfulfilled, onrejected): Promise<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<Entity, Hint>\[]>
