...
- #### Parameters
  ...
  * ##### args: [EventArgs](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/EventArgs.md)\<T>
...
- #### Parameters
  ...
  * ##### args: [FlushEventArgs](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/FlushEventArgs.md)
...
* ****getSubscribedEntities**(): [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#EntityName)\<T>\[]

- #### Returns [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#EntityName)\<T>\[]
