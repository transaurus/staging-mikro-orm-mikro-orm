...
* ****new MediumIntType**(): [MediumIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/MediumIntType.md)

- Inherited from IntegerType.constructor

  #### Returns [MediumIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/MediumIntType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/IntegerType.ts#L11)inheritedcompareAsType
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/IntegerType.ts#L15)inheritedensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/MediumIntType.ts#L7)getColumnType
