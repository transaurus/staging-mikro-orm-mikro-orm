...
* ****new SmallIntType**(): [SmallIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/SmallIntType.md)

- Inherited from Type.constructor

  #### Returns [SmallIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/SmallIntType.md)
