...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Type.md)\<string | null | undefined>
  * *UuidType*
...
* ****new UuidType**(): [UuidType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/UuidType.md)

- Inherited from Type.constructor

  #### Returns [UuidType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/UuidType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/UuidType.ts#L11)compareAsType
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/UuidType.ts#L15)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/UuidType.ts#L7)getColumnType
