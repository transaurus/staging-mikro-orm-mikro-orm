...
* ****new EntityCaseNamingStrategy**(): [EntityCaseNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EntityCaseNamingStrategy.md)

- Inherited from AbstractNamingStrategy.constructor

  #### Returns [EntityCaseNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EntityCaseNamingStrategy.md)
