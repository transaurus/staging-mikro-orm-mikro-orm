...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Type.md)\<boolean | null | undefined, boolean | null | undefined>
  * *BooleanType*
...
* ****new BooleanType**(): [BooleanType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/BooleanType.md)

- Inherited from Type.constructor

  #### Returns [BooleanType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/BooleanType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/BooleanType.ts#L11)compareAsType
...
* ****convertToJSValue**(value, platform, context): undefined | null | boolean
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/BooleanType.ts#L15)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/BooleanType.ts#L7)getColumnType
