...
* ****new Cursor**\<Entity, Hint, Fields, Excludes, IncludeCount>(items, totalCount, options, meta): [Cursor](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Cursor.md)\<Entity, Hint, Fields, Excludes, IncludeCount>

- #### Parameters

  * ##### items: [Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<Entity, Hint, Fields, Excludes>\[]
  ...
  * ##### meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EntityMetadata.md)\<Entity>

  #### Returns [Cursor](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Cursor.md)\<Entity, Hint, Fields, Excludes, IncludeCount>
...
* ****\[iterator]**(): IterableIterator<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<Entity, Hint, Fields, Excludes>, any, any>

- #### Returns IterableIterator<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<Entity, Hint, Fields, Excludes>, any, any>
...
- Computes the cursor value for a given entity.
  ...
  * ##### entity: Entity | [Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Loaded)\<Entity, Hint, Fields, Excludes>
...
- Computes the cursor value for given entity and order definition.
  ...
  * ##### meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EntityMetadata.md)\<Entity>
  * ##### entity: [FilterObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#FilterObject)\<Entity>
  * ##### orderBy: [OrderDefinition](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#OrderDefinition)\<Entity>
...
* ****getDefinition**\<Entity>(meta, orderBy): \[never, [QueryOrder](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/enum/QueryOrder.md)]\[]
...
- #### Parameters
  ...
  * ##### orderBy: [OrderDefinition](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#OrderDefinition)\<Entity>
  ...
  #### Returns \[never, [QueryOrder](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/enum/QueryOrder.md)]\[]
