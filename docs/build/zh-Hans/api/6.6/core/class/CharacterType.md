...
* ****new CharacterType**(): [CharacterType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/CharacterType.md)

- Inherited from StringType.constructor

  #### Returns [CharacterType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/CharacterType.md)
