...
* [ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/ArrayType.md)\<T>
  * *EnumArrayType*
...
* ****new EnumArrayType**\<T>(owner, items, hydrate): [EnumArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EnumArrayType.md)\<T>
...
- Overrides ArrayType.constructor
  ...
  * ##### hydrate: (i) => T = <!-- -->...
  ...
  #### Returns [EnumArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EnumArrayType.md)\<T>
