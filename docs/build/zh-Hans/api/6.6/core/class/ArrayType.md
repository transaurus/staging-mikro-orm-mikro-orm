...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Type.md)\<T\[] | null, string | null>
  * *ArrayType*
...
### [**](#constructor)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/ArrayType.ts#L9)constructor

* ****new ArrayType**\<T>(toJsValue, toDbValue): [ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/ArrayType.md)\<T>
...
- Overrides Type.constructor
  ...
  *
  ...
  #### Returns [ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/ArrayType.md)\<T>
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/ArrayType.ts#L45)compareAsType
...
### [**](#convertToDatabaseValue)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/ArrayType.ts#L16)convertToDatabaseValue
...
### [**](#convertToJSValue)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/ArrayType.ts#L33)convertToJSValue
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/ArrayType.ts#L53)getColumnType
...
### [**](#toJSON)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/ArrayType.ts#L49)toJSON
