...
* ****new EnumType**(): [EnumType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EnumType.md)

- Inherited from Type.constructor

  #### Returns [EnumType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EnumType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/EnumType.ts#L15)compareAsType
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/EnumType.ts#L19)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/EnumType.ts#L7)getColumnType
