...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Type.md)\<JSTypeByMode\<Mode>, string>
  * *DecimalType*
...
* ****new DecimalType**\<Mode>(mode): [DecimalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/DecimalType.md)\<Mode>
...
- Overrides Type.constructor
  ...
  * ##### optionalmode: Mode
  ...
  #### Returns [DecimalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/DecimalType.md)\<Mode>
