...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Type.md)\<unknown, string | null>
  * *JsonType*
...
* ****new JsonType**(): [JsonType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/JsonType.md)

- Inherited from Type.constructor

  #### Returns [JsonType](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/JsonType.md)
...
### [**](#runtimeType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L46)runtimeType
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L42)compareAsType
...
### [**](#convertToDatabaseValue)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L7)convertToDatabaseValue
...
### [**](#convertToDatabaseValueSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L19)convertToDatabaseValueSQL
...
### [**](#convertToJSValue)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L23)convertToJSValue
...
### [**](#convertToJSValueSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L15)convertToJSValueSQL
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L38)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/types/JsonType.ts#L34)getColumnType
