...
* ****new SqlitePlatform**(): [SqlitePlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqlitePlatform.md)

- Inherited from BaseSqlitePlatform.constructor

  #### Returns [SqlitePlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqlitePlatform.md)
