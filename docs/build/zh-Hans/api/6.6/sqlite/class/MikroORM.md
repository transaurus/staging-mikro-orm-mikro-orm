...
* [MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/MikroORM.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqliteDriver.md), EM>
  * *MikroORM*
...
* ****new MikroORM**\<EM>(options): [SqliteMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/MikroORM.md)\<EM>

- Inherited from MikroORM.constructor

  #### Parameters

  * ##### options: [Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Options)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqliteDriver.md), EM> | [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Configuration.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqliteDriver.md), EM>

  #### Returns [SqliteMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/MikroORM.md)\<EM>

## Properties<!-- -->[**](#Properties)

### [**](#config)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/MikroORM.ts#L16)readonlyinheritedconfig

**config: [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Configuration.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqliteDriver.md), [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/knex/class/EntityManager.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqliteDriver.md)> & [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EntityManager.md)<[IDatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/IDatabaseDriver.md)<[Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Connection.md)>>>
...
* ****connect**(): Promise<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqliteDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/sqlite/class/SqliteDriver.md)>
...
### [**](#init)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/sqlite/src/SqliteMikroORM.ts#L22)staticinit
...
### [**](#initSync)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/sqlite/src/SqliteMikroORM.ts#L29)staticinitSync
