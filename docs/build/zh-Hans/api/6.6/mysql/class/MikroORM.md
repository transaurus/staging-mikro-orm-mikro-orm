...
* [MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/MikroORM.md)<[MySqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MySqlDriver.md), EM>
  * *MikroORM*
...
* ****new MikroORM**\<EM>(options): [MySqlMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MikroORM.md)\<EM>

- Inherited from MikroORM.constructor

  #### Parameters

  * ##### options: [Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core.md#Options)<[MySqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MySqlDriver.md), EM> | [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Configuration.md)<[MySqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MySqlDriver.md), EM>

  #### Returns [MySqlMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MikroORM.md)\<EM>

## Properties<!-- -->[**](#Properties)

### [**](#config)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/core/src/MikroORM.ts#L16)readonlyinheritedconfig

**config: [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Configuration.md)<[MySqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MySqlDriver.md), [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/knex/class/EntityManager.md)<[MySqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MySqlDriver.md)> & [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/EntityManager.md)<[IDatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/interface/IDatabaseDriver.md)<[Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/core/class/Connection.md)>>>
...
* ****connect**(): Promise<[MySqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MySqlDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[MySqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mysql/class/MySqlDriver.md)>
...
### [**](#init)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/mysql/src/MySqlMikroORM.ts#L22)staticinit
...
### [**](#initSync)[**](https://github.com/mikro-orm/mikro-orm/blob/master/packages/mysql/src/MySqlMikroORM.ts#L29)staticinitSync
