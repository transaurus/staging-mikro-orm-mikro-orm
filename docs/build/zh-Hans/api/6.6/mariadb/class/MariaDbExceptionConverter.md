...
* ****new MariaDbExceptionConverter**(): [MariaDbExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mariadb/class/MariaDbExceptionConverter.md)

- Inherited from ExceptionConverter.constructor

  #### Returns [MariaDbExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/6.6/mariadb/class/MariaDbExceptionConverter.md)
