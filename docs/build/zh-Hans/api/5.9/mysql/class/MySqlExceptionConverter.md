...
* ****new MySqlExceptionConverter**(): [MySqlExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mysql/class/MySqlExceptionConverter.md)

- Inherited from ExceptionConverter.constructor

  #### Returns [MySqlExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mysql/class/MySqlExceptionConverter.md)

## Methods<!-- -->[**](#Methods)

### [**](#convertException)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/mysql/src/MySqlExceptionConverter.ts#L15)convertException
