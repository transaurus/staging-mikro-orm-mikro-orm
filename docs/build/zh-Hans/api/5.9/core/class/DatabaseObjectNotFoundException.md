...
* [ServerException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/ServerException.md)
  * *DatabaseObjectNotFoundException*
    * [TableNotFoundException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/TableNotFoundException.md)
...
* ****new DatabaseObjectNotFoundException**(previous): [DatabaseObjectNotFoundException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DatabaseObjectNotFoundException.md)
...
- Inherited from ServerException.constructor
  ...
  * ##### previous: Error
  ...
  #### Returns [DatabaseObjectNotFoundException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DatabaseObjectNotFoundException.md)
