...
* ****new NotFoundError**\<T>(message, entity): [NotFoundError](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/NotFoundError.md)\<T>
...
- Inherited from ValidationError.constructor
  ...
  * ##### optionalentity: T
  ...
  #### Returns [NotFoundError](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/NotFoundError.md)\<T>
...
### [**](#findExactlyOneFailed)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/errors.ts#L261)staticfindExactlyOneFailed

* ****findExactlyOneFailed**(name, where): [NotFoundError](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/NotFoundError.md)\<Partial\<any>>
...
- #### Parameters
  ...
  * ##### where: IPrimaryKeyValue | [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core.md#Dictionary)
  ...
  #### Returns [NotFoundError](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/NotFoundError.md)\<Partial\<any>>

### [**](#findOneFailed)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/errors.ts#L257)staticfindOneFailed

* ****findOneFailed**(name, where): [NotFoundError](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/NotFoundError.md)\<Partial\<any>>
