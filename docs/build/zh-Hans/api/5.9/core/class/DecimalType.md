...
* ****new DecimalType**(): [DecimalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DecimalType.md)

- Inherited from Type.constructor

  #### Returns [DecimalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DecimalType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DecimalType.ts#L14)compareAsType
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DecimalType.ts#L10)getColumnType
