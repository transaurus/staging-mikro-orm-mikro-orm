...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/Type.md)
  * *TimeType*
...
* ****new TimeType**(): [TimeType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/TimeType.md)

- Inherited from Type.constructor

  #### Returns [TimeType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/TimeType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/TimeType.ts#L16)compareAsType
...
### [**](#convertToDatabaseValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/TimeType.ts#L8)convertToDatabaseValue
...
* ****convertToJSValue**(value, platform): string
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/TimeType.ts#L20)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/TimeType.ts#L24)getColumnType
