...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/Type.md)\<unknown, string | null>
  * *JsonType*
...
* ****new JsonType**(): [JsonType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/JsonType.md)

- Inherited from Type.constructor

  #### Returns [JsonType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/JsonType.md)
...
### [**](#convertToDatabaseValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/JsonType.ts#L8)convertToDatabaseValue
...
### [**](#convertToDatabaseValueSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/JsonType.ts#L20)convertToDatabaseValueSQL
...
### [**](#convertToJSValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/JsonType.ts#L24)convertToJSValue

* ****convertToJSValue**(value, platform): unknown
...
### [**](#convertToJSValueSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/JsonType.ts#L16)convertToJSValueSQL
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/JsonType.ts#L32)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/JsonType.ts#L28)getColumnType
