...
* ****new DeadlockException**(previous): [DeadlockException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DeadlockException.md)
...
- Inherited from ServerException.constructor
  ...
  * ##### previous: Error
  ...
  #### Returns [DeadlockException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DeadlockException.md)
