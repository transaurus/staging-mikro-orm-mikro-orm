...
* ****new UnknownType**(): [UnknownType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/UnknownType.md)

- Inherited from StringType.constructor

  #### Returns [UnknownType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/UnknownType.md)
...
- Inherited from StringType.\[custom]
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/UnknownType.ts#L11)compareAsType

* ****compareAsType**(): string

- Overrides StringType.compareAsType
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/StringType.ts#L15)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/UnknownType.ts#L7)getColumnType
...
- Inherited from StringType.isCustomType
