...
* ****new NonUniqueFieldNameException**(previous): [NonUniqueFieldNameException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/NonUniqueFieldNameException.md)
...
- Inherited from ServerException.constructor
  ...
  * ##### previous: Error
  ...
  #### Returns [NonUniqueFieldNameException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/NonUniqueFieldNameException.md)
