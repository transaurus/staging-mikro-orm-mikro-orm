...
* ****new MediumIntType**(): [MediumIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/MediumIntType.md)

- Inherited from IntegerType.constructor

  #### Returns [MediumIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/MediumIntType.md)
...
- Inherited from IntegerType.\[custom]
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/MediumIntType.ts#L11)ensureComparable

* ****ensureComparable**(): boolean

- Overrides IntegerType.ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/MediumIntType.ts#L7)getColumnType
...
- Inherited from IntegerType.isCustomType
