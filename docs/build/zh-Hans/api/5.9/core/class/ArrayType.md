...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/Type.md)\<T\[] | null, string | null>
  * *ArrayType*
    * [EnumArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/EnumArrayType.md)
...
### [**](#constructor)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/ArrayType.ts#L9)constructor

* ****new ArrayType**\<T>(hydrate): [ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/ArrayType.md)\<T>
...
- Overrides Type.constructor
  ...
  * ##### hydrate: (i) => T = <!-- -->...
  ...
  #### Returns [ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/ArrayType.md)\<T>
...
### [**](#convertToDatabaseValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/ArrayType.ts#L13)convertToDatabaseValue
