...
* ****new SyntaxErrorException**(previous): [SyntaxErrorException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/SyntaxErrorException.md)
...
- Inherited from ServerException.constructor
  ...
  * ##### previous: Error
  ...
  #### Returns [SyntaxErrorException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/SyntaxErrorException.md)
