...
* ****new ReadOnlyException**(previous): [ReadOnlyException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/ReadOnlyException.md)
...
- Inherited from ServerException.constructor
  ...
  * ##### previous: Error
  ...
  #### Returns [ReadOnlyException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/ReadOnlyException.md)
