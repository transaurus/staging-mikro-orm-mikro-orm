...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/Type.md)\<Date, string>
  * *DateType*
...
* ****new DateType**(): [DateType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DateType.md)

- Inherited from Type.constructor

  #### Returns [DateType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/DateType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DateType.ts#L34)compareAsType
...
### [**](#convertToDatabaseValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DateType.ts#L8)convertToDatabaseValue
...
### [**](#convertToJSValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DateType.ts#L20)convertToJSValue

* ****convertToJSValue**(value, platform): Date
...
### [**](#ensureComparable)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DateType.ts#L38)ensureComparable
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DateType.ts#L42)getColumnType
...
### [**](#toJSON)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/DateType.ts#L46)toJSON
