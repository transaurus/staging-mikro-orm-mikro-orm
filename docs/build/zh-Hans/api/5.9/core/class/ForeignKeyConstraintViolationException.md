...
* ****new ForeignKeyConstraintViolationException**(previous): [ForeignKeyConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/ForeignKeyConstraintViolationException.md)
...
- Inherited from ConstraintViolationException.constructor
  ...
  * ##### previous: Error
  ...
  #### Returns [ForeignKeyConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/ForeignKeyConstraintViolationException.md)
