...
* ****new CheckConstraintViolationException**(previous): [CheckConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/CheckConstraintViolationException.md)
...
- Inherited from ConstraintViolationException.constructor
  ...
  * ##### previous: Error
  ...
  #### Returns [CheckConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/CheckConstraintViolationException.md)
