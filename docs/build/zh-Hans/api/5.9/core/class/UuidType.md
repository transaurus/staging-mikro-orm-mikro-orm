...
* ****new UuidType**(): [UuidType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/UuidType.md)

- Inherited from Type.constructor

  #### Returns [UuidType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/UuidType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/UuidType.ts#L11)compareAsType
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/UuidType.ts#L7)getColumnType
