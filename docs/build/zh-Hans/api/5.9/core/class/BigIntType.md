...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/Type.md)\<string | bigint | null | undefined, string | null | undefined>
  * *BigIntType*
...
* ****new BigIntType**(): [BigIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/BigIntType.md)

- Inherited from Type.constructor

  #### Returns [BigIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/BigIntType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/BigIntType.ts#L30)compareAsType
...
### [**](#convertToDatabaseValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/BigIntType.ts#L10)convertToDatabaseValue
...
### [**](#convertToJSValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/BigIntType.ts#L18)convertToJSValue

* ****convertToJSValue**(value): undefined | null | string
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/core/src/types/BigIntType.ts#L26)getColumnType
...
* ****toJSON**(value, platform): undefined | null | string | bigint
