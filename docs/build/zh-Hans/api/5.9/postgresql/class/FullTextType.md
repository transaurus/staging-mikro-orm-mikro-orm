...
* [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/Type.md)\<string, string>
  * *FullTextType*
...
* ****new FullTextType**(): [FullTextType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/postgresql/class/FullTextType.md)

- Inherited from Type.constructor

  #### Returns [FullTextType](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/postgresql/class/FullTextType.md)
...
### [**](#compareAsType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/postgresql/src/types/FullTextType.ts#L5)compareAsType
...
### [**](#convertToDatabaseValueSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/postgresql/src/types/FullTextType.ts#L13)convertToDatabaseValueSQL
...
### [**](#getColumnType)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/postgresql/src/types/FullTextType.ts#L9)getColumnType
