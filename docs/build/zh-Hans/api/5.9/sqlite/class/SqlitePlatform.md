...
* ****new SqlitePlatform**(): [SqlitePlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/sqlite/class/SqlitePlatform.md)

- Inherited from AbstractSqlPlatform.constructor

  #### Returns [SqlitePlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/sqlite/class/SqlitePlatform.md)

## Methods<!-- -->[**](#Methods)

### [**](#allowsComparingTuples)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L65)allowsComparingTuples
...
### [**](#convertsJsonAutomatically)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L61)convertsJsonAutomatically
...
### [**](#getBooleanTypeDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L53)getBooleanTypeDeclarationSQL
...
### [**](#getCurrentTimestampSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L21)getCurrentTimestampSQL
...
### [**](#getDateTimeTypeDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L25)getDateTimeTypeDeclarationSQL
...
### [**](#getDefaultPrimaryName)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L112)getDefaultPrimaryName
...
### [**](#getEnumTypeDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L29)getEnumTypeDeclarationSQL
...
### [**](#getFloatDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L49)getFloatDeclarationSQL
...
### [**](#getFullTextWhereClause)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L120)getFullTextWhereClause
...
### [**](#getIndexName)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L104)getIndexName
...
### [**](#getIntegerTypeDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L45)getIntegerTypeDeclarationSQL
...
### [**](#getSmallIntTypeDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L41)getSmallIntTypeDeclarationSQL
...
### [**](#getTinyIntTypeDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L37)getTinyIntTypeDeclarationSQL
...
### [**](#getVarcharTypeDeclarationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L57)getVarcharTypeDeclarationSQL
...
### [**](#processDateProperty)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L75)processDateProperty
...
### [**](#quoteValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L91)quoteValue
...
### [**](#quoteVersionValue)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L83)quoteVersionValue
...
### [**](#supportsDownMigrations)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L116)supportsDownMigrations
...
### [**](#usesDefaultKeyword)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L13)usesDefaultKeyword
...
### [**](#usesReturningStatement)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqlitePlatform.ts#L17)usesReturningStatement
