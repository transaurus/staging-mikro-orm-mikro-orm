...
* ****new SqliteExceptionConverter**(): [SqliteExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/sqlite/class/SqliteExceptionConverter.md)

- Inherited from ExceptionConverter.constructor

  #### Returns [SqliteExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/sqlite/class/SqliteExceptionConverter.md)

## Methods<!-- -->[**](#Methods)

### [**](#convertException)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/sqlite/src/SqliteExceptionConverter.ts#L14)convertException
