...
* [EntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core/class/EntityRepository.md)\<T>
  * *EntityRepository*
...
### [**](#constructor)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/mongodb/src/MongoEntityRepository.ts#L7)constructor

* ****new EntityRepository**\<T>(\_em, entityName): [MongoEntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/EntityRepository.md)\<T>
...
- Overrides EntityRepository.constructor
  ...
  * ##### \_em: [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/MongoDriver.md)>
  * ##### entityName: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/core.md#EntityName)\<T>

  #### Returns [MongoEntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/EntityRepository.md)\<T>

## Methods<!-- -->[**](#Methods)

### [**](#aggregate)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/mongodb/src/MongoEntityRepository.ts#L15)aggregate
...
### [**](#getCollection)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/mongodb/src/MongoEntityRepository.ts#L19)getCollection

* ****getCollection**(): Collection\<T>

- #### Returns Collection\<T>

### [**](#getEntityManager)[**](https://github.com/mikro-orm/mikro-orm/blob/0b5bb40ab/packages/mongodb/src/MongoEntityRepository.ts#L26)getEntityManager

* ****getEntityManager**(): [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/MongoDriver.md)>
...
- Overrides EntityRepository.getEntityManager
  ...
  ***
  ...
  #### Returns [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/5.9/mongodb/class/MongoDriver.md)>
