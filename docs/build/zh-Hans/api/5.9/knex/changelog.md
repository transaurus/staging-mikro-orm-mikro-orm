...
* **core:** ensure column name conflicts in M
  <!-- -->
  :N
  <!-- -->
  are propagated to STI child entities ([562515c](https://github.com/mikro-orm/mikro-orm/commit/562515c7b2141430cef4b0bb8f7a9517a2162594)), closes [#7123](https://github.com/mikro-orm/mikro-orm/issues/7123)
...
* **core:** normalize `populate` option in `Collection.matching()` for M
  <!-- -->
  :N
  <!-- -->
  relations ([#7091](https://github.com/mikro-orm/mikro-orm/issues/7091)) ([d9b996f](https://github.com/mikro-orm/mikro-orm/commit/d9b996fff09010c88e54b6e6748e2d98eae9f113))
...
* **sql:** fix populating M
  <!-- -->
  :N
  <!-- -->
  relations with `pivotEntity` that uses `mapToPk: true` ([cdd8f85](https://github.com/mikro-orm/mikro-orm/commit/cdd8f85d29749d8b6a173054563883cc54e0a3c4)), closes [#7107](https://github.com/mikro-orm/mikro-orm/issues/7107)
...
## [6.6.9](https://github.com/mikro-orm/mikro-orm/compare/v6.6.8...v6.6.9) (2026-03-05)[​](#669-2026-03-05 "Direct link to 669-2026-03-05")
...
* **core:** ensure column name conflicts in M
  ...
  :N
  <!-- -->
  are propagated to STI child entities ([5be76ae](https://github.com/mikro-orm/mikro-orm/commit/5be76ae21ccd05e161a74631288dbbd3c6f32401)), closes [#7123](https://github.com/mikro-orm/mikro-orm/issues/7123)
...
* **core:** normalize `populate` option in `Collection.matching()` for M
  ...
  :N
  <!-- -->
  relations ([#7091](https://github.com/mikro-orm/mikro-orm/issues/7091)) ([886772a](https://github.com/mikro-orm/mikro-orm/commit/886772a1901ebfd747f9edf86c1d7769733c0e2e))
...
* **sql:** fix populating M
  ...
  :N
  <!-- -->
  relations with `pivotEntity` that uses `mapToPk: true` ([0ab55fe](https://github.com/mikro-orm/mikro-orm/commit/0ab55fecba1e859ba8e9a59d62dd94258e99612e)), closes [#7107](https://github.com/mikro-orm/mikro-orm/issues/7107)
...
* **core:** use upsert when adding items to not initialized M
  <!-- -->
  :N
  <!-- -->
  collections ([#7019](https://github.com/mikro-orm/mikro-orm/issues/7019)) ([268f378](https://github.com/mikro-orm/mikro-orm/commit/268f3789110b83c8b59e321f55e55fa937ade925)), closes [#6625](https://github.com/mikro-orm/mikro-orm/issues/6625)
...
### Performance Improvements[​](#performance-improvements-2 "Direct link to Performance Improvements")
...
### Performance Improvements[​](#performance-improvements-3 "Direct link to Performance Improvements")
...
* **query-builder:** fix aliasing of 1:1 inverse side when used in a filter nested inside M
  <!-- -->
  :N
  <!-- -->
  relation ([61969f6](https://github.com/mikro-orm/mikro-orm/commit/61969f6769513f017c245a7a28c8b9ec2cfd6b51)), closes [#6851](https://github.com/mikro-orm/mikro-orm/issues/6851)
...
* **core:** process owning sides of M
  <!-- -->
  :N
  <!-- -->
  relations in `em.assign` with `onlyOwnProperties` ([#6822](https://github.com/mikro-orm/mikro-orm/issues/6822)) ([099869f](https://github.com/mikro-orm/mikro-orm/commit/099869fea507d20a0b45c3abf31e592c2d348eac)), closes [#6813](https://github.com/mikro-orm/mikro-orm/issues/6813)
...
* **query-builder:** fix `qb.leftJoinAndSelect` with a subquery on M
  <!-- -->
  :N
  <!-- -->
  relations ([aa52abb](https://github.com/mikro-orm/mikro-orm/commit/aa52abbfa029006069051e8e85982e172eb234a7))
...
### Performance Improvements[​](#performance-improvements-4 "Direct link to Performance Improvements")
...
* **core:** use explicit dataloader for M
  <!-- -->
  :N
  <!-- -->
  properties ([6372e4c](https://github.com/mikro-orm/mikro-orm/commit/6372e4c829f6e15764e05a196ee6aaf5d9071d32)), closes [#6665](https://github.com/mikro-orm/mikro-orm/issues/6665)
...
* **core:** respect owner schema when persisting M
  <!-- -->
  :N
  <!-- -->
  with wildcard entities ([a53765f](https://github.com/mikro-orm/mikro-orm/commit/a53765f3bcd4ade9861a395f4063b5bee53a663a)), closes [#6575](https://github.com/mikro-orm/mikro-orm/issues/6575)
...
* **core:** clean up 1
  ...
  :m
  <!-- -->
  collections when changing the m:1 value ([a720927](https://github.com/mikro-orm/mikro-orm/commit/a720927de9abe4113a37b366a542024c3528a391))
...
* **core:** fix populating m
  <!-- -->
  :n
  <!-- -->
  collection with custom types ([444c130](https://github.com/mikro-orm/mikro-orm/commit/444c130dd0423d03960e43843a54c149c4f525be)), closes [#6477](https://github.com/mikro-orm/mikro-orm/issues/6477)
...
### Performance Improvements[​](#performance-improvements-5 "Direct link to Performance Improvements")
...
* **sql:** respect EM schema when clearing not populated 1
  <!-- -->
  :m
  <!-- -->
  collection of wildcard entities ([12223e3](https://github.com/mikro-orm/mikro-orm/commit/12223e308ccfca0c3cc87650e2748cf035351655)), closes [#6387](https://github.com/mikro-orm/mikro-orm/issues/6387)
...
### Performance Improvements[​](#performance-improvements-6 "Direct link to Performance Improvements")
...
### Performance Improvements[​](#performance-improvements-7 "Direct link to Performance Improvements")
...
### Performance Improvements[​](#performance-improvements-8 "Direct link to Performance Improvements")
...
* **mongo:** fix populating lazy M
  <!-- -->
  :N
  <!-- -->
  owning sides ([f7e90cb](https://github.com/mikro-orm/mikro-orm/commit/f7e90cb24b128b0edb4bac696dc06d2b4043cba8)), closes [#6079](https://github.com/mikro-orm/mikro-orm/issues/6079)
...
* **schema:** resolve missing auto\_increment for PK in `MySQL/MariaDB` update DDL ([#6073](https://github.com/mikro-orm/mikro-orm/issues/6073)) ([984758f](https://github.com/mikro-orm/mikro-orm/commit/984758fdb6aaf3744f96a22c5a8e5f7db2d16850)), closes [#6072](https://github.com/mikro-orm/mikro-orm/issues/6072)
...
### Performance Improvements[​](#performance-improvements-9 "Direct link to Performance Improvements")
...
* **mongo:** support partial loading of M
  <!-- -->
  :N
  <!-- -->
  owning sides ([#6027](https://github.com/mikro-orm/mikro-orm/issues/6027)) ([e53a7d9](https://github.com/mikro-orm/mikro-orm/commit/e53a7d937d50309bafb9113681ca0d7afdbe9485))
...
* **core:** fix overriding not initialized 1
  <!-- -->
  :m
  <!-- -->
  collection without orphan removal ([517108b](https://github.com/mikro-orm/mikro-orm/commit/517108bd5a2defd15a2b6d677429e0b4d06d5422)), closes [#5883](https://github.com/mikro-orm/mikro-orm/issues/5883)
...
* **core:** fix handling of pivot entities with M
  <!-- -->
  :N
  <!-- -->
  relations ([fa89731](https://github.com/mikro-orm/mikro-orm/commit/fa8973166373b45ceeebeb9279786498ce24362e)), closes [#5774](https://github.com/mikro-orm/mikro-orm/issues/5774)
...
### Performance Improvements[​](#performance-improvements-10 "Direct link to Performance Improvements")
...
* **sql:** implement batching of M
  <!-- -->
  :N
  <!-- -->
  collection update queries ([d97979b](https://github.com/mikro-orm/mikro-orm/commit/d97979b236b8a7e40f64848e88602c531b8ebb84)), closes [#5627](https://github.com/mikro-orm/mikro-orm/issues/5627)
...
### Performance Improvements[​](#performance-improvements-11 "Direct link to Performance Improvements")

* **sql:** optimize diffing M
  <!-- -->
  :N
  <!-- -->
  collection state ([f46e7c8](https://github.com/mikro-orm/mikro-orm/commit/f46e7c86e29727b57f3220901ac5b14a6f1719c1)), closes [#5627](https://github.com/mikro-orm/mikro-orm/issues/5627)
...
* **core:** always use root entity when computing M
  <!-- -->
  :N
  <!-- -->
  field names with STI ([568e57f](https://github.com/mikro-orm/mikro-orm/commit/568e57f7b513c2af774d74492474a6d5183d7658)), closes [#5586](https://github.com/mikro-orm/mikro-orm/issues/5586)
...
### Bug Fixes[​](#bug-fixes-63 "Direct link to Bug Fixes")
...
### Bug Fixes[​](#bug-fixes-64 "Direct link to Bug Fixes")
...
### Bug Fixes[​](#bug-fixes-65 "Direct link to Bug Fixes")
...
## [6.2.0](https://github.com/mikro-orm/mikro-orm/compare/v6.1.12...v6.2.0) (2024-04-09)[​](#620-2024-04-09 "Direct link to 620-2024-04-09")

### Bug Fixes[​](#bug-fixes-66 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-12 "Direct link to Performance Improvements")
...
## [6.1.12](https://github.com/mikro-orm/mikro-orm/compare/v6.1.11...v6.1.12) (2024-03-24)[​](#6112-2024-03-24 "Direct link to 6112-2024-03-24")

### Bug Fixes[​](#bug-fixes-67 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-13 "Direct link to Performance Improvements")
...
## [6.1.11](https://github.com/mikro-orm/mikro-orm/compare/v6.1.10...v6.1.11) (2024-03-18)[​](#6111-2024-03-18 "Direct link to 6111-2024-03-18")

### Bug Fixes[​](#bug-fixes-68 "Direct link to Bug Fixes")
...
## [6.1.10](https://github.com/mikro-orm/mikro-orm/compare/v6.1.9...v6.1.10) (2024-03-14)[​](#6110-2024-03-14 "Direct link to 6110-2024-03-14")

### Bug Fixes[​](#bug-fixes-69 "Direct link to Bug Fixes")
...
* **core:** fix populating references for 1
  <!-- -->
  :m
  <!-- -->
  collections ([9b9027d](https://github.com/mikro-orm/mikro-orm/commit/9b9027d65a3dff6822b3463871e6571b3aa22a76)), closes [#5336](https://github.com/mikro-orm/mikro-orm/issues/5336)
...
### Performance Improvements[​](#performance-improvements-14 "Direct link to Performance Improvements")
...
## [6.1.9](https://github.com/mikro-orm/mikro-orm/compare/v6.1.8...v6.1.9) (2024-03-10)[​](#619-2024-03-10 "Direct link to 619-2024-03-10")

### Bug Fixes[​](#bug-fixes-70 "Direct link to Bug Fixes")
...
## [6.1.8](https://github.com/mikro-orm/mikro-orm/compare/v6.1.7...v6.1.8) (2024-03-06)[​](#618-2024-03-06 "Direct link to 618-2024-03-06")

### Bug Fixes[​](#bug-fixes-71 "Direct link to Bug Fixes")
...
## [6.1.7](https://github.com/mikro-orm/mikro-orm/compare/v6.1.6...v6.1.7) (2024-03-04)[​](#617-2024-03-04 "Direct link to 617-2024-03-04")

### Bug Fixes[​](#bug-fixes-72 "Direct link to Bug Fixes")
...
## [6.1.6](https://github.com/mikro-orm/mikro-orm/compare/v6.1.5...v6.1.6) (2024-02-28)[​](#616-2024-02-28 "Direct link to 616-2024-02-28")

### Bug Fixes[​](#bug-fixes-73 "Direct link to Bug Fixes")
...
* **core:** support raw fragments in `orderBy` of 1
  <!-- -->
  :m
  <!-- -->
  and m
  ...
  :n
  <!-- -->
  relations ([ed80163](https://github.com/mikro-orm/mikro-orm/commit/ed801634b6677da9f123f7033f27452a40558602)), closes [#5277](https://github.com/mikro-orm/mikro-orm/issues/5277)
...
### Performance Improvements[​](#performance-improvements-15 "Direct link to Performance Improvements")
...
## [6.1.5](https://github.com/mikro-orm/mikro-orm/compare/v6.1.4...v6.1.5) (2024-02-21)[​](#615-2024-02-21 "Direct link to 615-2024-02-21")

### Bug Fixes[​](#bug-fixes-74 "Direct link to Bug Fixes")
...
* **schema:** allow 1
  ...
  :m
  <!-- -->
  properties in pivot entities ([c370578](https://github.com/mikro-orm/mikro-orm/commit/c37057808aca5b6a4ac190d38374405edc833762))

## [6.1.4](https://github.com/mikro-orm/mikro-orm/compare/v6.1.3...v6.1.4) (2024-02-16)[​](#614-2024-02-16 "Direct link to 614-2024-02-16")

### Bug Fixes[​](#bug-fixes-75 "Direct link to Bug Fixes")
...
## [6.1.3](https://github.com/mikro-orm/mikro-orm/compare/v6.1.2...v6.1.3) (2024-02-13)[​](#613-2024-02-13 "Direct link to 613-2024-02-13")

### Bug Fixes[​](#bug-fixes-76 "Direct link to Bug Fixes")
...
* **core:** fix validation for removing items from 1
  <!-- -->
  :m
  <!-- -->
  collections ([34b8473](https://github.com/mikro-orm/mikro-orm/commit/34b8473d7056b864f0b4c7825f784368299edcfa)), closes [#5243](https://github.com/mikro-orm/mikro-orm/issues/5243)
...
## [6.1.2](https://github.com/mikro-orm/mikro-orm/compare/v6.1.1...v6.1.2) (2024-02-11)[​](#612-2024-02-11 "Direct link to 612-2024-02-11")

### Bug Fixes[​](#bug-fixes-77 "Direct link to Bug Fixes")
...
## [6.1.1](https://github.com/mikro-orm/mikro-orm/compare/v6.1.0...v6.1.1) (2024-02-10)[​](#611-2024-02-10 "Direct link to 611-2024-02-10")

### Bug Fixes[​](#bug-fixes-78 "Direct link to Bug Fixes")
...
## [6.1.0](https://github.com/mikro-orm/mikro-orm/compare/v6.0.7...v6.1.0) (2024-02-04)[​](#610-2024-02-04 "Direct link to 610-2024-02-04")

### Bug Fixes[​](#bug-fixes-79 "Direct link to Bug Fixes")
...
## [6.0.7](https://github.com/mikro-orm/mikro-orm/compare/v6.0.6...v6.0.7) (2024-01-30)[​](#607-2024-01-30 "Direct link to 607-2024-01-30")

### Bug Fixes[​](#bug-fixes-80 "Direct link to Bug Fixes")
...
## [6.0.6](https://github.com/mikro-orm/mikro-orm/compare/v6.0.5...v6.0.6) (2024-01-29)[​](#606-2024-01-29 "Direct link to 606-2024-01-29")

### Bug Fixes[​](#bug-fixes-81 "Direct link to Bug Fixes")
...
## [6.0.5](https://github.com/mikro-orm/mikro-orm/compare/v6.0.4...v6.0.5) (2024-01-18)[​](#605-2024-01-18 "Direct link to 605-2024-01-18")

### Bug Fixes[​](#bug-fixes-82 "Direct link to Bug Fixes")
...
## [6.0.4](https://github.com/mikro-orm/mikro-orm/compare/v6.0.3...v6.0.4) (2024-01-15)[​](#604-2024-01-15 "Direct link to 604-2024-01-15")

### Bug Fixes[​](#bug-fixes-83 "Direct link to Bug Fixes")
...
## [6.0.3](https://github.com/mikro-orm/mikro-orm/compare/v6.0.2...v6.0.3) (2024-01-13)[​](#603-2024-01-13 "Direct link to 603-2024-01-13")

### Bug Fixes[​](#bug-fixes-84 "Direct link to Bug Fixes")
...
## [6.0.2](https://github.com/mikro-orm/mikro-orm/compare/v6.0.1...v6.0.2) (2024-01-09)[​](#602-2024-01-09 "Direct link to 602-2024-01-09")

### Bug Fixes[​](#bug-fixes-85 "Direct link to Bug Fixes")
...
## [6.0.1](https://github.com/mikro-orm/mikro-orm/compare/v6.0.0...v6.0.1) (2024-01-08)[​](#601-2024-01-08 "Direct link to 601-2024-01-08")

**Note:** Version bump only for package @mikro-orm/root

## [6.0.0](https://github.com/mikro-orm/mikro-orm/compare/v5.9.7...v6.0.0) (2024-01-08)[​](#600-2024-01-08 "Direct link to 600-2024-01-08")

### Bug Fixes[​](#bug-fixes-86 "Direct link to Bug Fixes")
...
### Code Refactoring[​](#code-refactoring "Direct link to Code Refactoring")
...
* **core:** require `mappedBy` option for 1
  <!-- -->
  :m
  <!-- -->
  properties ([716aa76](https://github.com/mikro-orm/mikro-orm/commit/716aa76111c07c9a25ddf601c3fe1f3d2edcc81f))
...
* **core:** respect updates to M
  <!-- -->
  :N
  <!-- -->
  inverse sides and batch them ([#4798](https://github.com/mikro-orm/mikro-orm/issues/4798)) ([ec65001](https://github.com/mikro-orm/mikro-orm/commit/ec650013f3486a89a12c105ea49a8fc28b1f8072)), closes [#4564](https://github.com/mikro-orm/mikro-orm/issues/4564)
...
### Performance Improvements[​](#performance-improvements-16 "Direct link to Performance Improvements")
...
## [5.9.7](https://github.com/mikro-orm/mikro-orm/compare/v5.9.5...v5.9.7) (2023-12-30)[​](#597-2023-12-30 "Direct link to 597-2023-12-30")

### Bug Fixes[​](#bug-fixes-87 "Direct link to Bug Fixes")
...
## [5.9.6](https://github.com/mikro-orm/mikro-orm/compare/v5.9.5...v5.9.6) (2023-12-21)[​](#596-2023-12-21 "Direct link to 596-2023-12-21")

### Bug Fixes[​](#bug-fixes-88 "Direct link to Bug Fixes")
...
## [5.9.5](https://github.com/mikro-orm/mikro-orm/compare/v5.9.4...v5.9.5) (2023-12-15)[​](#595-2023-12-15 "Direct link to 595-2023-12-15")

### Bug Fixes[​](#bug-fixes-89 "Direct link to Bug Fixes")
...
## [5.9.4](https://github.com/mikro-orm/mikro-orm/compare/v5.9.3...v5.9.4) (2023-11-17)[​](#594-2023-11-17 "Direct link to 594-2023-11-17")

### Bug Fixes[​](#bug-fixes-90 "Direct link to Bug Fixes")
...
## [5.9.3](https://github.com/mikro-orm/mikro-orm/compare/v5.9.2...v5.9.3) (2023-11-06)[​](#593-2023-11-06 "Direct link to 593-2023-11-06")

### Bug Fixes[​](#bug-fixes-91 "Direct link to Bug Fixes")
...
## [5.9.2](https://github.com/mikro-orm/mikro-orm/compare/v5.9.1...v5.9.2) (2023-11-02)[​](#592-2023-11-02 "Direct link to 592-2023-11-02")

### Bug Fixes[​](#bug-fixes-92 "Direct link to Bug Fixes")
...
## [5.9.1](https://github.com/mikro-orm/mikro-orm/compare/v5.9.0...v5.9.1) (2023-10-31)[​](#591-2023-10-31 "Direct link to 591-2023-10-31")

### Bug Fixes[​](#bug-fixes-93 "Direct link to Bug Fixes")
...
## [5.9.0](https://github.com/mikro-orm/mikro-orm/compare/v5.8.10...v5.9.0) (2023-10-24)[​](#590-2023-10-24 "Direct link to 590-2023-10-24")

### Bug Fixes[​](#bug-fixes-94 "Direct link to Bug Fixes")
...
## [5.8.10](https://github.com/mikro-orm/mikro-orm/compare/v5.8.9...v5.8.10) (2023-10-18)[​](#5810-2023-10-18 "Direct link to 5810-2023-10-18")

### Bug Fixes[​](#bug-fixes-95 "Direct link to Bug Fixes")

* **knex:** fix populating M
  <!-- -->
  :N
  <!-- -->
  from inverse side with joined strategy ([9f82e95](https://github.com/mikro-orm/mikro-orm/commit/9f82e95b3353be2ef476dc3ce129674e863b44b8))
...
## [5.8.9](https://github.com/mikro-orm/mikro-orm/compare/v5.8.8...v5.8.9) (2023-10-15)[​](#589-2023-10-15 "Direct link to 589-2023-10-15")

### Bug Fixes[​](#bug-fixes-96 "Direct link to Bug Fixes")
...
## [5.8.8](https://github.com/mikro-orm/mikro-orm/compare/v5.8.7...v5.8.8) (2023-10-11)[​](#588-2023-10-11 "Direct link to 588-2023-10-11")

### Bug Fixes[​](#bug-fixes-97 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-17 "Direct link to Performance Improvements")
...
## [5.8.7](https://github.com/mikro-orm/mikro-orm/compare/v5.8.6...v5.8.7) (2023-10-05)[​](#587-2023-10-05 "Direct link to 587-2023-10-05")

### Bug Fixes[​](#bug-fixes-98 "Direct link to Bug Fixes")
...
## [5.8.6](https://github.com/mikro-orm/mikro-orm/compare/v5.8.5...v5.8.6) (2023-10-02)[​](#586-2023-10-02 "Direct link to 586-2023-10-02")

### Bug Fixes[​](#bug-fixes-99 "Direct link to Bug Fixes")
...
## [5.8.5](https://github.com/mikro-orm/mikro-orm/compare/v5.8.4...v5.8.5) (2023-09-30)[​](#585-2023-09-30 "Direct link to 585-2023-09-30")

### Bug Fixes[​](#bug-fixes-100 "Direct link to Bug Fixes")
...
## [5.8.4](https://github.com/mikro-orm/mikro-orm/compare/v5.8.3...v5.8.4) (2023-09-27)[​](#584-2023-09-27 "Direct link to 584-2023-09-27")

### Bug Fixes[​](#bug-fixes-101 "Direct link to Bug Fixes")
...
## [5.8.3](https://github.com/mikro-orm/mikro-orm/compare/v5.8.2...v5.8.3) (2023-09-24)[​](#583-2023-09-24 "Direct link to 583-2023-09-24")

### Bug Fixes[​](#bug-fixes-102 "Direct link to Bug Fixes")
...
## [5.8.2](https://github.com/mikro-orm/mikro-orm/compare/v5.8.1...v5.8.2) (2023-09-20)[​](#582-2023-09-20 "Direct link to 582-2023-09-20")

### Bug Fixes[​](#bug-fixes-103 "Direct link to Bug Fixes")
...
## [5.8.1](https://github.com/mikro-orm/mikro-orm/compare/v5.8.0...v5.8.1) (2023-09-12)[​](#581-2023-09-12 "Direct link to 581-2023-09-12")

### Bug Fixes[​](#bug-fixes-104 "Direct link to Bug Fixes")
...
## [5.8.0](https://github.com/mikro-orm/mikro-orm/compare/v5.7.14...v5.8.0) (2023-09-10)[​](#580-2023-09-10 "Direct link to 580-2023-09-10")

### Bug Fixes[​](#bug-fixes-105 "Direct link to Bug Fixes")
...
* **core:** remove old items from 1
  <!-- -->
  :m
  <!-- -->
  collections via `set()` even if not initialized ([b03e165](https://github.com/mikro-orm/mikro-orm/commit/b03e1656d6bf0a626bdca2f4395ef3a221acfcbf))
...
* **query-builder:** apply join condition to the target entity in M
  <!-- -->
  :N
  <!-- -->
  relations ([c78d812](https://github.com/mikro-orm/mikro-orm/commit/c78d812e53f4ac6b12ad186e327f1e9fbcaf30b6)), closes [#4644](https://github.com/mikro-orm/mikro-orm/issues/4644)
...
## [5.7.14](https://github.com/mikro-orm/mikro-orm/compare/v5.7.13...v5.7.14) (2023-07-27)[​](#5714-2023-07-27 "Direct link to 5714-2023-07-27")

### Bug Fixes[​](#bug-fixes-106 "Direct link to Bug Fixes")
...
## [5.7.13](https://github.com/mikro-orm/mikro-orm/compare/v5.7.12...v5.7.13) (2023-07-16)[​](#5713-2023-07-16 "Direct link to 5713-2023-07-16")

### Bug Fixes[​](#bug-fixes-107 "Direct link to Bug Fixes")
...
## [5.7.12](https://github.com/mikro-orm/mikro-orm/compare/v5.7.11...v5.7.12) (2023-06-10)[​](#5712-2023-06-10 "Direct link to 5712-2023-06-10")

### Bug Fixes[​](#bug-fixes-108 "Direct link to Bug Fixes")
...
* **mongo:** allow saving self-references inside M
  <!-- -->
  :N
  <!-- -->
  properties in one flush ([c1b5fc4](https://github.com/mikro-orm/mikro-orm/commit/c1b5fc49de2b962e4d44b5673a8df1437f0f71ab)), closes [#4431](https://github.com/mikro-orm/mikro-orm/issues/4431)
...
## [5.7.11](https://github.com/mikro-orm/mikro-orm/compare/v5.7.10...v5.7.11) (2023-06-01)[​](#5711-2023-06-01 "Direct link to 5711-2023-06-01")

### Bug Fixes[​](#bug-fixes-109 "Direct link to Bug Fixes")
...
## [5.7.10](https://github.com/mikro-orm/mikro-orm/compare/v5.7.9...v5.7.10) (2023-05-23)[​](#5710-2023-05-23 "Direct link to 5710-2023-05-23")

### Bug Fixes[​](#bug-fixes-110 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-18 "Direct link to Performance Improvements")
...
## [5.7.9](https://github.com/mikro-orm/mikro-orm/compare/v5.7.8...v5.7.9) (2023-05-22)[​](#579-2023-05-22 "Direct link to 579-2023-05-22")

### Bug Fixes[​](#bug-fixes-111 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-19 "Direct link to Performance Improvements")
...
## [5.7.8](https://github.com/mikro-orm/mikro-orm/compare/v5.7.7...v5.7.8) (2023-05-21)[​](#578-2023-05-21 "Direct link to 578-2023-05-21")

### Bug Fixes[​](#bug-fixes-112 "Direct link to Bug Fixes")
...
## [5.7.7](https://github.com/mikro-orm/mikro-orm/compare/v5.7.6...v5.7.7) (2023-05-14)[​](#577-2023-05-14 "Direct link to 577-2023-05-14")

### Bug Fixes[​](#bug-fixes-113 "Direct link to Bug Fixes")
...
## [5.7.6](https://github.com/mikro-orm/mikro-orm/compare/v5.7.5...v5.7.6) (2023-05-13)[​](#576-2023-05-13 "Direct link to 576-2023-05-13")

### Bug Fixes[​](#bug-fixes-114 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-20 "Direct link to Performance Improvements")
...
## [5.7.5](https://github.com/mikro-orm/mikro-orm/compare/v5.7.4...v5.7.5) (2023-05-09)[​](#575-2023-05-09 "Direct link to 575-2023-05-09")

### Bug Fixes[​](#bug-fixes-115 "Direct link to Bug Fixes")
...
## [5.7.4](https://github.com/mikro-orm/mikro-orm/compare/v5.7.3...v5.7.4) (2023-05-01)[​](#574-2023-05-01 "Direct link to 574-2023-05-01")

### Bug Fixes[​](#bug-fixes-116 "Direct link to Bug Fixes")
...
## [5.7.3](https://github.com/mikro-orm/mikro-orm/compare/v5.7.2...v5.7.3) (2023-04-28)[​](#573-2023-04-28 "Direct link to 573-2023-04-28")

### Bug Fixes[​](#bug-fixes-117 "Direct link to Bug Fixes")
...
## [5.7.2](https://github.com/mikro-orm/mikro-orm/compare/v5.7.1...v5.7.2) (2023-04-25)[​](#572-2023-04-25 "Direct link to 572-2023-04-25")

### Bug Fixes[​](#bug-fixes-118 "Direct link to Bug Fixes")
...
## [5.7.1](https://github.com/mikro-orm/mikro-orm/compare/v5.7.0...v5.7.1) (2023-04-25)[​](#571-2023-04-25 "Direct link to 571-2023-04-25")

### Bug Fixes[​](#bug-fixes-119 "Direct link to Bug Fixes")
...
## [5.7.0](https://github.com/mikro-orm/mikro-orm/compare/v5.6.16...v5.7.0) (2023-04-23)[​](#570-2023-04-23 "Direct link to 570-2023-04-23")

### Bug Fixes[​](#bug-fixes-120 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-21 "Direct link to Performance Improvements")
...
## [5.6.16](https://github.com/mikro-orm/mikro-orm/compare/v5.6.15...v5.6.16) (2023-04-04)[​](#5616-2023-04-04 "Direct link to 5616-2023-04-04")

### Bug Fixes[​](#bug-fixes-121 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-22 "Direct link to Performance Improvements")

* **core:** populating many large 1
  <!-- -->
  :M
  <!-- -->
  collections ([875d966](https://github.com/mikro-orm/mikro-orm/commit/875d966db9b4d4ea313709e0f1382f025599edbf)), closes [#4171](https://github.com/mikro-orm/mikro-orm/issues/4171)

## [5.6.15](https://github.com/mikro-orm/mikro-orm/compare/v5.6.14...v5.6.15) (2023-03-18)[​](#5615-2023-03-18 "Direct link to 5615-2023-03-18")

### Bug Fixes[​](#bug-fixes-122 "Direct link to Bug Fixes")
...
## [5.6.14](https://github.com/mikro-orm/mikro-orm/compare/v5.6.13...v5.6.14) (2023-03-12)[​](#5614-2023-03-12 "Direct link to 5614-2023-03-12")

### Bug Fixes[​](#bug-fixes-123 "Direct link to Bug Fixes")
...
* **core:** ensure `populate: true` supports nested relations inside M
  <!-- -->
  :N
  <!-- -->
  ([b42f0f3](https://github.com/mikro-orm/mikro-orm/commit/b42f0f3a54cb3e3f7146584caf4d34f200ccc195))
...
## [5.6.13](https://github.com/mikro-orm/mikro-orm/compare/v5.6.12...v5.6.13) (2023-03-01)[​](#5613-2023-03-01 "Direct link to 5613-2023-03-01")

### Bug Fixes[​](#bug-fixes-124 "Direct link to Bug Fixes")
...
## [5.6.12](https://github.com/mikro-orm/mikro-orm/compare/v5.6.11...v5.6.12) (2023-02-26)[​](#5612-2023-02-26 "Direct link to 5612-2023-02-26")

### Bug Fixes[​](#bug-fixes-125 "Direct link to Bug Fixes")
...
## [5.6.11](https://github.com/mikro-orm/mikro-orm/compare/v5.6.10...v5.6.11) (2023-02-17)[​](#5611-2023-02-17 "Direct link to 5611-2023-02-17")

### Bug Fixes[​](#bug-fixes-126 "Direct link to Bug Fixes")
...
## [5.6.10](https://github.com/mikro-orm/mikro-orm/compare/v5.6.9...v5.6.10) (2023-02-17)[​](#5610-2023-02-17 "Direct link to 5610-2023-02-17")

### Bug Fixes[​](#bug-fixes-127 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-23 "Direct link to Performance Improvements")
...
## [5.6.9](https://github.com/mikro-orm/mikro-orm/compare/v5.6.8...v5.6.9) (2023-02-10)[​](#569-2023-02-10 "Direct link to 569-2023-02-10")

### Bug Fixes[​](#bug-fixes-128 "Direct link to Bug Fixes")
...
## [5.6.8](https://github.com/mikro-orm/mikro-orm/compare/v5.6.7...v5.6.8) (2023-01-25)[​](#568-2023-01-25 "Direct link to 568-2023-01-25")

### Bug Fixes[​](#bug-fixes-129 "Direct link to Bug Fixes")
...
## [5.6.7](https://github.com/mikro-orm/mikro-orm/compare/v5.6.6...v5.6.7) (2023-01-13)[​](#567-2023-01-13 "Direct link to 567-2023-01-13")

### Bug Fixes[​](#bug-fixes-130 "Direct link to Bug Fixes")
...
## [5.6.6](https://github.com/mikro-orm/mikro-orm/compare/v5.6.5...v5.6.6) (2023-01-10)[​](#566-2023-01-10 "Direct link to 566-2023-01-10")

### Bug Fixes[​](#bug-fixes-131 "Direct link to Bug Fixes")
...
## [5.6.5](https://github.com/mikro-orm/mikro-orm/compare/v5.6.4...v5.6.5) (2023-01-09)[​](#565-2023-01-09 "Direct link to 565-2023-01-09")

### Bug Fixes[​](#bug-fixes-132 "Direct link to Bug Fixes")
...
## [5.6.4](https://github.com/mikro-orm/mikro-orm/compare/v5.6.3...v5.6.4) (2023-01-04)[​](#564-2023-01-04 "Direct link to 564-2023-01-04")

### Bug Fixes[​](#bug-fixes-133 "Direct link to Bug Fixes")
...
## [5.6.3](https://github.com/mikro-orm/mikro-orm/compare/v5.6.2...v5.6.3) (2022-12-28)[​](#563-2022-12-28 "Direct link to 563-2022-12-28")

### Bug Fixes[​](#bug-fixes-134 "Direct link to Bug Fixes")
...
## [5.6.2](https://github.com/mikro-orm/mikro-orm/compare/v5.6.1...v5.6.2) (2022-12-25)[​](#562-2022-12-25 "Direct link to 562-2022-12-25")

### Bug Fixes[​](#bug-fixes-135 "Direct link to Bug Fixes")
...
* **core:** validate bidirectional M
  <!-- -->
  :N
  <!-- -->
  with `pivotEntity` ([5e793a2](https://github.com/mikro-orm/mikro-orm/commit/5e793a2ef956ea9bf324c950c5e975f5d75ceb99)), closes [#3860](https://github.com/mikro-orm/mikro-orm/issues/3860)
...
## [5.6.1](https://github.com/mikro-orm/mikro-orm/compare/v5.6.0...v5.6.1) (2022-12-20)[​](#561-2022-12-20 "Direct link to 561-2022-12-20")

### Bug Fixes[​](#bug-fixes-136 "Direct link to Bug Fixes")
...
## [5.6.0](https://github.com/mikro-orm/mikro-orm/compare/v5.5.3...v5.6.0) (2022-12-09)[​](#560-2022-12-09 "Direct link to 560-2022-12-09")

### Bug Fixes[​](#bug-fixes-137 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-24 "Direct link to Performance Improvements")
...
## [5.5.3](https://github.com/mikro-orm/mikro-orm/compare/v5.5.2...v5.5.3) (2022-11-10)[​](#553-2022-11-10 "Direct link to 553-2022-11-10")

### Bug Fixes[​](#bug-fixes-138 "Direct link to Bug Fixes")

* **core:** respect filters when loading m
  <!-- -->
  :n
  <!-- -->
  relations ([#3716](https://github.com/mikro-orm/mikro-orm/issues/3716)) ([86a65a7](https://github.com/mikro-orm/mikro-orm/commit/86a65a77cbfb8909511cb3bf269517feb2921e06))
...
### Performance Improvements[​](#performance-improvements-25 "Direct link to Performance Improvements")
...
## [5.5.2](https://github.com/mikro-orm/mikro-orm/compare/v5.5.1...v5.5.2) (2022-11-07)[​](#552-2022-11-07 "Direct link to 552-2022-11-07")

### Bug Fixes[​](#bug-fixes-139 "Direct link to Bug Fixes")
...
## [5.5.1](https://github.com/mikro-orm/mikro-orm/compare/v5.5.0...v5.5.1) (2022-11-05)[​](#551-2022-11-05 "Direct link to 551-2022-11-05")

### Bug Fixes[​](#bug-fixes-140 "Direct link to Bug Fixes")
...
## [5.5.0](https://github.com/mikro-orm/mikro-orm/compare/v5.4.2...v5.5.0) (2022-10-23)[​](#550-2022-10-23 "Direct link to 550-2022-10-23")

### Bug Fixes[​](#bug-fixes-141 "Direct link to Bug Fixes")
...
* **core:** rework handling of orphan removal for 1
  <!-- -->
  :m
  <!-- -->
  collections ([925c798](https://github.com/mikro-orm/mikro-orm/commit/925c7989bbc2adf4b7fb2c0f41dff580046e86eb)), closes [#3564](https://github.com/mikro-orm/mikro-orm/issues/3564)
...
### Performance Improvements[​](#performance-improvements-26 "Direct link to Performance Improvements")
...
## [5.4.2](https://github.com/mikro-orm/mikro-orm/compare/v5.4.1...v5.4.2) (2022-09-12)[​](#542-2022-09-12 "Direct link to 542-2022-09-12")

### Bug Fixes[​](#bug-fixes-142 "Direct link to Bug Fixes")
...
## [5.4.1](https://github.com/mikro-orm/mikro-orm/compare/v5.4.0...v5.4.1) (2022-09-08)[​](#541-2022-09-08 "Direct link to 541-2022-09-08")

### Bug Fixes[​](#bug-fixes-143 "Direct link to Bug Fixes")
...
### Features[​](#features-72 "Direct link to Features")
...
## [5.4.0](https://github.com/mikro-orm/mikro-orm/compare/v5.3.1...v5.4.0) (2022-09-01)[​](#540-2022-09-01 "Direct link to 540-2022-09-01")

### Bug Fixes[​](#bug-fixes-144 "Direct link to Bug Fixes")
...
### Features[​](#features-73 "Direct link to Features")
...
## [5.3.1](https://github.com/mikro-orm/mikro-orm/compare/v5.3.0...v5.3.1) (2022-08-04)[​](#531-2022-08-04 "Direct link to 531-2022-08-04")

### Bug Fixes[​](#bug-fixes-145 "Direct link to Bug Fixes")
...
## [5.3.0](https://github.com/mikro-orm/mikro-orm/compare/v5.2.4...v5.3.0) (2022-08-01)[​](#530-2022-08-01 "Direct link to 530-2022-08-01")

### Bug Fixes[​](#bug-fixes-146 "Direct link to Bug Fixes")
...
### Features[​](#features-74 "Direct link to Features")
...
## [5.2.4](https://github.com/mikro-orm/mikro-orm/compare/v5.2.3...v5.2.4) (2022-07-25)[​](#524-2022-07-25 "Direct link to 524-2022-07-25")

### Bug Fixes[​](#bug-fixes-147 "Direct link to Bug Fixes")
...
* **core:** ensure m
  ...
  :n
  <!-- -->
  collection is not dirty after hydration ([66e0a21](https://github.com/mikro-orm/mikro-orm/commit/66e0a21bb12a716afd2b0ba700ff7df14a5f0dc0)), closes [#3323](https://github.com/mikro-orm/mikro-orm/issues/3323) [#3287](https://github.com/mikro-orm/mikro-orm/issues/3287)
...
* **knex:** fix $or over 1
  ...
  :m
  <!-- -->
  and m:1 auto-joined relations ([#3307](https://github.com/mikro-orm/mikro-orm/issues/3307)) ([b6f12b2](https://github.com/mikro-orm/mikro-orm/commit/b6f12b21d04d5974e6fd082b4d9984c80129b9cc))

### Features[​](#features-75 "Direct link to Features")
...
## [5.2.3](https://github.com/mikro-orm/mikro-orm/compare/v5.2.2...v5.2.3) (2022-07-08)[​](#523-2022-07-08 "Direct link to 523-2022-07-08")

### Bug Fixes[​](#bug-fixes-148 "Direct link to Bug Fixes")

* **core:** ensure M
  <!-- -->
  :N
  <!-- -->
  collections are not dirty after populating of inverse side ([21ba9b2](https://github.com/mikro-orm/mikro-orm/commit/21ba9b212473a9347b2bd38a048710a9628c05ee)), closes [#3287](https://github.com/mikro-orm/mikro-orm/issues/3287)
...
## [5.2.2](https://github.com/mikro-orm/mikro-orm/compare/v5.2.1...v5.2.2) (2022-07-03)[​](#522-2022-07-03 "Direct link to 522-2022-07-03")

### Bug Fixes[​](#bug-fixes-149 "Direct link to Bug Fixes")
...
* **core:** fix populating of 1
  <!-- -->
  :m
  <!-- -->
  collections between wildcard schema entities ([69c06aa](https://github.com/mikro-orm/mikro-orm/commit/69c06aa5b3ac553bb6c1438a7143d56d18fcf894)), closes [#3270](https://github.com/mikro-orm/mikro-orm/issues/3270)
...
### Features[​](#features-76 "Direct link to Features")

* **core:** propagate add operation to m
  <!-- -->
  :n
  <!-- -->
  owner even if not initialized ([#3273](https://github.com/mikro-orm/mikro-orm/issues/3273)) ([dc9255c](https://github.com/mikro-orm/mikro-orm/commit/dc9255cb4c26291c7e33a7c38da0475fb20f3832))

## [5.2.1](https://github.com/mikro-orm/mikro-orm/compare/v5.2.0...v5.2.1) (2022-06-21)[​](#521-2022-06-21 "Direct link to 521-2022-06-21")

### Bug Fixes[​](#bug-fixes-150 "Direct link to Bug Fixes")
...
### Features[​](#features-77 "Direct link to Features")
...
### Performance Improvements[​](#performance-improvements-27 "Direct link to Performance Improvements")
...
## [5.2.0](https://github.com/mikro-orm/mikro-orm/compare/v5.1.5...v5.2.0) (2022-06-10)[​](#520-2022-06-10 "Direct link to 520-2022-06-10")

### Bug Fixes[​](#bug-fixes-151 "Direct link to Bug Fixes")
...
### Features[​](#features-78 "Direct link to Features")
...
## [5.1.5](https://github.com/mikro-orm/mikro-orm/compare/v5.1.4...v5.1.5) (2022-05-29)[​](#515-2022-05-29 "Direct link to 515-2022-05-29")

### Bug Fixes[​](#bug-fixes-152 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-28 "Direct link to Performance Improvements")
...
## [5.1.4](https://github.com/mikro-orm/mikro-orm/compare/v5.1.3...v5.1.4) (2022-05-19)[​](#514-2022-05-19 "Direct link to 514-2022-05-19")

### Bug Fixes[​](#bug-fixes-153 "Direct link to Bug Fixes")
...
### Features[​](#features-79 "Direct link to Features")
...
## [5.1.3](https://github.com/mikro-orm/mikro-orm/compare/v5.1.2...v5.1.3) (2022-04-27)[​](#513-2022-04-27 "Direct link to 513-2022-04-27")

### Bug Fixes[​](#bug-fixes-154 "Direct link to Bug Fixes")
...
### Features[​](#features-80 "Direct link to Features")
...
### Performance Improvements[​](#performance-improvements-29 "Direct link to Performance Improvements")
...
## [5.1.2](https://github.com/mikro-orm/mikro-orm/compare/v5.1.1...v5.1.2) (2022-04-10)[​](#512-2022-04-10 "Direct link to 512-2022-04-10")

### Bug Fixes[​](#bug-fixes-155 "Direct link to Bug Fixes")
...
### Features[​](#features-81 "Direct link to Features")
...
## [5.1.1](https://github.com/mikro-orm/mikro-orm/compare/v5.1.0...v5.1.1) (2022-03-20)[​](#511-2022-03-20 "Direct link to 511-2022-03-20")

### Bug Fixes[​](#bug-fixes-156 "Direct link to Bug Fixes")
...
### Features[​](#features-82 "Direct link to Features")
...
## [5.1.0](https://github.com/mikro-orm/mikro-orm/compare/v5.0.5...v5.1.0) (2022-03-13)[​](#510-2022-03-13 "Direct link to 510-2022-03-13")

### Bug Fixes[​](#bug-fixes-157 "Direct link to Bug Fixes")
...
### Features[​](#features-83 "Direct link to Features")
...
## [5.0.5](https://github.com/mikro-orm/mikro-orm/compare/v5.0.4...v5.0.5) (2022-02-27)[​](#505-2022-02-27 "Direct link to 505-2022-02-27")

### Bug Fixes[​](#bug-fixes-158 "Direct link to Bug Fixes")
...
## [5.0.4](https://github.com/mikro-orm/mikro-orm/compare/v5.0.3...v5.0.4) (2022-02-22)[​](#504-2022-02-22 "Direct link to 504-2022-02-22")

### Bug Fixes[​](#bug-fixes-159 "Direct link to Bug Fixes")
...
## [5.0.3](https://github.com/mikro-orm/mikro-orm/compare/v5.0.2...v5.0.3) (2022-02-20)[​](#503-2022-02-20 "Direct link to 503-2022-02-20")

### Bug Fixes[​](#bug-fixes-160 "Direct link to Bug Fixes")
...
### Features[​](#features-84 "Direct link to Features")
...
## [5.0.2](https://github.com/mikro-orm/mikro-orm/compare/v5.0.1...v5.0.2) (2022-02-16)[​](#502-2022-02-16 "Direct link to 502-2022-02-16")

### Bug Fixes[​](#bug-fixes-161 "Direct link to Bug Fixes")
...
## [5.0.1](https://github.com/mikro-orm/mikro-orm/compare/v5.0.0...v5.0.1) (2022-02-13)[​](#501-2022-02-13 "Direct link to 501-2022-02-13")

### Bug Fixes[​](#bug-fixes-162 "Direct link to Bug Fixes")
...
### Features[​](#features-85 "Direct link to Features")
...
## [5.0.0](https://github.com/mikro-orm/mikro-orm/compare/v4.5.10...v5.0.0) (2022-02-06)[​](#500-2022-02-06 "Direct link to 500-2022-02-06")

### Bug Fixes[​](#bug-fixes-163 "Direct link to Bug Fixes")
...
* **core:** improve partial loading of 1
  <!-- -->
  :m
  <!-- -->
  relations ([3ddde1e](https://github.com/mikro-orm/mikro-orm/commit/3ddde1e9a5e31c245da44ebaa96332ee61ef0c61)), closes [#2651](https://github.com/mikro-orm/mikro-orm/issues/2651)
...
* **core:** propagate `em.remove()` to 1
  <!-- -->
  :m
  <!-- -->
  collections ([c23c39c](https://github.com/mikro-orm/mikro-orm/commit/c23c39cf70a3f417a6537a2941db87b89b6d78db)), closes [#2395](https://github.com/mikro-orm/mikro-orm/issues/2395)
* **core:** propagate `em.remove()` to m:1 properties of 1
  <!-- -->
  :m
  <!-- -->
  relations ([e6fa2f7](https://github.com/mikro-orm/mikro-orm/commit/e6fa2f7841b4508406d3a36caec31f63b2aaa4bf)), closes [#2636](https://github.com/mikro-orm/mikro-orm/issues/2636)
...
* **sti:** allow m
  ...
  :n
  <!-- -->
  relations between two STI entities ([6c797e9](https://github.com/mikro-orm/mikro-orm/commit/6c797e9e8f578bbcd77bdd1220e7b07e3d4d46e8)), closes [#2246](https://github.com/mikro-orm/mikro-orm/issues/2246)
...
### Features[​](#features-86 "Direct link to Features")
...
* **entity-generator**: add support for generating M
  <!-- -->
  :N
  <!-- -->
  properties ([c0628c5](https://github.com/mikro-orm/mikro-orm/commit/c0628c5))
...
### Performance Improvements[​](#performance-improvements-30 "Direct link to Performance Improvements")
...
## [4.5.10](https://github.com/mikro-orm/mikro-orm/compare/v4.5.9...v4.5.10) (2021-12-26)[​](#4510-2021-12-26 "Direct link to 4510-2021-12-26")

### Bug Fixes[​](#bug-fixes-164 "Direct link to Bug Fixes")
...
* **mongo:** do not use separate update queries for M
  <!-- -->
  :N
  <!-- -->
  collections if not needed ([e57984d](https://github.com/mikro-orm/mikro-orm/commit/e57984d0d3048637c75b1f3f5ff46d0ed5528e92)), closes [#2483](https://github.com/mikro-orm/mikro-orm/issues/2483)
...
* **validation:** validate missing 1
  <!-- -->
  :m
  <!-- -->
  mappedBy key in factory ([e75fcff](https://github.com/mikro-orm/mikro-orm/commit/e75fcff68e2e2f9f66a84887ecd8aa4166d8bb2c)), closes [#2393](https://github.com/mikro-orm/mikro-orm/issues/2393)

### Performance Improvements[​](#performance-improvements-31 "Direct link to Performance Improvements")
...
## [4.5.9](https://github.com/mikro-orm/mikro-orm/compare/v4.5.8...v4.5.9) (2021-08-24)[​](#459-2021-08-24 "Direct link to 459-2021-08-24")

**Note:** Version bump only for package @mikro-orm/core

## [4.5.8](https://github.com/mikro-orm/mikro-orm/compare/v4.5.7...v4.5.8) (2021-08-24)[​](#458-2021-08-24 "Direct link to 458-2021-08-24")

### Bug Fixes[​](#bug-fixes-165 "Direct link to Bug Fixes")
...
## [4.5.7](https://github.com/mikro-orm/mikro-orm/compare/v4.5.6...v4.5.7) (2021-06-30)[​](#457-2021-06-30 "Direct link to 457-2021-06-30")

### Bug Fixes[​](#bug-fixes-166 "Direct link to Bug Fixes")

* **core:** fix clearing 1
  <!-- -->
  :m
  <!-- -->
  collections ([29cd17b](https://github.com/mikro-orm/mikro-orm/commit/29cd17b62cac23a9eea69219de27fd987f2f0ca6)), closes [#1914](https://github.com/mikro-orm/mikro-orm/issues/1914)
* **core:** fix M
  <!-- -->
  :N
  <!-- -->
  relations with custom type PKs ([ed399b1](https://github.com/mikro-orm/mikro-orm/commit/ed399b19ad08ba8df8effbc632bdf7bd943cf972)), closes [#1930](https://github.com/mikro-orm/mikro-orm/issues/1930)
* **core:** fix removing of m
  <!-- -->
  :n
  <!-- -->
  items when one is composite ([8084845](https://github.com/mikro-orm/mikro-orm/commit/808484559c2dc30aca729a9e5a5ab7256b48427a)), closes [#1961](https://github.com/mikro-orm/mikro-orm/issues/1961)
...
### Features[​](#features-87 "Direct link to Features")
...
## [4.5.6](https://github.com/mikro-orm/mikro-orm/compare/v4.5.5...v4.5.6) (2021-06-06)[​](#456-2021-06-06 "Direct link to 456-2021-06-06")

### Bug Fixes[​](#bug-fixes-167 "Direct link to Bug Fixes")
...
### Features[​](#features-88 "Direct link to Features")
...
## [4.5.5](https://github.com/mikro-orm/mikro-orm/compare/v4.5.4...v4.5.5) (2021-05-17)[​](#455-2021-05-17 "Direct link to 455-2021-05-17")

### Bug Fixes[​](#bug-fixes-168 "Direct link to Bug Fixes")
...
## [4.5.4](https://github.com/mikro-orm/mikro-orm/compare/v4.5.3...v4.5.4) (2021-04-26)[​](#454-2021-04-26 "Direct link to 454-2021-04-26")

### Bug Fixes[​](#bug-fixes-169 "Direct link to Bug Fixes")
...
### Features[​](#features-89 "Direct link to Features")
...
## [4.5.3](https://github.com/mikro-orm/mikro-orm/compare/v4.5.2...v4.5.3) (2021-04-09)[​](#453-2021-04-09 "Direct link to 453-2021-04-09")

### Bug Fixes[​](#bug-fixes-170 "Direct link to Bug Fixes")
...
### Features[​](#features-90 "Direct link to Features")
...
## [4.5.2](https://github.com/mikro-orm/mikro-orm/compare/v4.5.1...v4.5.2) (2021-04-06)[​](#452-2021-04-06 "Direct link to 452-2021-04-06")

### Bug Fixes[​](#bug-fixes-171 "Direct link to Bug Fixes")
...
## [4.5.1](https://github.com/mikro-orm/mikro-orm/compare/v4.5.0...v4.5.1) (2021-03-27)[​](#451-2021-03-27 "Direct link to 451-2021-03-27")

### Bug Fixes[​](#bug-fixes-172 "Direct link to Bug Fixes")
...
* **core:** support `Collection.loadCount` for unidirectional M
  <!-- -->
  :N
  <!-- -->
  ([27e4dd2](https://github.com/mikro-orm/mikro-orm/commit/27e4dd2d93006f632e332e0e689a22ba61835acd)), closes [#1608](https://github.com/mikro-orm/mikro-orm/issues/1608)
...
## [4.5.0](https://github.com/mikro-orm/mikro-orm/compare/v4.4.4...v4.5.0) (2021-03-21)[​](#450-2021-03-21 "Direct link to 450-2021-03-21")

### Bug Fixes[​](#bug-fixes-173 "Direct link to Bug Fixes")

* **core:** apply filters when populating M
  <!-- -->
  :N
  <!-- -->
  relations ([cd8330a](https://github.com/mikro-orm/mikro-orm/commit/cd8330a7a71caadf8fed1e97e7d1db28a1a17b27)), closes [#1232](https://github.com/mikro-orm/mikro-orm/issues/1232)
...
### Features[​](#features-91 "Direct link to Features")
...
## [4.4.4](https://github.com/mikro-orm/mikro-orm/compare/v4.4.3...v4.4.4) (2021-02-21)[​](#444-2021-02-21 "Direct link to 444-2021-02-21")

### Bug Fixes[​](#bug-fixes-174 "Direct link to Bug Fixes")
...
### Performance Improvements[​](#performance-improvements-32 "Direct link to Performance Improvements")

* **core:** improve processing of 1
  <!-- -->
  :m
  <!-- -->
  relations ([#1450](https://github.com/mikro-orm/mikro-orm/issues/1450)) ([f5c1818](https://github.com/mikro-orm/mikro-orm/commit/f5c18183ea03d7360d298a95e5848aa698c25e1b))

## [4.4.3](https://github.com/mikro-orm/mikro-orm/compare/v4.4.2...v4.4.3) (2021-02-14)[​](#443-2021-02-14 "Direct link to 443-2021-02-14")

### Bug Fixes[​](#bug-fixes-175 "Direct link to Bug Fixes")
...
* **core:** propagate custom join columns to inverse side (m
  <!-- -->
  :n
  <!-- -->
  ) ([3f0a7b2](https://github.com/mikro-orm/mikro-orm/commit/3f0a7b2ecbd00630d2bad0d8c3d1a734ed260d1c)), closes [#1429](https://github.com/mikro-orm/mikro-orm/issues/1429)
...
## [4.4.2](https://github.com/mikro-orm/mikro-orm/compare/v4.4.1...v4.4.2) (2021-02-04)[​](#442-2021-02-04 "Direct link to 442-2021-02-04")

### Features[​](#features-92 "Direct link to Features")
...
## [4.4.1](https://github.com/mikro-orm/mikro-orm/compare/v4.4.0...v4.4.1) (2021-02-01)[​](#441-2021-02-01 "Direct link to 441-2021-02-01")

### Bug Fixes[​](#bug-fixes-176 "Direct link to Bug Fixes")

* **core:** alias pivot fields when loading m
  <!-- -->
  :n
  <!-- -->
  relations ([56682be](https://github.com/mikro-orm/mikro-orm/commit/56682bec4d3a3144ac26d592cd7c5d603ad9ad54)), closes [#1346](https://github.com/mikro-orm/mikro-orm/issues/1346) [#1349](https://github.com/mikro-orm/mikro-orm/issues/1349)
...
## [4.4.0](https://github.com/mikro-orm/mikro-orm/compare/v4.3.4...v4.4.0) (2021-01-24)[​](#440-2021-01-24 "Direct link to 440-2021-01-24")

### Bug Fixes[​](#bug-fixes-177 "Direct link to Bug Fixes")
...
### Features[​](#features-93 "Direct link to Features")
...
### Performance Improvements[​](#performance-improvements-33 "Direct link to Performance Improvements")
...
## [4.3.4](https://github.com/mikro-orm/mikro-orm/compare/v4.3.3...v4.3.4) (2020-12-11)[​](#434-2020-12-11 "Direct link to 434-2020-12-11")

### Bug Fixes[​](#bug-fixes-178 "Direct link to Bug Fixes")
...
### Features[​](#features-94 "Direct link to Features")
...
## [4.3.3](https://github.com/mikro-orm/mikro-orm/compare/v4.3.2...v4.3.3) (2020-12-04)[​](#433-2020-12-04 "Direct link to 433-2020-12-04")

### Bug Fixes[​](#bug-fixes-179 "Direct link to Bug Fixes")
...
* **core:** fix populating 1
  <!-- -->
  :m
  <!-- -->
  where the owner uses `mapToPk` ([85a7c9d](https://github.com/mikro-orm/mikro-orm/commit/85a7c9dbcfd17922efcececd7619ddcc58aed87f)), closes [#1128](https://github.com/mikro-orm/mikro-orm/issues/1128)
* **core:** fix propagating of changes to 1
  <!-- -->
  :m
  <!-- -->
  with `mapToPk` ([b38df3e](https://github.com/mikro-orm/mikro-orm/commit/b38df3e2a1fb2470365569557a0a9ac953dcf11d)), closes [#1128](https://github.com/mikro-orm/mikro-orm/issues/1128)
...
## [4.3.2](https://github.com/mikro-orm/mikro-orm/compare/v4.3.1...v4.3.2) (2020-11-24)[​](#432-2020-11-24 "Direct link to 432-2020-11-24")

### Bug Fixes[​](#bug-fixes-180 "Direct link to Bug Fixes")
...
## [4.3.1](https://github.com/mikro-orm/mikro-orm/compare/v4.3.0...v4.3.1) (2020-11-20)[​](#431-2020-11-20 "Direct link to 431-2020-11-20")

### Bug Fixes[​](#bug-fixes-181 "Direct link to Bug Fixes")
...
## [4.3.0](https://github.com/mikro-orm/mikro-orm/compare/v4.2.3...v4.3.0) (2020-11-13)[​](#430-2020-11-13 "Direct link to 430-2020-11-13")

### Bug Fixes[​](#bug-fixes-182 "Direct link to Bug Fixes")
...
* **sql:** fix populating M
  ...
  :N
  <!-- -->
  via joined strategy with conditions ([7113827](https://github.com/mikro-orm/mikro-orm/commit/7113827500079efb844df7bddf0b7443ab098185)), closes [#1043](https://github.com/mikro-orm/mikro-orm/issues/1043)
...
### Features[​](#features-95 "Direct link to Features")
...
## [4.2.3](https://github.com/mikro-orm/mikro-orm/compare/v4.2.2...v4.2.3) (2020-10-24)[​](#423-2020-10-24 "Direct link to 423-2020-10-24")

### Bug Fixes[​](#bug-fixes-183 "Direct link to Bug Fixes")
...
## [4.2.2](https://github.com/mikro-orm/mikro-orm/compare/v4.2.1...v4.2.2) (2020-10-22)[​](#422-2020-10-22 "Direct link to 422-2020-10-22")

### Bug Fixes[​](#bug-fixes-184 "Direct link to Bug Fixes")
...
* **core:** fix wrongly inferred 1
  <!-- -->
  :m
  <!-- -->
  metadata ([82f7f0a](https://github.com/mikro-orm/mikro-orm/commit/82f7f0a7e003e81255ccb74e435e9ac920db8cca)), closes [#936](https://github.com/mikro-orm/mikro-orm/issues/936)

### Features[​](#features-96 "Direct link to Features")
...
## [4.2.1](https://github.com/mikro-orm/mikro-orm/compare/v4.2.0...v4.2.1) (2020-10-20)[​](#421-2020-10-20 "Direct link to 421-2020-10-20")

### Bug Fixes[​](#bug-fixes-185 "Direct link to Bug Fixes")
...
## [4.2.0](https://github.com/mikro-orm/mikro-orm/compare/v4.1.1...v4.2.0) (2020-10-18)[​](#420-2020-10-18 "Direct link to 420-2020-10-18")

### Bug Fixes[​](#bug-fixes-186 "Direct link to Bug Fixes")
...
### Features[​](#features-97 "Direct link to Features")
...
## [4.1.1](https://github.com/mikro-orm/mikro-orm/compare/v4.1.0...v4.1.1) (2020-10-14)[​](#411-2020-10-14 "Direct link to 411-2020-10-14")

### Bug Fixes[​](#bug-fixes-187 "Direct link to Bug Fixes")
...
## [4.1.0](https://github.com/mikro-orm/mikro-orm/compare/v4.0.7...v4.1.0) (2020-10-12)[​](#410-2020-10-12 "Direct link to 410-2020-10-12")

### Bug Fixes[​](#bug-fixes-188 "Direct link to Bug Fixes")
...
### Features[​](#features-98 "Direct link to Features")
...
### Performance Improvements[​](#performance-improvements-34 "Direct link to Performance Improvements")
...
## [4.0.7](https://github.com/mikro-orm/mikro-orm/compare/v4.0.6...v4.0.7) (2020-09-24)[​](#407-2020-09-24 "Direct link to 407-2020-09-24")

### Bug Fixes[​](#bug-fixes-189 "Direct link to Bug Fixes")
...
### Features[​](#features-99 "Direct link to Features")
...
### Performance Improvements[​](#performance-improvements-35 "Direct link to Performance Improvements")
...
## [4.0.6](https://github.com/mikro-orm/mikro-orm/compare/v4.0.5...v4.0.6) (2020-09-22)[​](#406-2020-09-22 "Direct link to 406-2020-09-22")

### Bug Fixes[​](#bug-fixes-190 "Direct link to Bug Fixes")
...
* **query-builder:** fix auto-joining of 1
  <!-- -->
  :m
  <!-- -->
  PKs ([920995f](https://github.com/mikro-orm/mikro-orm/commit/920995f94070ff242b297d2837d83c7d9a9cb776)), closes [#857](https://github.com/mikro-orm/mikro-orm/issues/857)
...
## [4.0.5](https://github.com/mikro-orm/mikro-orm/compare/v4.0.4...v4.0.5) (2020-09-21)[​](#405-2020-09-21 "Direct link to 405-2020-09-21")

### Bug Fixes[​](#bug-fixes-191 "Direct link to Bug Fixes")
...
### Features[​](#features-100 "Direct link to Features")
...
## [4.0.4](https://github.com/mikro-orm/mikro-orm/compare/v4.0.3...v4.0.4) (2020-09-19)[​](#404-2020-09-19 "Direct link to 404-2020-09-19")

### Bug Fixes[​](#bug-fixes-192 "Direct link to Bug Fixes")
...
### Features[​](#features-101 "Direct link to Features")
...
### Performance Improvements[​](#performance-improvements-36 "Direct link to Performance Improvements")
...
### Reverts[​](#reverts "Direct link to Reverts")
...
## [4.0.3](https://github.com/mikro-orm/mikro-orm/compare/v4.0.2...v4.0.3) (2020-09-15)[​](#403-2020-09-15 "Direct link to 403-2020-09-15")

### Bug Fixes[​](#bug-fixes-193 "Direct link to Bug Fixes")
...
### Features[​](#features-102 "Direct link to Features")
...
### Performance Improvements[​](#performance-improvements-37 "Direct link to Performance Improvements")
...
## [4.0.2](https://github.com/mikro-orm/mikro-orm/compare/v4.0.1...v4.0.2) (2020-09-11)[​](#402-2020-09-11 "Direct link to 402-2020-09-11")

### Bug Fixes[​](#bug-fixes-194 "Direct link to Bug Fixes")
...
### Features[​](#features-103 "Direct link to Features")
...
## [4.0.1](https://github.com/mikro-orm/mikro-orm/compare/v4.0.0...v4.0.1) (2020-09-10)[​](#401-2020-09-10 "Direct link to 401-2020-09-10")

### Bug Fixes[​](#bug-fixes-195 "Direct link to Bug Fixes")
...
## [4.0.0](https://github.com/mikro-orm/mikro-orm/compare/v3.6.15...v4.0.0) (2020-09-08)[​](#400-2020-09-08 "Direct link to 400-2020-09-08")

### Bug Fixes[​](#bug-fixes-196 "Direct link to Bug Fixes")
...
* **mapping:** support mixed M
  <!-- -->
  :N
  <!-- -->
  with composite PK on one side only ([a951918](https://github.com/mikro-orm/mikro-orm/commit/a95191831ce4e406cbbf43cc6ee27b1eecd3c31d))
...
* **sql:** pivot joining of m
  <!-- -->
  :n
  <!-- -->
  when no target entity needed directly ([2b0bb72](https://github.com/mikro-orm/mikro-orm/commit/2b0bb72a5c2819de96008ccdd597787d4ccc0625)), closes [#549](https://github.com/mikro-orm/mikro-orm/issues/549)
* **sql:** pivot joining of m
  <!-- -->
  :n
  <!-- -->
  when target entity is null ([3b05a59](https://github.com/mikro-orm/mikro-orm/commit/3b05a5918f490037b0c618e76b139dc8f57a1343)), closes [#548](https://github.com/mikro-orm/mikro-orm/issues/548)
* **sql:** rework implicit m
  <!-- -->
  :n
  <!-- -->
  pivot joining ([7928c50](https://github.com/mikro-orm/mikro-orm/commit/7928c50a6f5a2fea9c593c3ef4d70a73942a6dba))
...
### Features[​](#features-104 "Direct link to Features")
...
* **core:** allow persisting 1
  <!-- -->
  :m
  <!-- -->
  collections ([#686](https://github.com/mikro-orm/mikro-orm/issues/686)) ([379b289](https://github.com/mikro-orm/mikro-orm/commit/379b2891a1a71467db3ad0fb50ba328a09913a7b)), closes [#467](https://github.com/mikro-orm/mikro-orm/issues/467)
...
### Performance Improvements[​](#performance-improvements-38 "Direct link to Performance Improvements")
