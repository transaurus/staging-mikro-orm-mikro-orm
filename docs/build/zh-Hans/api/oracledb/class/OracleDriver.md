...
* [AbstractSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlDriver.md)<[OracleConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleConnection.md), [OraclePlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OraclePlatform.md)>
  * *OracleDriver*
...
### [**](#constructor)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/oracledb/src/OracleDriver.ts#L29)constructor

* ****new OracleDriver**(config): [OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleDriver.md)
...
- Overrides AbstractSqlDriver\<OracleConnection, OraclePlatform>.constructor
  ...
  * ##### config: [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Configuration.md)<[IDatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IDatabaseDriver.md)<[Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Connection.md)>, [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md)<[IDatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IDatabaseDriver.md)<[Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Connection.md)>>>
  ...
  #### Returns [OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleDriver.md)

## Properties<!-- -->[**](#Properties)

### [**](#\[EntityManagerType])[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlDriver.ts#L77)inherited\[EntityManagerType]

**\[EntityManagerType]: [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleDriver.md)>
...
* ****connect**(options): Promise<[OracleConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleConnection.md)>
...
- Inherited from AbstractSqlDriver.connect
  ...
  * ##### optionaloptions: { skipOnConnect?<!-- -->: boolean }
  ...
  #### Returns Promise<[OracleConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleConnection.md)>
...
### [**](#createEntityManager)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlDriver.ts#L131)inheritedcreateEntityManager

* ****createEntityManager**(useContext): [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleDriver.md)>
...
- Inherited from AbstractSqlDriver.createEntityManager
  ...
  * ##### optionaluseContext: boolean
  ...
  #### Returns [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleDriver.md)>
...
* ****getConnection**(type): [OracleConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleConnection.md)
...
- Inherited from AbstractSqlDriver.getConnection
  ...
  * ##### type: [ConnectionType](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#ConnectionType) = <!-- -->'write'
  ...
  #### Returns [OracleConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleConnection.md)
...
### [**](#getORMClass)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/oracledb/src/OracleDriver.ts#L142)getORMClass

* ****getORMClass**(): [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Constructor)<[OracleMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/MikroORM.md)<[SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleDriver.md)>, (string | [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<any, never, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<any>> | [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Partial\<any>>)\[]>>
...
- Overrides AbstractSqlDriver.getORMClass
  ...
  ***
  ...
  #### Returns [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Constructor)<[OracleMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/MikroORM.md)<[SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleDriver.md)>, (string | [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<any, never, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<any>> | [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Partial\<any>>)\[]>>
...
* ****getPlatform**(): [OraclePlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OraclePlatform.md)
...
### [**](#nativeInsertMany)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/oracledb/src/OracleDriver.ts#L64)nativeInsertMany

* ****nativeInsertMany**\<T>(entityName, data, options): Promise<[QueryResult](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/QueryResult.md)\<T>>
...
### [**](#nativeUpdateMany)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/oracledb/src/OracleDriver.ts#L99)nativeUpdateMany
...
* ****reconnect**(options): Promise<[OracleConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/oracledb/class/OracleConnection.md)>
