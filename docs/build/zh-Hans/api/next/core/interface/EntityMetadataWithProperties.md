...
: [EntityProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EntityProperty.md)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>, any>\[]
...
: [CheckConstraint](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/CheckConstraint.md)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>>\[]
...
: [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityCtor)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>>
...
: (typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PrimaryKeyProp) | keyof
...
IsNever\<TBase, true, false> extends true ? {} : TBase extends { toObject: any } ? Pick<[IWrappedEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/IWrappedEntity.md)<{ -readonly \[ K in ... | ... | ... ]: InferBuilderValue<...> } & { \[PrimaryKeyProp]?
...
: ... }) & Omit\<TBase<...>, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PrimaryKeyProp)>>, BaseEntityMethodKeys> : {} | keyof
...
: TRepository extends [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)\<R> ? R : TRepository } | keyof

<!-- -->

IsNever\<TBase, true, false> extends true ? {} : Omit\<TBase, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PrimaryKeyProp)>)\[]
...
: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary)\<any>
...
: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary)<[FilterDef](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FilterDef)\<any>>
...
: string | [IndexCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#IndexCallback)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, never, false>>; fillFactor?
...
: NoInfer\<AllKeys\<TProperties, TBase>> | NoInfer\<AllKeys\<TProperties, TBase>>\[]; invisible?
...
: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary); properties?

<!-- -->

: NoInfer\<AllKeys\<TProperties, TBase>> | NoInfer\<AllKeys\<TProperties, TBase>>\[]; type?
...
: [InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>
...
: { meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntityMetadata.md)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityCtor)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>>>; prop: [EntityProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EntityProperty.md)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>, any> }\[]
...
: NoInfer\<AllKeys\<TProperties, TBase>> | NoInfer\<AllKeys\<TProperties, TBase>>\[]; name?
...
- Inherited from Omit.addProperty
  ...
  * ##### prop: Partial<[EntityProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EntityProperty.md)<[InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntityFromProperties)\<TProperties, TPK, TBase, TRepository, false>, any>>
