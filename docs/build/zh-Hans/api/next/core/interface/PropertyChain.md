...
- #### Parameters
  ...
  * ##### rest...cascade: [Cascade](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/enum/Cascade.md)\[]
...
- #### Parameters
  ...
  * ##### check: string | [CheckCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#CheckCallback)\<any>
...
- #### Parameters
  ...
  * ##### columnType: [AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AnyString) | ColumnType
...
- #### Parameters
  ...
  * ##### rest...columnTypes: ([AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AnyString) | ColumnType)\[]
...
- #### Parameters
  ...
  * ##### defaultValue: null | string | number | boolean | [RawQueryFragment](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/RawQueryFragment.md)\<string> | Date | string\[] | number\[]
...
- #### Parameters
  ...
  * ##### deferMode: [DeferMode](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/enum/DeferMode.md) | immediate | deferred
...
- #### Parameters
  ...
  * ##### deleteRule: [AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AnyString) | cascade | no action | set null | set default
...
- #### Parameters
  ...
  * ##### discriminatorMap: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary)\<string>
...
- #### Parameters
  ...
  * ##### filters: [FilterOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FilterOptions)
...
- #### Parameters
  ...
  * ##### formula: string | [FormulaCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FormulaCallback)\<any>
...
- #### Parameters
  ...
  * ##### generated: string | [GeneratedColumnCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#GeneratedColumnCallback)\<any>
...
- #### Parameters
  ...
  * ##### rest...orderBy: [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#QueryOrderMap)\<object>\[]
...
- #### Parameters
  ...
  * ##### pivotEntity: () => [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityName)
...
- #### Parameters
  ...
  * ##### strategy: [LoadStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/enum/LoadStrategy.md) | select-in | joined | balanced
...
- #### Parameters
  ...
  * ##### updateRule: [AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AnyString) | cascade | no action | set null | set default
...
- #### Parameters
  ...
  * ##### rest...where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FilterQuery)\<object>\[]
