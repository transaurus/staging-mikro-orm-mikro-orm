...
* Partial\<Record<[UniversalPropertyKeys](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#UniversalPropertyKeys), unknown>>
  * *EmptyOptions*
...
Inherited from Partial.discriminator

### [**](#discriminatorMap)inheriteddiscriminatorMap

**discriminatorMap: unknown

Inherited from Partial.discriminatorMap
...
### [**](#targetKey)inheritedtargetKey

**targetKey: unknown

Inherited from Partial.targetKey
