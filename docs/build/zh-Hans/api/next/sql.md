...
* [**AbstractNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#AbstractNamingStrategy)
* [**AnyEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#AnyEntity)
* [**AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#AnyString)
* [**ARRAY\_OPERATORS](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ARRAY_OPERATORS)
* [**ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ArrayType)
* [**assign](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#assign)
* [**AssignOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#AssignOptions)
* [**AutoPath](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#AutoPath)
* [**BaseEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#BaseEntity)
* [**BigIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#BigIntType)
* [**BlobType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#BlobType)
* [**BooleanType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#BooleanType)
* [**CacheAdapter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CacheAdapter)
* [**Cascade](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Cascade)
* [**Cast](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Cast)
* [**ChangeSet](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ChangeSet)
* [**ChangeSetType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ChangeSetType)
* [**CharacterType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CharacterType)
* [**CheckCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CheckCallback)
* [**CheckConstraint](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CheckConstraint)
* [**CheckConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CheckConstraintViolationException)
* [**ClearDatabaseOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ClearDatabaseOptions)
* [**CollationOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CollationOptions)
* [**Collection](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Collection)
* [**compareArrays](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#compareArrays)
* [**compareBooleans](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#compareBooleans)
* [**compareBuffers](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#compareBuffers)
* [**compareObjects](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#compareObjects)
* [**CompiledFunctions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CompiledFunctions)
* [**Config](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Config)
* [**Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Configuration)
* [**Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Connection)
* [**ConnectionConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ConnectionConfig)
* [**ConnectionException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ConnectionException)
* [**ConnectionOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ConnectionOptions)
* [**ConnectionType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ConnectionType)
* [**ConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ConstraintViolationException)
* [**Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Constructor)
* [**CountOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CountOptions)
* [**CreateContextOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CreateContextOptions)
* [**CreateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CreateOptions)
* [**CreateSchemaOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CreateSchemaOptions)
* [**createSqlFunction](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#createSqlFunction)
* [**Cursor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Cursor)
* [**CursorError](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#CursorError)
* [**DatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DatabaseDriver)
* [**DatabaseObjectExistsException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DatabaseObjectExistsException)
* [**DatabaseObjectNotFoundException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DatabaseObjectNotFoundException)
* [**DataloaderType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DataloaderType)
* [**DateTimeType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DateTimeType)
* [**DateType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DateType)
* [**DeadlockException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DeadlockException)
* [**DecimalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DecimalType)
* [**DeepPartial](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DeepPartial)
* [**DefaultLogger](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DefaultLogger)
* [**DeferMode](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DeferMode)
* [**defineConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#defineConfig)
* [**DefineConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DefineConfig)
* [**defineEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#defineEntity)
* [**DefineEntityHooks](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DefineEntityHooks)
* [**DeleteOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DeleteOptions)
* [**Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Dictionary)
* [**DoubleType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DoubleType)
* [**DriverException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DriverException)
* [**DriverMethodOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DriverMethodOptions)
* [**DropSchemaOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#DropSchemaOptions)
* [**EagerProps](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EagerProps)
* [**Edge](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Edge)
* [**EmbeddableOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EmbeddableOptions)
* [**EmbeddedOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EmbeddedOptions)
* [**EmbeddedPrefixMode](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EmbeddedPrefixMode)
* [**EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EmptyOptions)
* [**EnsureDatabaseOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EnsureDatabaseOptions)
* [**EntityAssigner](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityAssigner)
* [**EntityCaseNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityCaseNamingStrategy)
* [**EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityClass)
* [**EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityCtor)
* [**EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityData)
* [**EntityDataValue](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityDataValue)
* [**EntityDictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityDictionary)
* [**EntityDTO](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityDTO)
* [**EntityDTOProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityDTOProp)
* [**EntityField](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityField)
* [**EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityKey)
* [**EntityLoader](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityLoader)
* [**EntityLoaderOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityLoaderOptions)
* [**EntityManagerType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityManagerType)
* [**EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityMetadata)
* [**EntityMetadataWithProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityMetadataWithProperties)
* [**EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityName)
* [**EntityOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityOptions)
* [**EntityProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityProperty)
* [**EntityProps](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityProps)
* [**EntityRef](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityRef)
* [**EntityRepositoryType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityRepositoryType)
* [**EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntitySchema)
* [**EntitySchemaMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntitySchemaMetadata)
* [**EntitySchemaProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntitySchemaProperty)
* [**EntitySchemaWithMeta](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntitySchemaWithMeta)
* [**EntitySerializer](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntitySerializer)
* [**EntityTransformer](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityTransformer)
* [**EntityType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityType)
* [**EntityValue](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EntityValue)
* [**EnumArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EnumArrayType)
* [**EnumOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EnumOptions)
* [**EnumType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EnumType)
* [**equals](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#equals)
* [**EventArgs](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EventArgs)
* [**EventManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EventManager)
* [**EventSubscriber](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EventSubscriber)
* [**EventType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EventType)
* [**EventTypeMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#EventTypeMap)
* [**ExceptionConverter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ExceptionConverter)
* [**ExpandHint](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ExpandHint)
* [**ExpandProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ExpandProperty)
* [**ExpandQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ExpandQuery)
* [**ExpandScalar](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ExpandScalar)
* [**FilterDef](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FilterDef)
* [**FilterItemValue](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FilterItemValue)
* [**FilterKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FilterKey)
* [**FilterObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FilterObject)
* [**FilterOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FilterOptions)
* [**FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FilterQuery)
* [**FilterValue](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FilterValue)
* [**FindAllOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FindAllOptions)
* [**FindByCursorOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FindByCursorOptions)
* [**FindOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FindOneOptions)
* [**FindOneOrFailOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FindOneOrFailOptions)
* [**FindOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FindOptions)
* [**FlatQueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FlatQueryOrderMap)
* [**FloatType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FloatType)
* [**FlushEventArgs](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FlushEventArgs)
* [**FlushMode](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FlushMode)
* [**ForeignKeyConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ForeignKeyConstraintViolationException)
* [**ForkOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ForkOptions)
* [**FormulaCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FormulaCallback)
* [**FormulaTable](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FormulaTable)
* [**FromEntityType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#FromEntityType)
* [**GeneratedCacheAdapter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#GeneratedCacheAdapter)
* [**GeneratedColumnCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#GeneratedColumnCallback)
* [**GenerateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#GenerateOptions)
* [**GetReferenceOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#GetReferenceOptions)
* [**GetRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#GetRepository)
* [**GroupOperator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#GroupOperator)
* [**Hidden](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Hidden)
* [**HiddenProps](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#HiddenProps)
* [**Highlighter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Highlighter)
* [**Hydrator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Hydrator)
* [**IConfiguration](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IConfiguration)
* [**IDatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IDatabaseDriver)
* [**IEntityGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IEntityGenerator)
* [**IMigrationGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IMigrationGenerator)
* [**IMigrator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IMigrator)
* [**ImportsResolver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ImportsResolver)
* [**IndexCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IndexCallback)
* [**IndexColumnOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IndexColumnOptions)
* [**IndexOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IndexOptions)
* [**InferEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferEntity)
* [**InferEntityFromProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferEntityFromProperties)
* [**InferEntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferEntityName)
* [**InferPrimaryKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferPrimaryKey)
* [**InitCollectionOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InitCollectionOptions)
* [**IntegerType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IntegerType)
* [**IntervalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IntervalType)
* [**InvalidFieldNameException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InvalidFieldNameException)
* [**IPrimaryKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IPrimaryKey)
* [**ISchemaGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ISchemaGenerator)
* [**ISeedManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ISeedManager)
* [**IsolationLevel](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IsolationLevel)
* [**isRaw](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#isRaw)
* [**IsSubset](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IsSubset)
* [**IsUnknown](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IsUnknown)
* [**IType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IType)
* [**IWrappedEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#IWrappedEntity)
* [**JSON\_KEY\_OPERATORS](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#JSON_KEY_OPERATORS)
* [**JsonProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#JsonProperty)
* [**JsonType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#JsonType)
* [**LoadCountOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoadCountOptions)
* [**Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Loaded)
* [**LoadedCollection](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoadedCollection)
* [**LoadedReference](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoadedReference)
* [**LoadHint](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoadHint)
* [**LoadReferenceOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoadReferenceOptions)
* [**LoadReferenceOrFailOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoadReferenceOrFailOptions)
* [**LoadStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoadStrategy)
* [**LockMode](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LockMode)
* [**LockOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LockOptions)
* [**LockWaitTimeoutException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LockWaitTimeoutException)
* [**LogContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LogContext)
* [**Logger](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Logger)
* [**LoggerNamespace](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoggerNamespace)
* [**LoggerOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoggerOptions)
* [**LoggingOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#LoggingOptions)
* [**ManyToManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ManyToManyOptions)
* [**ManyToOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ManyToOneOptions)
* [**MatchingOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MatchingOptions)
* [**MaybePromise](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MaybePromise)
* [**MediumIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MediumIntType)
* [**MemoryCacheAdapter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MemoryCacheAdapter)
* [**MergeLoaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MergeLoaded)
* [**MergeOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MergeOptions)
* [**MergeSelected](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MergeSelected)
* [**MetadataDiscovery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MetadataDiscovery)
* [**MetadataDiscoveryOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MetadataDiscoveryOptions)
* [**MetadataError](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MetadataError)
* [**MetadataProcessor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MetadataProcessor)
* [**MetadataProvider](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MetadataProvider)
* [**MetadataStorage](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MetadataStorage)
* [**MigrateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigrateOptions)
* [**MigrationDiff](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigrationDiff)
* [**MigrationInfo](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigrationInfo)
* [**MigrationObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigrationObject)
* [**MigrationResult](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigrationResult)
* [**MigrationRow](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigrationRow)
* [**MigrationsOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigrationsOptions)
* [**MigratorEvent](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MigratorEvent)
* [**MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MikroORM)
* [**MongoNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MongoNamingStrategy)
* [**NamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NamingStrategy)
* [**NativeDeleteOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NativeDeleteOptions)
* [**NativeInsertUpdateManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NativeInsertUpdateManyOptions)
* [**NativeInsertUpdateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NativeInsertUpdateOptions)
* [**New](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#New)
* [**Node](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Node)
* [**NodeState](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NodeState)
* [**NonUniqueFieldNameException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NonUniqueFieldNameException)
* [**NotFoundError](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NotFoundError)
* [**NotNullConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NotNullConstraintViolationException)
* [**NullCacheAdapter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NullCacheAdapter)
* [**NullHighlighter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#NullHighlighter)
* [**ObjectQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ObjectQuery)
* [**OneToManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#OneToManyOptions)
* [**OneToOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#OneToOneOptions)
* [**Opt](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Opt)
* [**OptimisticLockError](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#OptimisticLockError)
* [**OptionalProps](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#OptionalProps)
* [**Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Options)
* [**OrderDefinition](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#OrderDefinition)
* [**p](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#p)
* [**parseJsonSafe](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#parseJsonSafe)
* [**PlainObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PlainObject)
* [**Platform](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Platform)
* [**PolymorphicRef](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PolymorphicRef)
* [**PoolConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PoolConfig)
* [**Populate](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Populate)
* [**PopulateHint](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PopulateHint)
* [**PopulateHintOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PopulateHintOptions)
* [**PopulateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PopulateOptions)
* [**PopulatePath](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PopulatePath)
* [**Prefixes](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Prefixes)
* [**Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Primary)
* [**PrimaryKeyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PrimaryKeyOptions)
* [**PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PrimaryKeyProp)
* [**PropertyBuilders](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PropertyBuilders)
* [**PropertyChain](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PropertyChain)
* [**PropertyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#PropertyOptions)
* [**QueryFlag](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryFlag)
* [**QueryOperator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryOperator)
* [**QueryOrder](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryOrder)
* [**QueryOrderKeys](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryOrderKeys)
* [**QueryOrderKeysFlat](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryOrderKeysFlat)
* [**QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryOrderMap)
* [**QueryOrderNumeric](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryOrderNumeric)
* [**QueryResult](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#QueryResult)
* [**quote](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#quote)
* [**Raw](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Raw)
* [**RawQueryFragment](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#RawQueryFragment)
* [**RawQueryFragmentSymbol](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#RawQueryFragmentSymbol)
* [**ReadOnlyException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ReadOnlyException)
* [**ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ref)
* [**Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Ref)
* [**Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Reference)
* [**ReferenceKind](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ReferenceKind)
* [**ReferenceOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ReferenceOptions)
* [**RefreshDatabaseOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#RefreshDatabaseOptions)
* [**RegisterOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#RegisterOptions)
* [**rel](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#rel)
* [**Rel](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Rel)
* [**RequestContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#RequestContext)
* [**RequiredEntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#RequiredEntityData)
* [**RequiredNullable](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#RequiredNullable)
* [**Scalar](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Scalar)
* [**SCALAR\_TYPES](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SCALAR_TYPES)
* [**ScalarRef](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ScalarRef)
* [**ScalarReference](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ScalarReference)
* [**SchemaColumns](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SchemaColumns)
* [**SchemaGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SchemaGenerator)
* [**SchemaTable](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SchemaTable)
* [**SeederObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SeederObject)
* [**SeederOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SeederOptions)
* [**Selected](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Selected)
* [**SerializationContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SerializationContext)
* [**serialize](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#serialize)
* [**SerializedPrimaryKeyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SerializedPrimaryKeyOptions)
* [**SerializeDTO](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SerializeDTO)
* [**SerializeOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SerializeOptions)
* [**ServerException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ServerException)
* [**SimpleColumnMeta](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SimpleColumnMeta)
* [**SimpleLogger](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SimpleLogger)
* [**SmallIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SmallIntType)
* [**sql](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#sql)
* [**SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SqlEntityManager)
* [**SqlEntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SqlEntityRepository)
* [**StreamOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#StreamOptions)
* [**StringType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#StringType)
* [**Subquery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Subquery)
* [**SyncCacheAdapter](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SyncCacheAdapter)
* [**SyntaxErrorException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SyntaxErrorException)
* [**t](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#t)
* [**TableExistsException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TableExistsException)
* [**TableNotFoundException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TableNotFoundException)
* [**TextType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TextType)
* [**TimeType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TimeType)
* [**TinyIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TinyIntType)
* [**Transaction](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Transaction)
* [**TransactionContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionContext)
* [**TransactionEventArgs](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionEventArgs)
* [**TransactionEventBroadcaster](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionEventBroadcaster)
* [**TransactionEventType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionEventType)
* [**TransactionManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionManager)
* [**TransactionOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionOptions)
* [**TransactionPropagation](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionPropagation)
* [**TransactionStateError](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransactionStateError)
* [**TransformContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TransformContext)
* [**Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Type)
* [**TypeConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#TypeConfig)
* [**types](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#types)
* [**Uint8ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Uint8ArrayType)
* [**UnboxArray](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UnboxArray)
* [**UnderscoreNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UnderscoreNamingStrategy)
* [**UniqueConstraintViolationException](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UniqueConstraintViolationException)
* [**UniqueOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UniqueOptions)
* [**UnitOfWork](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UnitOfWork)
* [**UniversalPropertyKeys](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UniversalPropertyKeys)
* [**UnknownType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UnknownType)
* [**UpdateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UpdateOptions)
* [**UpdateSchemaOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UpdateSchemaOptions)
* [**UpsertManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UpsertManyOptions)
* [**UpsertOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UpsertOptions)
* [**Utils](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Utils)
* [**UuidType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#UuidType)
* [**ValidationError](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#ValidationError)
* [**wrap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#wrap)
...
### [**](#defineConfig)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/core/src/utils/Configuration.ts#L506)defineConfig

Re-exports

<!-- -->

[defineConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/function/defineConfig.md)
...
### [**](#MikroORM)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/core/src/MikroORM.ts#L96)MikroORM

Re-exports

<!-- -->

[MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/MikroORM.md)
...
### [**](#Options)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/core/src/utils/Configuration.ts#L772)Options
...
**AnyQueryBuilder\<T>: [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/class/QueryBuilder.md)\<T, any, any, any, any, any, any>
...
* **T**: object = [AnyEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AnyEntity)
...
**ContextOrderByMap\<Entity, RootAlias, Context, RawAliases>: [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#QueryOrderMap)\<Entity> | ((IsNever\<RootAlias> extends true ? {} : RootAliasOrderKeys\<RootAlias, Entity>) & (\[Context] extends \[never] ? {} : ContextOrderKeys\<Context>) & (IsNever\<RawAliases> extends true ? {} : string extends RawAliases ? {} : RawOrderKeys\<RawAliases>))
...
**Field\<Entity, RootAlias, Context>: WithAlias<[EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityKey)\<Entity>> | (IsNever\<RootAlias> extends true ? never : WithAlias<\`${RootAlias}.${[EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityKey)\<Entity>}\`> | \`${RootAlias}.\*\`) | (\[Context] extends \[never] ? never : WithAlias\<ContextFieldKeys\<Context>> | \`${AliasNames\<Context>}.\*\`) | \* | [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/class/QueryBuilder.md)\<any> | NativeQueryBuilder | [RawQueryFragment](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/RawQueryFragment.md)\<any> | ([RawQueryFragment](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/RawQueryFragment.md) & symbol)
...
* **TEntities**
* **TOptions**: [MikroKyselyPluginOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/MikroKyselyPluginOptions.md) =
  <!-- -->
  {}
...
**InferDBFromKysely\<TKysely>: TKysely extends [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Kysely)\<infer
...
* **TKysely**: [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#Kysely)\<any>
...
**InferEntityProperties\<Schema>: Schema extends [EntitySchemaWithMeta](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EntitySchemaWithMeta.md)\<any, any, any, any, infer
...
**InferKyselyDB\<TEntities, TOptions>: [MapValueAsTable](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MapValueAsTable)<[MapTableName](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MapTableName)\<TEntities, TOptions>, TOptions>
...
[InferEntityProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferEntityProperties)\<TSchema> as TransformColumnName\<K, TOptions\[columnNamingStrategy] extends property ? property : underscore, [MaybeReturnType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MaybeReturnType)<[InferEntityProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferEntityProperties)\<TSchema>\[K]>> ]: InferColumnValue<[MaybeReturnType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#MaybeReturnType)<[InferEntityProperties](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferEntityProperties)\<TSchema>\[K]>, TOptions\[processOnCreateHooks] extends true ? true : false> }>

#### Type parameters

* **TSchema**: [EntitySchemaWithMeta](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EntitySchemaWithMeta.md)
* **TOptions**: [MikroKyselyPluginOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/MikroKyselyPluginOptions.md) =
  <!-- -->
  {}
...
TMap as TransformName\<K, TOptions\[tableNamingStrategy] extends entity ? entity : underscore> ]: [InferKyselyTable](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#InferKyselyTable)\<TMap\[K], TOptions> }
...
**QBFilterQuery\<Entity, RootAlias, Context, RawAliases>: [FilterObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FilterObject)\<Entity> & [AliasedFilterCondition](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#AliasedFilterCondition)\<RootAlias, Context, Entity, RawAliases>
...
Rest}\` ? IsUpperLetter\<B> extends never ? \`${Lowercase\<A>}${[SnakeCase](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SnakeCase)<\`${B}${Rest}\`>}\` : IsLowerLetter\<A> extends never ? \`${Lowercase\<A>}${[SnakeCase](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SnakeCase)<\`${B}${Rest}\`>}\` : \`${Lowercase\<A>}\_${[SnakeCase](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql.md#SnakeCase)<\`${B}${Rest}\`>}\` : Lowercase\<TName>
...
### [**](#EMBEDDABLE_ARRAY_OPS)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/sql/src/query/enums.ts#L13)constEMBEDDABLE\_ARRAY\_OPS
