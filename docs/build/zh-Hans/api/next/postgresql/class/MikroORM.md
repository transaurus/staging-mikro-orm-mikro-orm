...
* [MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/MikroORM.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md), EM, Entities>
  * *MikroORM*
...
### [**](#constructor)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/postgresql/src/PostgreSqlMikroORM.ts#L66)constructor

* ****new MikroORM**\<EM, Entities>(options): [PostgreSqlMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/Options.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md), EM, Entities>>

  #### Returns [PostgreSqlMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/Configuration.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md), [PostgreSqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/EntityManager.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md)> & [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntityManager.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md)>>
...
**driver: [PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md)
...
### [**](#migrator)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/core/src/MikroORM.ts#L282)inheritedmigrator
...
* ****connect**(): Promise<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlDriver.md)>
...
### [**](#init)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/postgresql/src/PostgreSqlMikroORM.ts#L51)staticinit
