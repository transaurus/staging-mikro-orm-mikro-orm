...
* ****new PostgreSqlPlatform**(): [PostgreSqlPlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlPlatform.md)

- Inherited from BasePostgreSqlPlatform.constructor

  #### Returns [PostgreSqlPlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/postgresql/class/PostgreSqlPlatform.md)
...
- Inherited from BasePostgreSqlPlatform.getEnumArrayCheckConstraintExpression
...
- Inherited from BasePostgreSqlPlatform.getEnumCheckConstraintExpression
