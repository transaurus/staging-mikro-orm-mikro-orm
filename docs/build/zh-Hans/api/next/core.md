...
* [**DefineConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/namespace/DefineConfig.md)
* [**Hidden](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/namespace/Hidden.md)
* [**Opt](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/namespace/Opt.md)
* [**RequiredNullable](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/namespace/RequiredNullable.md)
...
* [**EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntityManager.md)
* [**EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntityMetadata.md)
* [**EntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntityRepository.md)
...
B}\` ? A extends StringKeys\<O, E> ? \`${A}.${[AutoPath](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AutoPath)\<NonNullable\<GetStringKey\<O, A, E>>, B, E, Prev\[D]>}\` : never : P extends StringKeys\<O, E> ? (NonNullable\<GetStringKey<..., ..., ...>> extends unknown ? Exclude\<P, \`${...}.\`> : never) | (StringKeys\<NonNullable<...>, E> extends never ? never : \`${... & ...}.\`) : StringKeys\<O, E> | \`${RelationKeys\<O>}:ref\` : never : never
...
* * **(columns, table): string | [Raw](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/RawQueryFragment.md)

  - #### Parameters

    * ##### columns: Record\<PropertyName\<T>, string>
    * ##### table: [SchemaTable](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#SchemaTable)
...
U\[] ? [DeepPartial](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#DeepPartial)\<U>\[] : T\[P] extends Readonly\<infer

<!-- -->

U>\[] ? Readonly<[DeepPartial](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#DeepPartial)\<U>>\[] : [DeepPartial](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#DeepPartial)\<T\[P]> }
...
T as DTORequiredKeys\<T, K> ]: [EntityDTOProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityDTOProp)\<T, T\[K], C> | AddOptional\<T\[K]> } & { \[ K in keyof

<!-- -->

T as DTOOptionalKeys\<T, K> ]?: [EntityDTOProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityDTOProp)\<T, T\[K], C> | AddOptional\<T\[K]> }
...
U } ? [IsUnknown](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#IsUnknown)\<U> extends false ? U : T : T extends LoadedReferenceShape\<infer
...
...\[] ? U extends [Scalar](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Scalar) ? T : [EntityDTOProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityDTOProp)<..., ..., ..., ...>\[] : T extends Relation\<T> ? DTOWrapper\<T, C, Flat> : T
...
T | PopulatePath.ALL | [AutoPath](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AutoPath)\<T, P, \`${PopulatePath.ALL}\`>
...
: (T extends [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityClass)\<infer
...
P : string) | [AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AnyString); discriminatorMap?

<!-- -->

: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary)\<string>; discriminatorValue?
...
: [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#QueryOrderMap)\<E> | [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#QueryOrderMap)\<E>\[]; readonly?
...
: () => [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor); schema?
...
* **T**
* **E** = T extends [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityClass)\<infer
  <!-- -->
  P> ? P : T
...
* ##### optionalconstructorParams?<!-- -->: (T extends [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityClass)\<infer <!-- -->P> ? keyof<!-- --> P : string)\[]
...
* ##### optionaldiscriminatorColumn?<!-- -->: (T extends [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityClass)\<infer <!-- -->P> ? keyof<!-- --> P : string) | [AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AnyString)

  For [Single Table Inheritance](https://mikro-orm.io/zh-Hans/zh-Hans/docs/next/inheritance-mapping#single-table-inheritance).

* ##### optionaldiscriminatorMap?<!-- -->: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary)\<string>
...
* ##### optionalexpression?<!-- -->: string | (em, where, options, stream) => object
  ...
  SQL query that maps to a [virtual entity](https://mikro-orm.io/zh-Hans/zh-Hans/docs/next/virtual-entities), or for view entities, the view definition.
...
* ##### optionalinheritance?<!-- -->: tpt
  ...
  Set inheritance strategy: 'tpt' for [Table-Per-Type](https://mikro-orm.io/zh-Hans/zh-Hans/docs/next/inheritance-mapping#table-per-type-inheritance-tpt) inheritance. When set on the root entity, each entity in the hierarchy gets its own table with a FK from child PK to parent PK.

* ##### optionalorderBy?<!-- -->: [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#QueryOrderMap)\<E> | [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#QueryOrderMap)\<E>\[]
...
* ##### optionalrepository?<!-- -->: () => [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)

  Set [custom repository class](https://mikro-orm.io/zh-Hans/zh-Hans/docs/next/repositories#custom-repository).

  * * **(): [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)

    - #### Returns [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)
...
T ]: T\[K] } & [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/Reference.md)\<T>

Alias for `Reference<T> & { id: number }` (see [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Ref)).
...
: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityName)\<Base> } & { properties?
...
OmitBaseProps\<Entity, Base> as CleanKeys\<OmitBaseProps\<Entity, Base>, Key> ]-?: [EntitySchemaProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntitySchemaProperty)<[ExpandProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#ExpandProperty)\<NonNullable\<Entity\[Key]>>, Entity> } } & { inheritance?
...
* **T**: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityName) | readonly
  <!-- -->
...
* * **(columns, table, indexName): string | [Raw](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/RawQueryFragment.md)
...
E } ? E : Schema extends [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntitySchema.md)\<infer

<!-- -->

Entity> ? Entity : Schema extends [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityClass)\<infer
...
: ... extends ... ? ... : ... }) & Omit\<Base, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PrimaryKeyProp)>>, BaseEntityMethodKeys> : {}) & { -readonly \[ K in keyof
...
: Repository extends [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)\<infer

<!-- -->

R> ? R : Repository }) & (IsNever\<Base> extends true ? {} : Omit\<Base, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PrimaryKeyProp)>) & (ForceObject extends true ? { \[Config]?

<!-- -->

: [DefineConfig](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#DefineConfig)<{ forceObject: true }> } : {})
...
Differs from [LoggerOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/LoggerOptions.md) in terms of how they are used; this type is primarily a public type meant to be used within methods like `em.find()`.
...
* * **(metadata, platform): [MaybePromise](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#MaybePromise)\<void>

  - #### Parameters

    * ##### metadata: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntityMetadata.md)\[]
...
: [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)<[IMigrationGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/IMigrationGenerator.md)>; glob?
...
: ([MigrationObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/MigrationObject.md) | [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)\<Migration>)\[]; path?
...
* ##### optionalgenerator?<!-- -->: [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)<[IMigrationGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/IMigrationGenerator.md)>
...
* ##### optionalmigrationsList?<!-- -->: ([MigrationObject](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/MigrationObject.md) | [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Constructor)\<Migration>)\[]
...
: never }) | [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#QueryOrderMap)\<T>\[]
...
[AutoPath](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#AutoPath)\<T, P, \`${[PopulatePath](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/enum/PopulatePath.md)}\`>\[] | false
...
: [PopulateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PopulateOptions)\<T\[keyof
...
: boolean; field: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityKey)\<T>; filter?
...
* ##### optionalchildren?<!-- -->: [PopulateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PopulateOptions)\<T\[keyof<!-- --> T]>\[]

* ##### optionaldataOnly?<!-- -->: boolean

  When true, ignores `mapToPk` on the property and returns full entity data instead of just PKs.

* ##### field: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityKey)\<T>
...
T}\` ? H | \`${H}.${[Prefixes](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Prefixes)\<T>}\` : S
...
PK } ? PK extends undefined ? Omit\<T, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#PrimaryKeyProp)> : PK extends keyof
...
typeof [types](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#types), PropertyBuildersOverrideKeys> ]: () => UniversalPropertyOptionsBuilder\<InferPropertyValueType\<typeof [types](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#types)\[K]>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty> } & { array: \<T>(toJsValue, toDbValue) => UniversalPropertyOptionsBuilder\<InferPropertyValueType\<typeof types.array>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty>; bigint: \<Mode>(mode) => UniversalPropertyOptionsBuilder\<InferPropertyValueType\<typeof types.bigint>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty>; datetime: (length) => UniversalPropertyOptionsBuilder\<InferPropertyValueType\<typeof types.datetime>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty>; decimal: \<Mode>(mode) => UniversalPropertyOptionsBuilder\<InferPropertyValueType\<typeof types.decimal>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty>; embedded: \<Target>(target) => [PropertyChain](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/PropertyChain.md)<[InferEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntity)\<Target extends infer

<!-- -->

T\[] ? T : Target>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md) & { kind: embedded }>; enum: \<T>(items) => UniversalPropertyOptionsBuilder\<T extends () => [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary) ? ValueOf\<ReturnType\<T>> : T extends readonly
...
Value\[] ? Value : T, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForEnumOptions>; formula: \<T>(formula) => UniversalPropertyOptionsBuilder\<T, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty>; json: \<T>() => UniversalPropertyOptionsBuilder\<T, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty>; manyToMany: \<Target>(target) => [PropertyChain](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/PropertyChain.md)<[InferEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntity)\<Target>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md) & { kind: m:n }>; manyToOne: \<Target>(target) => [PropertyChain](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/PropertyChain.md)<[InferEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntity)\<Target extends infer

<!-- -->

T\[] ? T : Target>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md) & { kind: m:1 }>; oneToMany: \<Target>(target) => [PropertyChain](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/PropertyChain.md)<[InferEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntity)\<Target>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md) & { kind: 1:m }>; oneToOne: \<Target>(target) => [PropertyChain](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/PropertyChain.md)<[InferEntity](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#InferEntity)\<Target extends infer

<!-- -->

T\[] ? T : Target>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md) & { kind: 1:1 }>; time: (length) => UniversalPropertyOptionsBuilder\<InferPropertyValueType\<typeof types.time>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty>; type: \<T>(type) => UniversalPropertyOptionsBuilder\<InferPropertyValueType\<T>, [EmptyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmptyOptions.md), IncludeKeysForProperty> }
...
T as RequiredKeys\<T, K, I> ]: T\[K] | RequiredEntityDataProp\<T\[K], T, C> | [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Primary)\<T\[K]> | PolymorphicPrimary\<T\[K]> | [Raw](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/RawQueryFragment.md) } & { \[ K in keyof

<!-- -->

T as OptionalKeys\<T, K, I> ]?: T\[K] | RequiredEntityDataProp\<T\[K], T, C> | [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Primary)\<T\[K]> | PolymorphicPrimary\<T\[K]> | [Raw](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/RawQueryFragment.md) | null }
...
Alias for `ScalarReference` (see [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Ref)).
...
T as IsPrefixed\<T, K, L | F | AddEager\<T>> | FunctionKeys\<T, K> ]: T\[K] extends Function ? T\[K] : NonNullable\<T\[K]> extends [Scalar](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Scalar) ? T\[K] : LoadedProp\<NonNullable\<T\[K]>, Suffix\<K, L, true>, Suffix\<K, F, true>> | AddOptional\<T\[K]> } & { \[\_\_\_fieldsHint]?

<!-- -->

: (hint) => void; \[\_\_\_selectedType]?
...
T as ExcludeHidden\<T, K> & CleanKeys\<T, K> & (IsNever\<E> extends true ? K : Exclude\<K, E>) ]: SerializePropValue\<T, K, H, C> | Extract\<T\[K], null | undefined> } : { \[ K in keyof

<!-- -->

T as ExcludeHidden\<T, K> & CleanKeys\<T, K> & (IsNever\<E> extends true ? K : Exclude\<K, E>) & SerializeFieldsFilter\<T, K, F> ]: SerializePropValueWithFields\<T, K, H, C, F> | Extract\<T\[K], null | undefined> }
...
[PropertyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/PropertyOptions.md)\<any> | keyof

<!-- -->

[EnumOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EnumOptions.md)\<any> | keyof

<!-- -->

[EmbeddedOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/EmbeddedOptions.md)\<any, any> | keyof

<!-- -->

[ReferenceOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/ReferenceOptions.md)\<any, any> | keyof

<!-- -->

[ManyToOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/ManyToOneOptions.md)\<any, any> | keyof

<!-- -->

[OneToManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/OneToManyOptions.md)\<any, any> | keyof

<!-- -->

[OneToOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/OneToOneOptions.md)\<any, any> | keyof

<!-- -->

[ManyToManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/ManyToManyOptions.md)\<any, any>
...
* ##### readonlyarray: typeof [ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/ArrayType.md)
* ##### readonlybigint: typeof [BigIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/BigIntType.md)
* ##### readonlyblob: typeof [BlobType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/BlobType.md)
* ##### readonlyboolean: typeof [BooleanType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/BooleanType.md)
* ##### readonlycharacter: typeof [CharacterType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/CharacterType.md)
* ##### readonlydate: typeof [DateType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/DateType.md)
* ##### readonlydatetime: typeof [DateTimeType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/DateTimeType.md)
* ##### readonlydecimal: typeof [DecimalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/DecimalType.md)
* ##### readonlydouble: typeof [DoubleType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/DoubleType.md)
* ##### readonlyenum: typeof [EnumType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EnumType.md)
* ##### readonlyenumArray: typeof [EnumArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EnumArrayType.md)
* ##### readonlyfloat: typeof [FloatType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/FloatType.md)
* ##### readonlyinteger: typeof [IntegerType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/IntegerType.md)
* ##### readonlyinterval: typeof [IntervalType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/IntervalType.md)
* ##### readonlyjson: typeof [JsonType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/JsonType.md)
* ##### readonlymediumint: typeof [MediumIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/MediumIntType.md)
* ##### readonlysmallint: typeof [SmallIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/SmallIntType.md)
* ##### readonlystring: typeof [StringType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/StringType.md)
* ##### readonlytext: typeof [TextType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/TextType.md)
* ##### readonlytime: typeof [TimeType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/TimeType.md)
* ##### readonlytinyint: typeof [TinyIntType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/TinyIntType.md)
* ##### readonlyuint8array: typeof [Uint8ArrayType](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/Uint8ArrayType.md)
