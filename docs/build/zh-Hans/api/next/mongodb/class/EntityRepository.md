...
* [EntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/EntityRepository.md)\<T>
  * *EntityRepository*
...
- Overrides EntityRepository.constructor
  ...
  * ##### em: [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/mongodb/class/MongoDriver.md)>
  * ##### entityName: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityName)\<T>

  #### Returns [MongoEntityRepository](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/mongodb/class/EntityRepository.md)\<T>
...
- Inherited from EntityRepository.count
  ...
  * ##### options: [CountOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/CountOptions.md)\<T, Hint> = <!-- -->{}
...
- Inherited from EntityRepository.create
  ...
  * ##### data: Data & [IsSubset](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#IsSubset)<[RequiredEntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#RequiredEntityData)\<T, never, Convert>, Data>
...
- Inherited from EntityRepository.find
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/FindOptions.md)\<T, Hint, Fields, Excludes>
...
- Inherited from EntityRepository.findAll
  ...
  * ##### optionaloptions: [FindAllOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/FindAllOptions.md)\<T, Hint, Fields, Excludes>
...
- Inherited from EntityRepository.findByCursor
  ...
  * ##### options: [FindByCursorOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/FindByCursorOptions.md)\<T, Hint, Fields, Excludes, IncludeCount>
...
- Inherited from EntityRepository.findOne
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/FindOneOptions.md)\<T, Hint, Fields, Excludes>
...
- Inherited from EntityRepository.findOneOrFail
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#FilterQuery)\<T>
  * ##### optionaloptions: [FindOneOrFailOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/FindOneOrFailOptions.md)\<T, Hint, Fields, Excludes>
...
* ****getReference**(id, options): [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Ref)\<T>
* ****getReference**(id): T
...
- Inherited from EntityRepository.insert
  ...
  * ##### data: T | [RequiredEntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#RequiredEntityData)\<T>
...
- Inherited from EntityRepository.merge
  ...
  * ##### data: T | [EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityData)\<T>
...
- Inherited from EntityRepository.nativeUpdate
  ...
  * ##### optionaloptions: [UpdateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/UpdateOptions.md)\<T>
...
- Inherited from EntityRepository.stream
  ...
  * ##### optionaloptions: [StreamOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/StreamOptions.md)\<T, Hint, Fields, Excludes>
...
- Inherited from EntityRepository.upsert
  ...
  * ##### optionalentityOrData: T | [EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityData)\<T>
  * ##### optionaloptions: [UpsertOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/UpsertOptions.md)\<T, Fields>
...
- Inherited from EntityRepository.upsertMany
  ...
  * ##### optionalentitiesOrData: [EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#EntityData)\<T>\[] | T\[]
  * ##### optionaloptions: [UpsertManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/UpsertManyOptions.md)\<T, Fields>
