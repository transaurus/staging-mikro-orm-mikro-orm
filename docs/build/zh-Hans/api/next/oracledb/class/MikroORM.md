...
* [MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/class/MikroORM.md)<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/oracledb/class/OracleDriver.md), EM, Entities>
  * *MikroORM*
...
### [**](#constructor)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/oracledb/src/OracleMikroORM.ts#L66)constructor

* ****new MikroORM**\<EM, Entities>(options): [OracleMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/oracledb/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core/interface/Options.md)<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/oracledb/class/OracleDriver.md), EM, Entities>>

  #### Returns [OracleMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/oracledb/class/MikroORM.md)\<EM, Entities>
...
**driver: [OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/oracledb/class/OracleDriver.md)
...
* ****connect**(): Promise<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/oracledb/class/OracleDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[OracleDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/oracledb/class/OracleDriver.md)>
...
### [**](#init)[**](https://github.com/transaurus/staging-mikro-orm-mikro-orm/blob/2ecf1352e4ba7c26d38df8b63dc9af07dd7c5246/packages/oracledb/src/OracleMikroORM.ts#L51)staticinit
