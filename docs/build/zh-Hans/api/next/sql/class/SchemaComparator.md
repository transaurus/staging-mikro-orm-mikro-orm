...
- #### Parameters
  ...
  * ##### platform: [AbstractSqlPlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/class/AbstractSqlPlatform.md)
  ...
  #### Returns [SchemaComparator](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/class/SchemaComparator.md)
...
- Returns a SchemaDifference object containing the differences between the schemas fromSchema and toSchema.
  ...
  * ##### optionalinverseDiff: [SchemaDifference](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/SchemaDifference.md)
...
- Returns the difference between the columns
  ...
  * ##### fromColumn: [Column](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/Column.md)
  * ##### toColumn: [Column](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/Column.md)
...
- #### Parameters
  ...
  * ##### key1: [ForeignKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/ForeignKey.md)
  * ##### key2: [ForeignKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/ForeignKey.md)
  * ##### tableDifferences: [TableDifference](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/TableDifference.md)
...
- Finds the difference between the indexes index1 and index2. Compares index1 with index2 and returns index2 if there are any differences or false in case there are no differences.
  ...
  * ##### index1: [IndexDef](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/IndexDef.md)
  * ##### index2: [IndexDef](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/IndexDef.md)
...
- Returns the difference between the tables fromTable and toTable. If there are no differences this method returns the boolean false.
  ...
  * ##### optionalinverseTableDiff: [TableDifference](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/TableDifference.md)
...
- #### Parameters
  ...
  * ##### from: [Column](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/sql/interface/Column.md)
...
- #### Parameters
  ...
  * ##### optionaldefaultValue: null | string
  ...
  #### Returns null | string | [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/next/core.md#Dictionary)
