...
* ****new Seeder**\<T>(): [Seeder](https://mikro-orm.io/zh-Hans/zh-Hans/api/seeder/class/Seeder.md)\<T>

- #### Returns [Seeder](https://mikro-orm.io/zh-Hans/zh-Hans/api/seeder/class/Seeder.md)\<T>
