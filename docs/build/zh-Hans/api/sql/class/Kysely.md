...
You should create one instance of `Kysely` per database using the [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md) constructor. Each `Kysely` instance maintains its own connection pool.
...
* ****new Kysely**\<DB>(args): [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DB>
* ****new Kysely**\<DB>(args): [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DB>
...
- Overrides QueryCreator\<DB>.constructor
  ...
  * ##### args: KyselyConfig
  ...
  #### Returns [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DB>
...
- Inherited from QueryCreator.deleteFrom
  ...
  See the [DeleteQueryBuilder.where](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/DeleteQueryBuilder.md#where) method for examples on how to specify a where clause for the delete operation.
...
- Inherited from QueryCreator.selectNoFrom
  ...
  This method accepts the same inputs as [SelectQueryBuilder.select](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md#select). See its documentation for more examples.
...
- Creates a ControlledTransactionBuilder that can be used to run queries inside a controlled transaction.
  ...
  A ControlledTransaction allows you to commit and rollback manually, execute savepoint commands. It extends [Transaction](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Transaction) which extends [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md), so you can run queries inside the transaction. Once the transaction is committed, or rolled back, it can't be used anymore - all queries will throw an error. This is to prevent accidentally running queries outside the transaction - where atomicity is not guaranteed anymore.
...
- Creates a TransactionBuilder that can be used to run queries inside a transaction.
  ...
  The callback function passed to the execute method gets the transaction object as its only argument. The transaction is of type [Transaction](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Transaction) which inherits [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md). Any query started through the transaction object is executed inside the transaction.
...
- Inherited from QueryCreator.updateTable
  ...
  See the [UpdateQueryBuilder.where](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/UpdateQueryBuilder.md#where) method for examples on how to specify a where clause for the update operation.
...
* ****withoutPlugins**(): [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DB>
...
* ****withPlugin**(plugin): [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DB>
...
* ****withSchema**(schema): [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DB>
...
* ****withTables**\<T>(): [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DrainOuterGeneric\<DB & T>>
...
- Returns a copy of this Kysely instance with tables added to its database type.
  ...
  ***
  ...
  #### Returns [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<DrainOuterGeneric\<DB & T>>
