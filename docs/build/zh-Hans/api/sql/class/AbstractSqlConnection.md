...
* [Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Connection.md)
  ...
  * *AbstractSqlConnection*
    ...
    * [PostgreSqlConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlConnection.md)
...
* ****new AbstractSqlConnection**(config, options, type): [AbstractSqlConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlConnection.md)
...
- Inherited from Connection.constructor
  ...
  * ##### type: [ConnectionType](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#ConnectionType) = <!-- -->'write'
  ...
  #### Returns [AbstractSqlConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlConnection.md)

## Methods<!-- -->[**](#Methods)

### [**](#begin)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L148)begin
...
- Overrides Connection.begin
  ...
  * ##### options: { ctx?<!-- -->: ControlledTransaction\<any, any>; eventBroadcaster?<!-- -->: [TransactionEventBroadcaster](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/TransactionEventBroadcaster.md); isolationLevel?<!-- -->: [IsolationLevel](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/enum/IsolationLevel.md); loggerContext?<!-- -->: [LogContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/LogContext.md); readOnly?<!-- -->: boolean } = <!-- -->{}
    ...
    * ##### optionalloggerContext: [LogContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/LogContext.md)
    * ##### optionalreadOnly: boolean

  #### Returns Promise\<ControlledTransaction\<any, any>>

### [**](#checkConnection)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L87)checkConnection
...
### [**](#close)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L69)close
...
### [**](#commit)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L204)commit
...
### [**](#connect)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L30)connect
...
### [**](#createKysely)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L40)createKysely

* ****createKysely**(): [MaybePromise](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MaybePromise)\<void>
...
### [**](#createKyselyDialect)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L27)abstractcreateKyselyDialect

* ****createKyselyDialect**(overrides): [MaybePromise](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MaybePromise)\<Dialect>
...
- Creates a Kysely dialect instance with driver-specific configuration.
  ...
  * ##### overrides: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Dictionary)

  #### Returns [MaybePromise](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#MaybePromise)\<Dialect>
...
### [**](#execute)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L264)execute
...
### [**](#executeDump)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L328)executeDump
...
### [**](#getClient)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L101)getClient

* ****getClient**\<T>(): [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<T>

- Returns the underlying Kysely client, creating it synchronously if needed.

  ***

  #### Returns [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<T>
...
### [**](#initClient)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L117)initClient
...
### [**](#isConnected)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L79)isConnected
...
### [**](#rollback)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L227)rollback
...
### [**](#stream)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L287)stream
...
- Executes a SQL query and returns an async iterable that yields results row by row.
  ...
  * ##### query: string | [RawQueryFragment](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/RawQueryFragment.md)\<string> | NativeQueryBuilder
  * ##### params: readonly<!-- --> unknown\[] = <!-- -->\[]
  * ##### optionalctx: [Kysely](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/Kysely.md)\<any>
  * ##### optionalloggerContext: [LoggingOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#LoggingOptions)

  #### Returns AsyncIterableIterator\<T, any, any>

### [**](#transactional)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/AbstractSqlConnection.ts#L124)transactional
...
- Overrides Connection.transactional
  ...
  * ##### cb: (trx) => Promise\<T>
  *
    ##### options: { ctx?<!-- -->: ControlledTransaction\<any, \[]>; eventBroadcaster?<!-- -->: [TransactionEventBroadcaster](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/TransactionEventBroadcaster.md); isolationLevel?<!-- -->: [IsolationLevel](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/enum/IsolationLevel.md); loggerContext?<!-- -->: [LogContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/LogContext.md); readOnly?<!-- -->: boolean } = <!-- -->{}
