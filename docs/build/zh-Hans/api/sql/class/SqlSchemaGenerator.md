...
* AbstractSchemaGenerator<[AbstractSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlDriver.md)>
  * *SqlSchemaGenerator*
...
* ****new SqlSchemaGenerator**(em): [SqlSchemaGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/SqlSchemaGenerator.md)

- Inherited from AbstractSchemaGenerator\<AbstractSqlDriver>.constructor

  #### Parameters

  * ##### em: [AbstractSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlDriver.md)<[AbstractSqlConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlConnection.md), [AbstractSqlPlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlPlatform.md)> | [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[AbstractSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlDriver.md)<[AbstractSqlConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlConnection.md), [AbstractSqlPlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/AbstractSqlPlatform.md)>>

  #### Returns [SqlSchemaGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/SqlSchemaGenerator.md)

## Methods<!-- -->[**](#Methods)

### [**](#clear)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L180)clear
...
### [**](#create)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L38)create
...
### [**](#createDatabase)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L526)createDatabase
...
### [**](#createNamespace)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L170)createNamespace
...
### [**](#diffToSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L355)diffToSQL

* ****diffToSQL**(schemaDiff, options): string

- #### Parameters

  * ##### schemaDiff: [SchemaDifference](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SchemaDifference.md)
...
### [**](#drop)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L160)drop
...
- Implementation of ISchemaGenerator.drop
  ...
  * ##### options: [DropSchemaOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/DropSchemaOptions.md) = <!-- -->{}

  #### Returns Promise\<void>

### [**](#dropDatabase)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L538)dropDatabase
...
### [**](#dropNamespace)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L175)dropNamespace
...
### [**](#dropTableIfExists)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L588)dropTableIfExists
...
### [**](#ensureDatabase)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L47)ensureDatabase
...
- Implementation of ISchemaGenerator.ensureDatabase
  ...
  * ##### optionaloptions: [EnsureDatabaseOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/EnsureDatabaseOptions.md)
...
### [**](#execute)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L546)execute
...
### [**](#getCreateSchemaSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L99)getCreateSchemaSQL
...
- Implementation of ISchemaGenerator.getCreateSchemaSQL
  ...
  * ##### options: [CreateSchemaOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/CreateSchemaOptions.md) = <!-- -->{}

  #### Returns Promise\<string>

### [**](#getDropSchemaSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L218)getDropSchemaSQL
...
- Implementation of ISchemaGenerator.getDropSchemaSQL
  ...
  * ##### options: Omit<[DropSchemaOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/DropSchemaOptions.md), dropDb> = <!-- -->{}

  #### Returns Promise\<string>

### [**](#getTargetSchema)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L82)getTargetSchema
...
### [**](#getUpdateSchemaMigrationSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L311)getUpdateSchemaMigrationSQL
...
- Implementation of ISchemaGenerator.getUpdateSchemaMigrationSQL
  ...
  * ##### options: [UpdateSchemaOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/UpdateSchemaOptions.md)\<DatabaseSchema> = <!-- -->{}

  #### Returns Promise<{ down: string; up: string }>

### [**](#getUpdateSchemaSQL)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L302)getUpdateSchemaSQL
...
- Implementation of ISchemaGenerator.refresh
  ...
  * ##### optionaloptions: [RefreshDatabaseOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/RefreshDatabaseOptions.md)

  #### Returns Promise\<void>

### [**](#update)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L297)update
...
### [**](#register)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sql/src/schema/SqlSchemaGenerator.ts#L31)staticregister
