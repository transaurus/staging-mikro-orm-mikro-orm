...
* ****getConnection**(): Promise<[OraclePoolConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/OraclePoolConnection.md)>

- #### Returns Promise<[OraclePoolConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/OraclePoolConnection.md)>
