...
* [RunQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/RunQueryBuilder.md)\<T, RootAlias, Context>
  * *InsertQueryBuilder*
...
* ****addSelect**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, ExtractRawAliases\<F extends readonly
  <!-- -->
...
- Inherited from RunQueryBuilder.addSelect
  ...
  * ##### fields: F
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, ExtractRawAliases\<F extends readonly<!-- --> unknown\[] ? F\<F> : \[F]>, \* | ExtractRootFields\<F extends readonly<!-- --> U\[] ? U & string : F & string, RootAlias, Context>, {}>
...
* ****andHaving**(cond, params): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>

- Inherited from RunQueryBuilder.andHaving

  #### Parameters

  * ##### optionalcond: string | [QBFilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#QBFilterQuery)\<T, RootAlias, Context, never>
  * ##### optionalparams: any\[]

  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****andOrderBy**(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
* ****andOrderBy**\<T>(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
- Inherited from RunQueryBuilder.andOrderBy
  ...
  * ##### orderBy: [ContextOrderByMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ContextOrderByMap)\<T, RootAlias, Context, never> | [ContextOrderByMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ContextOrderByMap)\<T, RootAlias, Context, never>\[]
...
- Inherited from RunQueryBuilder.andWhere
  ...
  * ##### cond: [QBFilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#QBFilterQuery)\<T, RootAlias, Context, never>
...
* ****clone**(reset, preserve): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
- Inherited from RunQueryBuilder.clone
  ...
  * ##### optionalpreserve: keyof<!-- --> QBState\<Entity>\[]
  ...
  #### Returns [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****delete**(cond): [DeleteQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/DeleteQueryBuilder.md)\<T, RootAlias, Context>
...
- Inherited from RunQueryBuilder.delete
  ...
  * ##### optionalcond: [QBFilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#QBFilterQuery)\<T, RootAlias, Context, never>

  #### Returns [DeleteQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/DeleteQueryBuilder.md)\<T, RootAlias, Context>
...
* ****distinct**(): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****distinctOn**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
* ****distinctOn**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****from**\<Entity>(target, aliasName): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, never, \*, {}>
* ****from**\<Entity>(target): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, never, \*, {}>
...
- Inherited from RunQueryBuilder.from
  ...
  * ##### optionalaliasName: string
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, never, \*, {}>
...
* ****groupBy**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
* ****groupBy**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
* ****groupBy**\<P>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****having**(cond, params, operator): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
- Inherited from RunQueryBuilder.having
  ...
  * ##### cond: string | [QBFilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#QBFilterQuery)\<T, RootAlias, Context, never> = <!-- -->{}
  * ##### optionalparams: any\[]
...
* ****innerJoin**\<Field, Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, false>, never, \*, {}>
* ****innerJoin**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, string, Alias, false>, never, \*, {}>
...
- Inherited from RunQueryBuilder.innerJoin
  ...
  * ##### field: Field
  * ##### alias: Alias
  * ##### optionalcond: JoinCondition<[ExpandProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#ExpandProperty)\<GetType\<T, Context, Field>\[GetPropName\<Field> & keyof<!-- --> GetType\<T, Context, Field>]>, Alias>
  * ##### optionalschema: string

  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, false>, never, \*, {}>
...
- Inherited from RunQueryBuilder.innerJoinAndSelect
  ...
  * ##### alias: Alias
  * ##### cond: JoinCondition<[ExpandProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#ExpandProperty)\<GetType\<T, Context, Field>\[GetPropName\<Field> & keyof<!-- --> GetType\<T, Context, Field>]>, Alias> = <!-- -->...
  * ##### optionalfields: JoinFields
  * ##### optionalschema: string

  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof<!-- --> Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****innerJoinLateral**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, string, Alias, false>, never, \*, {}>
...
- Inherited from RunQueryBuilder.innerJoinLateral
  ...
  * ##### optionalschema: string
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, string, Alias, false>, never, \*, {}>
...
* ****innerJoinLateralAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****insert**(data): [InsertQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/InsertQueryBuilder.md)\<T, RootAlias, Context>
...
- Inherited from RunQueryBuilder.insert
  ...
  * ##### data: [RequiredEntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#RequiredEntityData)\<T> | [RequiredEntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#RequiredEntityData)\<T>\[]
  ...
  #### Returns [InsertQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/InsertQueryBuilder.md)\<T, RootAlias, Context>
...
* ****join**\<Field, Alias>(field, alias, cond, type, path, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, false>, never, \*, {}>
* ****join**\<Alias>(field, alias, cond, type, path, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, string, Alias, false>, never, \*, {}>
...
* ****joinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, type, path, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****leftJoin**\<Field, Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, false>, never, \*, {}>
* ****leftJoin**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, string, Alias, false>, never, \*, {}>
...
* ****leftJoinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****leftJoinLateral**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, string, Alias, false>, never, \*, {}>
...
* ****leftJoinLateralAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<T, Context, Field, Alias, true>, never, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****limit**(limit, offset): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****offset**(offset): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****onConflict**\<F>(fields): [InsertQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/InsertQueryBuilder.md)\<T, RootAlias, Context>
...
* ****orderBy**(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
* ****orderBy**\<T>(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****orHaving**(cond, params): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, \*, {}>
...
* ****select**\<F>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, ExtractRawAliases\<F>, ExtractRootFields\<F\[number] & string, RootAlias, Context>, {}>
* ****select**\<P>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, ExtractRootFields\<P, RootAlias, Context>, {}>
* ****select**\<P>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, never, ExtractRootFields\<P, RootAlias, Context>, {}>
* ****select**\<F>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, ExtractRawAliasFromField\<F>, ExtractRootFields\<F & string, RootAlias, Context>, {}>
...
- Inherited from RunQueryBuilder.select
  ...
  * ##### optionaldistinct: boolean
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<T, RootAlias, never, Context, ExtractRawAliases\<F>, ExtractRootFields\<F\[number] & string, RootAlias, Context>, {}>
...
* ****update**(data): [UpdateQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/UpdateQueryBuilder.md)\<T, RootAlias, Context>
...
- Inherited from RunQueryBuilder.update
  ...
  * ##### data: [EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityData)\<T>
  ...
  #### Returns [UpdateQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/UpdateQueryBuilder.md)\<T, RootAlias, Context>
...
* ****with**\<Name, Q>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, RootAlias, never, Context, never, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
* ****with**\<Name>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, RootAlias, never, Context, never, \*, Record\<Name, object>>
...
- Inherited from RunQueryBuilder.with
  ...
  * ##### optionaloptions: [CteOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/CteOptions.md)
  ...
  #### Returns [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, RootAlias, never, Context, never, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
...
* ****withRecursive**\<Name, Q>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, RootAlias, never, Context, never, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
* ****withRecursive**\<Name>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, RootAlias, never, Context, never, \*, Record\<Name, object>>
