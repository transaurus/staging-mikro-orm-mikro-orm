...
* Omit<[QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*>, getResult | getSingleResult | getResultList | where>
...
**mainAlias: [Alias](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/Alias.md)\<Entity>
...
* ****addSelect**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases | ExtractRawAliases\<F extends readonly
  <!-- -->
...
- Inherited from Omit.addSelect
  ...
  * ##### fields: F
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases | ExtractRawAliases\<F extends readonly<!-- --> unknown\[] ? F\<F> : \[F]>, \* | ExtractRootFields\<F extends readonly<!-- --> U\[] ? U & string : F & string, RootAlias, Context>, {}>
...
* ****andHaving**(cond, params): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
- Inherited from Omit.andHaving
  ...
  * ##### optionalparams: any\[]
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****andOrderBy**(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
* ****andOrderBy**\<T>(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****clone**(reset, preserve): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
- Inherited from Omit.clone
  ...
  * ##### optionalpreserve: keyof<!-- --> QBState\<Entity>\[]
  ...
  #### Returns [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****distinct**(): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****distinctOn**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
* ****distinctOn**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****from**\<Entity>(target, aliasName): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
* ****from**\<Entity>(target): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****getResultAndCount**(): Promise<\[[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Loaded)\<Entity, never, \*>\[], number]>
...
- Inherited from Omit.getResultAndCount
  ...
  ***
  ...
  #### Returns Promise<\[[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Loaded)\<Entity, never, \*>\[], number]>
...
* ****groupBy**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
* ****groupBy**\<F>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
* ****groupBy**\<P>(fields): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****having**(cond, params, operator): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****innerJoin**\<Field, Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, false>, RawAliases, \*, {}>
* ****innerJoin**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, string, Alias, false>, RawAliases, \*, {}>
...
- Inherited from Omit.innerJoin
  ...
  * ##### optionalschema: string
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, false>, RawAliases, \*, {}>
...
* ****innerJoinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, true>, RawAliases, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****innerJoinLateral**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, string, Alias, false>, RawAliases, \*, {}>
...
- Inherited from Omit.innerJoinLateral
  ...
  * ##### optionalschema: string
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, string, Alias, false>, RawAliases, \*, {}>
...
* ****innerJoinLateralAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, true>, RawAliases, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****join**\<Field, Alias>(field, alias, cond, type, path, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, false>, RawAliases, \*, {}>
* ****join**\<Alias>(field, alias, cond, type, path, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, string, Alias, false>, RawAliases, \*, {}>
...
* ****joinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, type, path, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, true>, RawAliases, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****leftJoin**\<Field, Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, false>, RawAliases, \*, {}>
* ****leftJoin**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, string, Alias, false>, RawAliases, \*, {}>
...
* ****leftJoinAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, true>, RawAliases, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****leftJoinLateral**\<Alias>(field, alias, cond, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, string, Alias, false>, RawAliases, \*, {}>
...
* ****leftJoinLateralAndSelect**\<Field, Alias, JoinFields>(field, alias, cond, fields, schema): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, (GetAlias\<Field> extends Alias ? IsNever\<Alias, true, false> extends true ? GetPropName\<Field> : Alias extends RootAlias ? GetPropName\<Field> : Alias extends keyof
  <!-- -->
  Context ? Context\[Alias\<Alias>] extends \[Path, ...any\[]] ? \`${Path & string}.${GetPropName\<Field>}\` : GetPropName\<Field> : GetPropName\<Field> : GetPropName\<Field>) & {}, [ModifyContext](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyContext)\<Entity, Context, Field, Alias, true>, RawAliases, [ModifyFields](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql.md#ModifyFields)<\*, RootAlias, Context, Field, Alias, JoinFields>, {}>
...
* ****limit**(limit, offset): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****offset**(offset): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****orderBy**(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
* ****orderBy**\<T>(orderBy): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****orHaving**(cond, params): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, {}>
...
* ****select**\<F>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases | ExtractRawAliases\<F>, ExtractRootFields\<F\[number] & string, RootAlias, Context>, {}>
* ****select**\<P>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, ExtractRootFields\<P, RootAlias, Context>, {}>
* ****select**\<P>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, ExtractRootFields\<P, RootAlias, Context>, {}>
* ****select**\<F>(fields, distinct): [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases | ExtractRawAliasFromField\<F>, ExtractRootFields\<F & string, RootAlias, Context>, {}>
...
- Inherited from Omit.select
  ...
  * ##### optionaldistinct: boolean
  ...
  #### Returns [SelectQueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/SelectQueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases | ExtractRawAliases\<F>, ExtractRootFields\<F\[number] & string, RootAlias, Context>, {}>
...
* ****stream**(options): AsyncIterableIterator<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Loaded)\<Entity, never, \*>, any, any>
...
- Inherited from Omit.stream
  ...
  * ##### optionaloptions: [QBStreamOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/QBStreamOptions.md)
  ...
  #### Returns AsyncIterableIterator<[Loaded](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Loaded)\<Entity, never, \*>, any, any>
...
* ****with**\<Name, Q>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
* ****with**\<Name>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, Record\<Name, object>>
...
- Inherited from Omit.with
  ...
  * ##### optionaloptions: [CteOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/interface/CteOptions.md)
  ...
  #### Returns [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
...
* ****withRecursive**\<Name, Q>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, Record\<Name, Q extends [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<T, never, never, never, never, \*, {}> ? T : object>>
* ****withRecursive**\<Name>(name, query, options): [QueryBuilder](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/QueryBuilder.md)\<Entity, RootAlias, never, Context, RawAliases, \*, Record\<Name, object>>
