...
* ****new UnicodeString**(value): [UnicodeString](https://mikro-orm.io/zh-Hans/zh-Hans/api/mssql/class/UnicodeString.md)

- #### Parameters

  * ##### value: string

  #### Returns [UnicodeString](https://mikro-orm.io/zh-Hans/zh-Hans/api/mssql/class/UnicodeString.md)
