...
* [MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/MikroORM.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md), EM, Entities>
  * *MikroORM*
...
### [**](#constructor)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sqlite/src/SqliteMikroORM.ts#L66)constructor

* ****new MikroORM**\<EM, Entities>(options): [SqliteMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/Options.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md), EM, Entities>>

  #### Returns [SqliteMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Configuration.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md), [SqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/sql/class/EntityManager.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md)> & [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md)<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md)>>
...
**driver: [SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md)
...
* ****connect**(): Promise<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[SqliteDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/sqlite/class/SqliteDriver.md)>
...
### [**](#init)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/sqlite/src/SqliteMikroORM.ts#L51)staticinit
