...
* [MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/MikroORM.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md), EM, Entities>
  * *MikroORM*
...
### [**](#constructor)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/postgresql/src/PostgreSqlMikroORM.ts#L66)constructor

* ****new MikroORM**\<EM, Entities>(options): [PostgreSqlMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/MikroORM.md)\<EM, Entities>
...
- Overrides MikroORM.constructor
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/Options.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md), EM, Entities>>

  #### Returns [PostgreSqlMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/MikroORM.md)\<EM, Entities>
...
**config: [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Configuration.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md), [PostgreSqlEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/EntityManager.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md)> & [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md)<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md)>>
...
**driver: [PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md)
...
* **get entityGenerator(): [IEntityGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IEntityGenerator.md)
...
- Inherited from MikroORM.entityGenerator
  ...
  ***
  ...
  #### Returns [IEntityGenerator](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IEntityGenerator.md)
...
* **get migrator(): [IMigrator](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IMigrator.md)
...
- Inherited from MikroORM.migrator
  ...
  ***
  ...
  #### Returns [IMigrator](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IMigrator.md)
...
* **get seeder(): [ISeedManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/ISeedManager.md)
...
- Inherited from MikroORM.seeder
  ...
  ***
  ...
  #### Returns [ISeedManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/ISeedManager.md)
...
* ****connect**(): Promise<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md)>
...
- Inherited from MikroORM.connect
  ...
  ***
  ...
  #### Returns Promise<[PostgreSqlDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/postgresql/class/PostgreSqlDriver.md)>
...
- Inherited from MikroORM.discoverEntity
  ...
  * ##### entities: T | T\[]
  * ##### optionalreset: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName) | [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\[]
...
### [**](#init)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/postgresql/src/PostgreSqlMikroORM.ts#L51)staticinit

* ****init**\<D, EM, Entities>(options): Promise<[MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/MikroORM.md)\<D, EM, Entities>>
...
- Overrides MikroORM.init
  ...
  * ##### options: Partial<[Options](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/Options.md)\<D, EM, Entities>>

  #### Returns Promise<[MikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/MikroORM.md)\<D, EM, Entities>>
