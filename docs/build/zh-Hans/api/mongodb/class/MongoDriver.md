...
* [DatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/DatabaseDriver.md)<[MongoConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoConnection.md)>
  * *MongoDriver*
...
* ****new MongoDriver**(config): [MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoDriver.md)
...
- Overrides DatabaseDriver\<MongoConnection>.constructor
  ...
  * ##### config: [Configuration](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Configuration.md)<[IDatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IDatabaseDriver.md)<[Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Connection.md)>, [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md)<[IDatabaseDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IDatabaseDriver.md)<[Connection](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Connection.md)>>>
  ...
  #### Returns [MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoDriver.md)
...
**\[EntityManagerType]: [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoDriver.md)>
...
* ****connect**(options): Promise<[MongoConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoConnection.md)>
...
- Inherited from DatabaseDriver.connect
  ...
  * ##### optionaloptions: { skipOnConnect?<!-- -->: boolean }
  ...
  #### Returns Promise<[MongoConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoConnection.md)>
...
* ****createEntityManager**(useContext): [MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoDriver.md)>
...
- Overrides DatabaseDriver.findOne
  ...
  * ##### entityName: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<T>
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#FilterQuery)\<T>
  * ##### options: [FindOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/FindOneOptions.md)\<T, P, F, E> = <!-- -->...
...
* ****getConnection**(type): [MongoConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoConnection.md)
...
* ****getORMClass**(): [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Constructor)<[MongoMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MikroORM.md)<[MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoDriver.md)>, (string | [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<any, never, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<any>> | [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Partial\<any>>)\[]>>
...
- Overrides DatabaseDriver.getORMClass
  ...
  ***
  ...
  #### Returns [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Constructor)<[MongoMikroORM](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MikroORM.md)<[MongoEntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/EntityManager.md)<[MongoDriver](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoDriver.md)>, (string | [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<any, never, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<any>> | [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Partial\<any>>)\[]>>
...
* ****getPlatform**(): [MongoPlatform](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoPlatform.md)
...
- Overrides DatabaseDriver.nativeUpdateMany
  ...
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#FilterQuery)\<T>\[]
  * ##### data: [EntityDictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityDictionary)\<T>\[]
  * ##### options: [NativeInsertUpdateOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/NativeInsertUpdateOptions.md)\<T> & [UpsertManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/UpsertManyOptions.md)\<T, never> = <!-- -->{}
...
* ****reconnect**(options): Promise<[MongoConnection](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/MongoConnection.md)>
...
- Overrides DatabaseDriver.stream
  ...
  * ##### entityName: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<T>
  * ##### where: [FilterQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#FilterQuery)\<T>
  * ##### options: [StreamOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/StreamOptions.md)\<T, any, any, any> & { rawResults?<!-- -->: boolean }
...
* ****streamVirtual**\<T>(entityName, where, options): AsyncIterableIterator<[EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityData)\<T>, any, any>
...
- #### Parameters
  ...
  * ##### options: [FindOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/FindOptions.md)\<T, any, any, any>
  ...
  #### Returns AsyncIterableIterator<[EntityData](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityData)\<T>, any, any>
