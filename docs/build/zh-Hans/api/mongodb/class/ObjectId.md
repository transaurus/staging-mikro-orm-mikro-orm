...
* ****new ObjectId**(): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
* ****new ObjectId**(inputId): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
* ****new ObjectId**(inputId): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
* ****new ObjectId**(inputId): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
* ****new ObjectId**(inputId): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
* ****new ObjectId**(inputId): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
...
- Overrides BSONValue.constructor
  ...
  ***
  ...
  #### Returns [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
...
- Compares the equality of this ObjectId with `otherID`.
  ...
  * ##### otherId: undefined | null | string | [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md) | ObjectIdLike
...
* ****createFromBase64**(base64): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
...
* ****createFromHexString**(hexString): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
...
* ****createFromTime**(time): [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md)
...
- Checks if a value can be used to create a valid bson ObjectId
  ...
  * ##### id: string | Uint8Array\<ArrayBufferLike> | [ObjectId](https://mikro-orm.io/zh-Hans/zh-Hans/api/mongodb/class/ObjectId.md) | ObjectIdLike
