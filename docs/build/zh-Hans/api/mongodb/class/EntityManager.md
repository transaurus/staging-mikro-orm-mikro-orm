...
* [EntityManager](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityManager.md)\<Driver>
  * *EntityManager*
...
- Overrides EntityManager.begin
  ...
  * ##### options: Omit<[TransactionOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/TransactionOptions.md), ignoreNestedTransactions> & TransactionOptions = <!-- -->{}
...
- #### Parameters
  ...
  * ##### entityOrCollectionName: string | [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<T>
...
- Overrides EntityManager.transactional
  ...
  * ##### cb: (em) => Promise\<T>
  *
    ##### options: [TransactionOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/TransactionOptions.md) & TransactionOptions = <!-- -->{}
