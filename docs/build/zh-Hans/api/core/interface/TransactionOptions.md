...
: [IsolationLevel](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/enum/IsolationLevel.md) | read uncommitted | read committed | snapshot | repeatable read | serializable
...
: never | [TransactionPropagation](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/enum/TransactionPropagation.md) | required | requires\_new | nested | not\_supported | supports | mandatory
