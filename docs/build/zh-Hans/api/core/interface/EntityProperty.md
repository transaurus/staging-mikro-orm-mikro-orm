...
: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Owner, false>
...
**cascade: [Cascade](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/enum/Cascade.md)\[]
...
: [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Type.md)\<any, any>
...
**customTypes: (undefined | [Type](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Type.md)\<any, any>)\[]
...
: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Dictionary)<[EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Target>>
...
**embeddable: [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Owner>
...
: \[[EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Owner, false>, [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Owner, false>]
...
**embeddedProps: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Dictionary)<[EntityProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/EntityProperty.md)\<any, any>>
...
**entity: () => [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<Owner>

#### Type declaration

* * **(): [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<Owner>

  - #### Returns [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<Owner>
...
: [FormulaCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#FormulaCallback)\<Owner>
...
**inversedBy: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Target, false>
...
**mappedBy: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Target, false>
...
**name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Owner, false>
...
: [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#QueryOrderMap)\<Owner> | [QueryOrderMap](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#QueryOrderMap)\<Owner>\[]
...
**pivotEntity: [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Target>
...
**referencedPKs: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Owner, false>\[]
...
**runtimeType: string | number | bigint | boolean | object | [AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#AnyString) | Buffer | Date | any
...
**target: [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<Target>
...
: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<Target, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<Target>>
...
**type: string | bigint | boolean | [AnyString](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#AnyString) | uuid | date | time | datetime | blob | uint8array | array | enumArray | enum | json | integer | smallint | tinyint | mediumint | float | double | decimal | character | text | interval | unknown
