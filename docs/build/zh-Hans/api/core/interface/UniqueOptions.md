...
### [**](#deferMode)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/core/src/metadata/types.ts#L703)optionaldeferMode
...
### [**](#disabled)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/core/src/metadata/types.ts#L709)optionaldisabled
...
: string | (T extends [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<P> ? [IndexCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#IndexCallback)\<P> : [IndexCallback](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#IndexCallback)\<T>)
...
: T extends [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<P> ? Properties\<P, H> : Properties\<T, H>
