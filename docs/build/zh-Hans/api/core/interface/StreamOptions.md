...
* Omit<[FindAllOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/FindAllOptions.md)\<Entity, Populate, Fields, Exclude>, cache | before | after | first | last | overfetch | strategy>
  * *StreamOptions*
...
[AutoPath](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#AutoPath)\<Entity, Exclude, never, 9>\[]
...
### [**](#limit)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/core/src/drivers/IDatabaseDriver.ts#L317)optionalinheritedlimit
...
### [**](#lockMode)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/core/src/drivers/IDatabaseDriver.ts#L354)optionalinheritedlockMode
...
### [**](#mergeResults)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/core/src/drivers/IDatabaseDriver.ts#L242)optionalmergeResults
...
: [Populate](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Populate)\<Entity, Populate>
...
: \[Populate] extends \[never] ? never : { \[ K in string ]?: [PopulateHintOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#PopulateHintOptions) }
...
: [PopulateHint](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/enum/PopulateHint.md) | infer | all | [ObjectQuery](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#ObjectQuery)\<Entity>
...
### [**](#where)[**](https://github.com/mikro-orm/mikro-orm/blob/1a584cf134fb9ffc6fd6fc0a9a7ae91212a6abb3/packages/core/src/drivers/IDatabaseDriver.ts#L220)optionalinheritedwhere
