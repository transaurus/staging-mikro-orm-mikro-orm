...
* ****new EntitySchema**\<Entity, Base, Class>(meta): [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<Entity, Base, Class>

- #### Parameters

  * ##### meta: [EntitySchemaMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntitySchemaMetadata)\<Entity, Base, Class>

  #### Returns [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<Entity, Base, Class>
...
**REGISTRY: Map\<Partial\<any>, [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<any, never, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<any>>> =
...
* **get meta(): [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<Entity, Class>
...
* **get name(): string | [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<Entity>

- Returns the entity class name.

  ***

  #### Returns string | [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<Entity>
...
- Adds an embedded property to the entity schema.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### options: [EmbeddedOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/EmbeddedOptions.md)\<Entity, Target>
...
- Adds an enum property to the entity schema.
  ...
  * ##### options: [EnumOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/EnumOptions.md)\<Entity> = <!-- -->{}
...
- Adds a lifecycle hook handler to the entity schema. This method allows registering hooks after the entity is defined, which can be useful for avoiding circular type references.
  ...
  * ##### event: [EventType](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/enum/EventType.md) | onInit | onLoad | beforeCreate | afterCreate | beforeUpdate | afterUpdate | beforeUpsert | afterUpsert | beforeDelete | afterDelete | beforeFlush | onFlush | afterFlush | beforeTransactionStart | afterTransactionStart | beforeTransactionCommit | afterTransactionCommit | beforeTransactionRollback | afterTransactionRollback
...
- Adds an index definition to the entity schema.
  ...
  * ##### options: [IndexOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/IndexOptions.md)\<Entity, Key>
...
- Adds a many-to-many relation to the entity schema.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### type: TypeType
  * ##### options: [ManyToManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/ManyToManyOptions.md)\<Entity, Target>
...
- Adds a many-to-one relation to the entity schema.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### type: TypeType
  * ##### options: [ManyToOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/ManyToOneOptions.md)\<Entity, Target>
...
- Adds a one-to-many relation to the entity schema.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### type: TypeType
  * ##### options: [OneToManyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/OneToManyOptions.md)\<Entity, Target>
...
- Adds a one-to-one relation to the entity schema.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### type: TypeType
  * ##### options: [OneToOneOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/OneToOneOptions.md)\<Entity, Target>
...
- Adds a primary key property to the entity schema.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### type: TypeType
  * ##### options: [PrimaryKeyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/PrimaryKeyOptions.md)\<Entity> = <!-- -->{}
...
- Adds a scalar property to the entity schema.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### optionaltype: TypeType
  * ##### options: [PropertyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/PropertyOptions.md)\<Entity> | [EntityProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/EntityProperty.md)\<Entity, any> = <!-- -->{}
...
- Adds a serialized primary key property (e.g. for MongoDB ObjectId).
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### type: TypeType
  * ##### options: [SerializedPrimaryKeyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/SerializedPrimaryKeyOptions.md)\<Entity> = <!-- -->{}
...
- Adds a unique constraint definition to the entity schema.
  ...
  * ##### options: [UniqueOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/UniqueOptions.md)\<Entity, Key>
...
- Adds a version property for optimistic locking.
  ...
  * ##### name: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<Entity>
  * ##### type: TypeType
  * ##### options: [PropertyOptions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/PropertyOptions.md)\<Entity> = <!-- -->{}
...
- Sets a custom repository class for this entity.
  ...
  * ##### repository: () => [Constructor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Constructor)
...
- Sets the base entity that this schema extends.
  ...
  * ##### base: [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)
...
* ****fromMetadata**\<T, U>(meta): [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<T, U, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>>
...
- Creates an EntitySchema from existing EntityMetadata (used internally).
  ...
  * ##### meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<T, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>> | [DeepPartial](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#DeepPartial)<[EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<T, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>>>

  #### Returns [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<T, U, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>>
...
* ****is**(item): item is [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<any, never, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<any>>
...
- Checks if the given value is an EntitySchema instance, using duck-typing as a fallback when `instanceof` fails due to CJS/ESM dual-package hazard (e.g. when using `tsx` or `@swc-node/register` with `"type": "commonjs"` projects).
  ...
  * ##### item: unknown
  ...
  #### Returns item is [EntitySchema](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntitySchema.md)\<any, never, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<any>>
