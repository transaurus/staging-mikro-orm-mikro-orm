...
* ****new Utils**(): [Utils](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Utils.md)

- #### Returns [Utils](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Utils.md)
...
- Gets string name of given class.
  ...
  * ##### classOrName: string | [EntityName](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityName)\<T>
...
- #### Parameters
  ...
  * ##### code: string
  * ##### optionalcompiledFunctions: [CompiledFunctions](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#CompiledFunctions)
  * ##### optionalkey: string
...
- Extracts all possible values of a TS enum. Works with both string and numeric enums.
  ...
  * ##### target: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Dictionary)
...
- Extracts primary key from `data`. Accepts objects or primary keys directly.
  ...
  * ##### strict: boolean = <!-- -->false
  ...
  #### Returns null | string | (T extends { \[PrimaryKeyProp]?<!-- -->: PK } ? PK extends undefined ? Omit\<T\<T>, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#PrimaryKeyProp)> : PK extends keyof<!-- --> T\<T> ? ReadonlyPrimary\<UnwrapPrimary\<T\<T>\[PK\<PK>]>> : PK extends keyof<!-- --> T\<T>\[] ? ReadonlyPrimary\<PrimaryPropToType\<T\<T>, PK\<PK>>> : PK : T extends { \_id?<!-- -->: PK } ? string | ReadonlyPrimary\<PK> : T extends { id?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T extends { uuid?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T)
...
- #### Parameters
  ...
  * ##### optionalplatform: [Platform](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Platform.md)
  * ##### flat: boolean = <!-- -->false
...
* ****getCompositeKeyValue**\<T>(data, meta, convertCustomTypes, platform): [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>
...
- #### Parameters
  ...
  * ##### optionalplatform: [Platform](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Platform.md)
  ...
  #### Returns [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>
...
- Returns the number of properties on `obj`. This is 20x faster than Object.keys(obj).length.
  ...
  * ##### object: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Dictionary)
...
* ****getObjectQueryKeys**\<T, K>(obj): (K | [RawQueryFragmentSymbol](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#RawQueryFragmentSymbol))\[]

- #### Parameters

  * ##### obj: T

  #### Returns (K | [RawQueryFragmentSymbol](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#RawQueryFragmentSymbol))\[]
...
* ****getOrderedPrimaryKeys**\<T>(id, meta, platform, convertCustomTypes, allowScalar): [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>\[]

- #### Parameters

  * ##### id: [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T> | Record\<string, [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>>
  * ##### meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<T, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>>
  * ##### optionalplatform: [Platform](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Platform.md)
  * ##### convertCustomTypes: boolean = <!-- -->false
...
* ****getPrimaryKeyCond**\<T>(entity, primaryKeys): null | Record\<string, [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>>

- #### Parameters

  * ##### entity: T
  * ##### primaryKeys: [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<T>\[]

  #### Returns null | Record\<string, [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>>
...
- #### Parameters
  ...
  * ##### pks: (T extends { \[PrimaryKeyProp]?<!-- -->: PK } ? PK extends undefined ? Omit\<T\<T>, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#PrimaryKeyProp)> : PK extends keyof<!-- --> T\<T> ? ReadonlyPrimary\<UnwrapPrimary\<T\<T>\[PK\<PK>]>> : PK extends keyof<!-- --> T\<T>\[] ? ReadonlyPrimary\<PrimaryPropToType\<T\<T>, PK\<PK>>> : PK : T extends { \_id?<!-- -->: PK } ? string | ReadonlyPrimary\<PK> : T extends { id?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T extends { uuid?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T)\[]
  * ##### meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<T, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>>

  #### Returns Record\<string, T extends { \[PrimaryKeyProp]?<!-- -->: PK } ? PK extends undefined ? Omit\<T\<T>, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#PrimaryKeyProp)> : PK extends keyof<!-- --> T\<T> ? ReadonlyPrimary\<UnwrapPrimary\<T\<T>\[PK\<PK>]>> : PK extends keyof<!-- --> T\<T>\[] ? ReadonlyPrimary\<PrimaryPropToType\<T\<T>, PK\<PK>>> : PK : T extends { \_id?<!-- -->: PK } ? string | ReadonlyPrimary\<PK> : T extends { id?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T extends { uuid?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T>
...
* ****isCollection**\<T, O>(item): item is [Collection](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Collection.md)\<T, O>

- #### Parameters

  * ##### item: any

  #### Returns item is [Collection](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Collection.md)\<T, O>
...
* ****isPrimaryKey**\<T>(key, allowComposite): key is [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>
...
- Checks whether the argument looks like primary key (string, number or ObjectId).
  ...
  * ##### allowComposite: boolean = <!-- -->false
  ...
  #### Returns key is [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>
...
* ****isScalarReference**\<T>(data, allowReference): data is [ScalarReference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/ScalarReference.md)\<any>
...
- Checks whether given object is a scalar reference.
  ...
  * ##### allowReference: boolean = <!-- -->false
  ...
  #### Returns data is [ScalarReference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/ScalarReference.md)\<any>
...
- Merges all sources into the target recursively. Ignores `undefined` values.
  ...
  * ##### target: T
  * ##### rest...sources: [Dictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Dictionary)\[]
...
- #### Parameters
  ...
  * ##### meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<T, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>>
  * ##### primaryKey: T | [Primary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Primary)\<T>
...
- #### Parameters
  ...
  * ##### entity: [EntityDictionary](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityDictionary)\<T>
  * ##### meta: [EntityMetadata](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/EntityMetadata.md)\<T, [EntityCtor](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityCtor)\<T>>
...
* ****splitPrimaryKeys**\<T>(key): [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<T>\[]

- #### Parameters

  * ##### key: string

  #### Returns [EntityKey](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityKey)\<T>\[]
