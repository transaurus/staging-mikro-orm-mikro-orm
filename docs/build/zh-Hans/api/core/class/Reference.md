...
* ****new Reference**\<T>(entity): [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T>

- #### Parameters

  * ##### entity: T

  #### Returns [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T>
...
* ****create**\<T>(entity): [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Ref)\<T>
...
- Creates a Reference wrapper for the given entity, preserving identity if one already exists.
  ...
  * ##### entity: T | [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Ref)\<T>
...
* ****createFromPK**\<T>(entityType, pk, options): [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Ref)\<T>
...
- Creates a Reference wrapper for an entity identified by its primary key, wrapped in a Ref.
  ...
  * ##### entityType: [EntityClass](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#EntityClass)\<T>
  * ##### pk: T extends { \[PrimaryKeyProp]?<!-- -->: PK } ? PK extends undefined ? Omit\<T\<T>, typeof [PrimaryKeyProp](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#PrimaryKeyProp)> : PK extends keyof<!-- --> T\<T> ? ReadonlyPrimary\<UnwrapPrimary\<T\<T>\[PK\<PK>]>> : PK extends keyof<!-- --> T\<T>\[] ? ReadonlyPrimary\<PrimaryPropToType\<T\<T>, PK\<PK>>> : PK : T extends { \_id?<!-- -->: PK } ? string | ReadonlyPrimary\<PK> : T extends { id?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T extends { uuid?<!-- -->: PK } ? ReadonlyPrimary\<PK> : T
...
* ****isReference**\<T>(data): data is [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T>
...
- Checks whether the argument is instance of `Reference` wrapper.
  ...
  * ##### data: any
  ...
  #### Returns data is [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T>
...
- Returns wrapped entity.
  ...
  * ##### ref: T | [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T> | [ScalarReference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/ScalarReference.md)\<T> | [Ref](https://mikro-orm.io/zh-Hans/zh-Hans/api/core.md#Ref)\<T>
...
* ****wrapReference**\<T, O>(entity, prop): T | [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T>
...
- Wraps the entity in a `Reference` wrapper if the property is defined as `ref`.
  ...
  * ##### entity: T | [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T>
  * ##### prop: [EntityProperty](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/interface/EntityProperty.md)\<O, T>

  #### Returns T | [Reference](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/Reference.md)\<T>
