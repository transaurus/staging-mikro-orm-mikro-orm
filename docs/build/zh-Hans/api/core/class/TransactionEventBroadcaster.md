...
* ****new TransactionEventBroadcaster**(em, context): [TransactionEventBroadcaster](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/TransactionEventBroadcaster.md)
...
- #### Parameters
  ...
  * ##### optionalcontext: { topLevelTransaction?<!-- -->: boolean }
  ...
  #### Returns [TransactionEventBroadcaster](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/TransactionEventBroadcaster.md)
