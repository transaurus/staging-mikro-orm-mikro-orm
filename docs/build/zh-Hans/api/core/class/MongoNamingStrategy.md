...
* ****new MongoNamingStrategy**(): [MongoNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/MongoNamingStrategy.md)

- Inherited from AbstractNamingStrategy.constructor

  #### Returns [MongoNamingStrategy](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/MongoNamingStrategy.md)
