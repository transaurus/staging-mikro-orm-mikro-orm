...
* ****new PolymorphicRef**(discriminator, id): [PolymorphicRef](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/PolymorphicRef.md)
...
- #### Parameters
  ...
  * ##### id: unknown
  ...
  #### Returns [PolymorphicRef](https://mikro-orm.io/zh-Hans/zh-Hans/api/core/class/PolymorphicRef.md)
